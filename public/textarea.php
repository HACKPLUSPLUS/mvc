...
<meta content="origin-when-cross-origin" name="referrer" />
  ...
  <meta property="fb:app_id" content="1401488693436528">
    ...
    <meta property="og:description" content="GitHub is where people build software. More than 23 million people use GitHub to discover, fork, and contribute to over 63 million projects.">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTkyOTkzMTY4OmY4MzU5MjEwNTk5NGNmNTdmYTNmMWViZmVkMTBjYzRlYzE0ZjgwOTRlYzIzYTdhMmEwM2JjZTc3ZDZhZjRkNmY=--ac3502d1a3f7c0b696bee5e879cefb3e1168992c">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="2003:15991:2A5D1BC:44CAC25:59805511" data-pjax-transient>
  

  <meta name="selected-link" value="/settings/replies" data-pjax-transient>

  <meta name="google-site-verification" content="KT5gs8h0wvaagLKAVWq8bbeNwnZZK1r1XQysX3xurLU">
<meta name="google-site-verification" content="ZzhVyEFwb7w3e0-uOTltm8Jsck2F5StVihD0exw2fsA">
    <meta name="google-analytics" content="UA-3769691-2">

<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="2003:15991:2A5D1BC:44CAC25:59805511" name="octolytics-dimension-request_id" /><meta content="iad" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" /><meta content="8722712" name="octolytics-actor-id" /><meta content="HACKPLUSPLUS" name="octolytics-actor-login" /><meta content="e153bb5cedf6985c773f7e6b25acb4e1ed1e8d7368985650cdd1162cdfb86951" name="octolytics-actor-hash" />
  ...
  <meta name="user-login" content="HACKPLUSPLUS">
    ...
    <meta name="js-proxy-site-detection-payload" content="">


  <meta name="html-safe-nonce" content="8b83b4a4de98154b35ea42314269741e82c4486a">

  <meta http-equiv="x-pjax-version" content="d99b42298f43ad39ca4e611565653db5">
  

    <meta name="description" content="GitHub is where people build software. More than 23 million people use GitHub to discover, fork, and contribute to over 63 million projects.">
...
<div class="header" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/search" class="js-site-search-form" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/settings/replies" class="header-search-scope no-underline">/settings/replies</a>
      <input type="text"
  ...
  <li class="dropdown js-menu-container">
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="sLthocGMqTSm/uJuSliKV+UnbZG3QG2NHvm/bEX78M+WhJ4hnrnUfQKeyilJn+/aj5mAZWPVS7BQtGgKva5JyQ==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="gOvFUOMfuDhyeUDtMvB/WsAC24PJ83e2X3bwtshm7ACm1DrQvCrFcdYZaKoxNxrXqrw2dx1mUYsROyfQMDNVBg==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
...
<div class="col-3 float-left pr-4" role="navigation">
  <nav class="menu" data-pjax>
    ...
    <a href="/settings/profile" class="js-selected-navigation-item menu-item" data-selected-links="avatar_settings /settings/profile">Profile</a>
    ...
    <a href="/settings/security" class="js-selected-navigation-item menu-item" data-selected-links=" /settings/security">Security</a>
      ...
      <a href="/settings/replies" class="js-selected-navigation-item selected menu-item" data-selected-links="edit_saved_reply /settings/replies">Saved replies</a>
      <a href="/settings/applications" class="js-selected-navigation-item menu-item" data-selected-links="applications_settings settings_user_authorized_apps /settings/applications">Authorized OAuth Apps</a>

      <a href="/settings/apps/authorizations" class="js-selected-navigation-item menu-item" data-selected-links="integrations_settings settings_user_authorized_integrations /settings/apps/authorizations">Authorized GitHub Apps</a>
      <a href="/settings/installations" class="js-selected-navigation-item menu-item" data-selected-links="integration_installations /settings/installations">Installed GitHub Apps</a>
    ...
    <nav class="menu" data-pjax>
      ...
      <a href="/settings/developers" class="js-selected-navigation-item menu-item" data-selected-links="settings_user_developer_applications /settings/developers">OAuth applications</a>
      <a href="/settings/apps" class="js-selected-navigation-item menu-item" data-selected-links="integrations /settings/apps">GitHub Apps</a>
  ...
  <div class="settings-next">
    <div class="Subhead Subhead--spacious">
      <h2 class="Subhead-heading">Add a saved reply</h2>
    </div>
  </div>

  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/settings/replies" class="new_saved_reply" id="new_saved_reply" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="TbtaIY7efvWT8OSQAkgcABnthIhAPTyAQVg7LF4SrtvQIjl738aK+Ota/kryLfB7RqDl2rZ7i17jYaPOv+PAdg==" /></div>

  <dl class="form">
    <dl class="form-group">
      <dt><label>Saved reply title</label></dt>
      <dd><input id="saved-reply-title-field" class="input-block form-control" type="text" required autofocus placeholder="Add a short title to your reply" name="title" value="" tabindex="1"></dd>
    </dl>
  </dl>

  <div class="saved-reply-form">
    <div class="js-suggester-container  js-previewable-comment-form previewable-comment-form write-selected" data-preview-url="/preview?markdown_unsupported=false&amp;subject_type=NilClass" data-preview-authenticity-token="m6orrYH+xoiXEqxtWDZs0qx6OvVDIAejtrl23xcJ1pD2cWDVw4Ig9js0KZhRCIejDKYZKQ8By+CYFnbHAopoFg==">
  ...
  <div class="comment-form-error js-comment-form-error" style="display:none">    There was an error creating your NilClass.
</div>
  <div class="write-content js-write-bucket js-uploadable-container js-upload-markdown-image is-default upload-enabled"
      data-upload-policy-url="/upload/policies/assets" data-upload-policy-authenticity-token="39dzfyfu/k8K7uZcOH7p5idxG31mmEfESIeyMICp2qDWExpQU5FoDI7IaIMsqfU/FDgWvTWx52abObbuNp7m3w=="
      >
    ...
    <textarea name="body"
              ...
              class="form-control input-contrast comment-form-textarea js-comment-field js-improved-comment-field js-task-list-field js-quick-submit js-size-to-fit js-suggester-field js-quote-selection-target "
              required></textarea>
...
>
  ...
  <div class="comment-form-error comment-form-bottom js-comment-update-error"></div>
    ...
    <div class="form-actions">
        <button type="submit" class="btn btn-primary" tabindex="1" data-disable-invalid data-disable-with> Add saved reply </button>
    </div>
  </div>
</form>
...
<div class="container-lg site-footer-container">
  <div class="site-footer " role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.12368s from unicorn-1144374575-0wb1l">GitHub</span>, Inc.</li>
