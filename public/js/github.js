define("github/features", ["exports", "./metadata"], function(e, t) {
        ...
        function a(e) {
            this.name = "ImageWithoutAltAttributeError", this.stack = (new Error).stack, this.element = e, this.message = "Missing alt attribute on " + m["default"](e)
        }

        function i(e) {
            this.name = "ElementWithoutLabelError", this.stack = (new Error).stack, this.element = e, this.message = "Missing text, title, or aria-label attribute on " + m["default"](e)
        }

        function o(e) {
            this.name = "LinkWithoutLabelOrRoleError", this.stack = (new Error).stack, this.element = e, this.message = "Missing href or role=button on " + m["default"](e)
        }

        function s(e) {
            this.name = "LabelMissingControl", this.stack = (new Error).stack, this.element = e, this.message = "Label missing control on " + m["default"](e)
        }

        function u(e) {
            this.name = "ButtonWithoutLabelError", this.stack = (new Error).stack, this.element = e, this.message = "Missing text or aria-label attribute on " + m["default"](e)
        }

        function l(e, t) {
            this.name = "ARIAAttributeMissingError", this.stack = (new Error).stack, this.element = e, this.message = "Missing " + t + " attribute on " + m["default"](e)
        }
        ...
        function f(e) {
            switch (e.nodeType) {
                case Node.ELEMENT_NODE:
                    if (d(e.getAttribute("alt")) || d(e.getAttribute("aria-label")) || d(e.getAttribute("title"))) return !0;
                    var t = !0,
                        n = !1,
                        r = void 0;
                    try {
        ...
        function h(e, t) {
            var n = !0,
                ...
                d = void 0;
            try {
                for (var h, m = e.querySelectorAll("img")[Symbol.iterator](); !(n = (h = m.next()).done); n = !0) {
                    var g = h.value;
                    g.hasAttribute("alt") || t(new a(g))
                }
            } catch (p) {
                r = !0, d = p
            } finally {
            ...
            var y = !0,
                ...
                j = void 0;
            try {
                for (var w, L = e.querySelectorAll("a")[Symbol.iterator](); !(y = (w = L.next()).done); y = !0) {
                    var S = w.value;
                    S.hasAttribute("name") || c(S) || (null == S.getAttribute("href") && "button" !== S.getAttribute("role") ? t(new o(S)) : f(S) || t(new i(S)))
                }
            } catch (p) {
                b = !0, j = p
            } finally {
            ...
            var x = !0,
                ...
                E = void 0;
            try {
                for (var _, T = e.querySelectorAll("button")[Symbol.iterator](); !(x = (_ = T.next()).done); x = !0) {
                    var q = _.value;
                    c(q) || f(q) || t(new u(q))
                }
            } catch (p) {
            ...
            var M = !0,
                ...
                C = void 0;
            try {
                for (var H, I = e.querySelectorAll("label")[Symbol.iterator](); !(M = (H = I.next()).done); M = !0) {
                    var D = H.value,
                        P = D.control || document.getElementById(D.getAttribute("for")) || D.querySelector("input");
                    P || t(new s(D), !1)
                }
            } catch (p) {
                A = !0, C = p
            ...
            var R = !0,
                ...
                N = void 0;
            try {
                for (var F, B = e.querySelectorAll("input[type=text], textarea")[Symbol.iterator](); !(R = (F = B.next()).done); R = !0) {
                    var z = F.value;
                    !z.labels || z.labels.length || c(z) || z.hasAttribute("aria-label") || t(new i(z))
                }
            } catch (p) {
                O = !0, N = p
            } finally {
            ...
            var U = !0,
                ...
                V = void 0;
            try {
                for (var $, Y = Object.keys(v)[Symbol.iterator](); !(U = ($ = Y.next()).done); U = !0) {
                    var J = $.value,
                        X = v[J],
                        K = !0,
                        G = !1,
                        Q = void 0;
                    try {
                        for (var Z, ee = e.querySelectorAll(J)[Symbol.iterator](); !(K = (Z = ee.next()).done); K = !0) {
                            var te = Z.value,
                                ne = [],
                                re = !0,
                                ae = !1,
                                ie = void 0;
                            try {
                                for (var oe, se = X[Symbol.iterator](); !(re = (oe = se.next()).done); re = !0) {
                                    var ue = oe.value;
                                    te.hasAttribute(ue) || ne.push(ue)
                                }
                            } catch (p) {
                                ae = !0, ie = p
                            } finally {
                            ...
                            ne.length > 0 && t(new l(te, ne.join(", ")))
                        }
                    } catch (p) {
                        G = !0, Q = p
                    } finally {
        ...
        function o(e) {
            var t = document.body;
            return u["default"](t, "github/accessibility-report.js:10"), t.classList.contains("zhio") || e.element.classList.contains("zh-login-status") || e.element.closest("#window-resizer-tooltip") || e.element.closest(".octotree_sidebar") || e.element.closest(".markdown-body")
        }

        function s(e) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : !0;
            if (!o(e)) {
                l && console.warn(e.name + ": " + e.message);
                var a = "Accessibility: " + e.name + "\n" + e.message;
                n && (t.isFeatureEnabled("ACCESSIBILITY_UI_WARNING") || window.testEnvA11yErrors) && (e.element.classList.add("accessibility-error"), window.testEnvA11yErrors || e.element.addEventListener("click", function() {
                ...
                })), window.testEnvA11yErrors && window.testEnvA11yErrors.push(a), t.isFeatureEnabled("LOG_ACCESSIBILITY") && r.reportError(e, {
        ...
        n.ready.then(function() {
            l = null != document.querySelector(".js-header-wrapper.stats-ui-enabled"), (l || window.testEnvA11yErrors || t.isFeatureEnabled("ACCESSIBILITY_UI_WARNING") || t.isFeatureEnabled("LOG_ACCESSIBILITY")) && (requestIdleCallback(function() {
                return a.scanForProblems(document, s)
            }), document.addEventListener("pjax:end", function(e) {
                requestIdleCallback(function() {
                    return a.scanForProblems(e.target, s)
                })
            }))
        })
    }), define("github/behaviors/event-key-polyfill", [], function() {
        function e(e) {
            return n[e] || e
        }
        ...
        function t(e) {
            var t = String.fromCharCode(e.which),
                n = e.which;
            return !e.shiftKey && n >= 49 && 57 >= n ? t : !e.shiftKey && n >= 96 && 105 >= n ? String(n - 95) : n >= 65 && 90 >= n ? e.shiftKey ? t : t.toLowerCase() : n >= 112 && 123 >= n ? "F" + (n - 111) : e.shiftKey ? a[n] || "Unidentified" : r[n] || "Unidentified"
        }
        var n = {
                OS: "Meta",
                Win: "Meta",
            ...
            i = null,
            o = Object.getOwnPropertyDescriptor(KeyboardEvent.prototype, "key");
        if (o)
            if (i = function(e) {
                ...
                i = function(e) {
                    var t = o.get.apply(e);
                    if (e.metaKey && s.test(e.code) && e.code !== "Key" + t.toUpperCase()) {
                        var n = String.fromCharCode(e.which);
                        return e.shiftKey ? n.toUpperCase() : n.toLowerCase()
                    }
                    return t
                }
            } else /Macintosh.*Safari/.test(navigator.userAgent) && (i = function(e) {
                var t = o.get.apply(e);
                return /^[a-z]$/.test(t) && e.shiftKey ? t.toUpperCase() : t
            });
        Object.defineProperty(KeyboardEvent.prototype, "key", {
            enumerable: !0,
            configurable: !0,
            get: function() {
                return i ? e(i(this)) : t(this)
            }
        })
        ...
        ! function() {
            ...
            if (!("checkValidity" in r && "setCustomValidity" in r && (r.required = !0, r.value = "hi", r.cloneNode().checkValidity()))) {
                var a = new WeakMap,
                    i = ["HTMLFormElement", "HTMLInputElement", "HTMLTextAreaElement", "HTMLSelectElement", "HTMLButtonElement", "HTMLFieldSetElement", "HTMLOutputElement"],
                    o = !0,
                    s = !1,
                    u = void 0;
                try {
    ...
    }), define("github/behaviors/user-content", ["../fragment-target", "delegated-events", "../document-ready"], function(e, t, n) {
        function r() {
            if (!document.querySelector(":target")) {
                var t = e.decodeFragmentValue(location.hash),
                    n = e.findElementByFragmentName(document, "user-content-" + t);
                n && n.scrollIntoView()
            }
        }
        window.addEventListener("hashchange", r), document.addEventListener("pjax:success", r), t.on("click", "a[href]", function(e) {
        ...
        function i(e, r, a) {
            var i = o["default"](document.querySelector(".js-repo-health-check"), HTMLFormElement),
                s = o["default"](i.querySelector(".js-repo-health-name"), HTMLInputElement);
        ...
        r.observe(".js-repo-health", function(e) {
            ...
            var n = o["default"](e.closest("form"), HTMLFormElement),
                r = o["default"](n.querySelector(".js-comment-field"), HTMLTextAreaElement),
                a = o["default"](n.querySelector(".js-repo-name"), HTMLInputElement);
            "hidden" === a.type ? r.addEventListener("focus", t) : a.addEventListener("change", t)
        })
    }), define("github/restrict-tab-behavior", ["exports", "./hotkey", "invariant", "./visible"], function(e, t, n, r) {
        function a(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function i(e) {
            ...
            s["default"](t instanceof HTMLElement, "github/restrict-tab-behavior.js:9");
            var n = void 0;
            if ("tab" === (n = o["default"](e)) || "shift+tab" === n) {
                e.preventDefault();
                var r = Array.from(t.querySelectorAll("input, button, textarea")).filter(u["default"]).filter(function() {
                        return s["default"](t instanceof HTMLInputElement || t instanceof HTMLButtonElement || t instanceof HTMLButtonElement, "github/restrict-tab-behavior.js:17"), !t.disabled
                    }),
                    a = "shift+tab" === o["default"](e) ? -1 : 1;
                if (document.activeElement) {
                    var i = r.indexOf(document.activeElement),
                        l = i + a;
                    l === r.length || -1 === i && "tab" === o["default"](e) ? r[0].focus() : -1 === i ? r[r.length - 1].focus() : r[l].focus()
                } else r[r.length - 1].focus()
            }
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var o = a(t),
            s = a(n),
            u = a(r)
    }), define("github/box-overlay", ["delegated-events", "./history", "./typecast", "./fragment-target", "./hash-change", "./hotkey", "invariant", "./once", "./restrict-tab-behavior"], function(e, t, n, r, a, i, o, s, u) {
        function l(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function c(t, n) {
            d(), n || (n = m["default"](document.querySelector("[data-box-overlay-id='" + t.id + "']"), HTMLButtonElement)), f(t).then(function() {
                var n = t.querySelector("[autofocus]");
                n ? n.focus() : (t.hidden && (t.hidden = !1), t.setAttribute("tabindex", "-1"), t.focus()), e.fire(t, "overlay:opened")
            }), t.hidden = !1, n.setAttribute("aria-expanded", "true"), t.addEventListener("keydown", b["default"]), document.addEventListener("keydown", h), j = t
        }

        function d() {
            if (j) {
                var n = j,
                    r = m["default"](document.querySelector('[data-box-overlay-id="' + n.id + '"]'), HTMLElement);
                f(n).then(function() {
                    r.focus(), e.fire(n, "overlay:closed")
                }), r.setAttribute("aria-expanded", "false"), n.hidden = !0, n.removeEventListener("keydown", b["default"]), document.removeEventListener("keydown", h), location.hash === "#" + n.id && t.replaceState(t.getState(), "", window.location.href.split("#")[0]), j = null
            }
        }
        ...
        function f(e) {
            return regeneratorRuntime.async(function(t) {
                for (;;) switch (t.prev = t.next) {
                    case 0:
                        if ("0s" !== getComputedStyle(e).transitionDuration) {
                            t.next = 2;
                            break
                        }
                        return t.abrupt("return");
                    case 2:
                        return e.style.display = "block", e.offsetHeight, t.next = 6, regeneratorRuntime.awrap(y["default"](e, "transitionend"));
                    case 6:
                        e.style.display = "";
                    case 7:
                    case "end":
        ...
        var m = l(n),
            ...
            b = l(u),
            j = null;
        e.on("click", "button[data-box-overlay-id]", function(e) {
            var t = m["default"](e.currentTarget, HTMLButtonElement),
                n = t.getAttribute("data-box-overlay-id");
            p["default"](n, "github/box-overlay.js:18");
            var r = m["default"](document.getElementById(n), HTMLElement);
            c(r, t)
        }), e.on("click", ".js-box-overlay-container", function(e) {
            var t = m["default"](e.target, HTMLElement);
            t.querySelector(".js-box-overlay-content") && d()
        }), e.on("click", ".js-box-overlay-close", function() {
            d()
        }), v["default"](function() {
            var e = r.findFragmentTarget(document);
        ...
        function c(e) {
            ...
            var n = e.form,
                r = n.closest(".js-branches"),
                i = r.querySelectorAll(".js-branches-subnav .js-subnav-item"),
                o = r.querySelector(".js-branches-subnav .js-subnav-item.selected"),
                u = r.querySelector(".js-branches-subnav .js-branches-all"),
                c = n.getAttribute("data-results-container");
            v || (v = o);
            var d = e.value.trim(),
                f = l(e);
            g.push(a.fetchSafeDocumentFragment(document, f)).then(function(e) {
        ...
        o.observe(".js-branch-search-field", function(e) {
            ...
            var n = this.matches(".js-branch-destroy"),
                r = this.closest(".js-branch-row").getAttribute("data-branch-name"),
                a = this.closest(".js-branches").querySelectorAll(".js-branch-row"),
        ...
        var t = /\bChrome\//.test(navigator.userAgent) && !/\bEdge\//.test(navigator.userAgent),
            n = void 0,
            r = void 0;
                ...
                _encodeObject: function(e, t) {
                    ...
                    if (null != Array.isArray && Array.isArray(t) || "[object Array]" === Object.prototype.toString.call(t))
                        for (n = 0, r = t.length; r > n; n++) {
                            ...
                            for (a in t) i.push(this._encodeObject(e + "[" + a + "]", t[a]));
        ...
        function s(e) {
            ...
            return d["default"]("string" == typeof t, "github/community.js:13"), document.querySelectorAll('span[data-fieldname="' + t + '"]')
        }

        function u(e) {
            var t = e.getAttribute("data-fieldname");
            return d["default"]("string" == typeof t, "github/community.js:19"), c["default"](document.querySelector('input[data-fieldname="' + t + '"]'), HTMLInputElement)
        }
        ...
        var c = o(e),
            d = o(t);
        a.onFocus(".js-template-form-input", function(e) {
            function t() {
                l(r, a)
            }
            ...
            var r = c["default"](e, HTMLInputElement),
                a = s(r);
        ...
        }), r.on("click", ".js-template-highlight", function() {
            u(this).focus()
        }), n.observe(".js-templates", function() {
            var e = !0,
                t = !1,
                n = void 0;
            try {
                for (var r, a = i.querySelectorAll(document, ".js-template-form-input", HTMLInputElement)[Symbol.iterator](); !(e = (r = a.next()).done); e = !0) {
                    var o = r.value,
                        u = s(o);
                    l(o, u)
                }
        ...
        function s(n) {
            ...
            return regeneratorRuntime.async(function(u) {
                for (;;) switch (u.prev = u.next) {
                    case 0:
                        return r = n, l["default"](r instanceof HTMLFormElement, "github/delegated-account-recovery.js:13"), a = document.querySelector(".js-delegated-account-recovery-submit"), l["default"](a instanceof HTMLButtonElement, "github/delegated-account-recovery.js:16"), i = document.querySelector(".js-create-recovery-token-form"), l["default"](i instanceof HTMLFormElement, "github/delegated-account-recovery.js:19"), r.classList.remove("failed"), r.classList.add("loading"), a.disabled = !0, u.prev = 9, u.next = 12, regeneratorRuntime.awrap(e.fetchForm(i));
                    case 12:
                        return o = u.sent, u.next = 15, regeneratorRuntime.awrap(o.json());
                    case 15:
                        s = u.sent, t.fillFormValues(r, {
                            token: s.token,
                            state: s.state_url
                        }), r.submit(), u.next = 25;
                        break;
        ...
        function u(e) {
            return regeneratorRuntime.async(function(t) {
                for (;;) switch (t.prev = t.next) {
                    case 0:
                        l["default"](e instanceof HTMLFormElement, "github/delegated-account-recovery.js:43"), e.submit();
                    case 2:
                    case "end":
                        return t.stop()
                }
    ...
    }), define("github/perform-transition", ["exports", "./once"], function(e, t) {
        function n(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function r(e, t) {
            ...
            var r = function(e) {
                    var t = a(e);
                    o["default"](e, "transitionend").then(function() {
                        e.style.display = "", e.style.visibility = "", t && i(e, function() {
                            e.style.height = ""
                        })
                    }), e.style.boxSizing = "content-box", e.style.display = "block", e.style.visibility = "visible", t && i(e, function() {
                ...
                c = void 0;
            try {
                for (var d, f = n[Symbol.iterator](); !(u = (d = f.next()).done); u = !0) {
                    var h = d.value;
                    r(h)
                }
            } catch (m) {
            ...
            var v = !0,
                ...
                p = void 0;
            try {
                for (var y, b = n[Symbol.iterator](); !(v = (y = b.next()).done); v = !0) {
                    var h = y.value;
                    if (a(h)) {
                        var j = getComputedStyle(h).height;
                        h.style.boxSizing = "", "0px" === j ? h.style.height = h.scrollHeight + "px" : h.style.height = "0px"
                    }
                }
            } catch (m) {
                g = !0, p = m
        ...
        function d(e) {
            ...
            e.getAttribute("data-initial-state") || e.setAttribute("data-initial-state", e.getAttribute("aria-expanded") || "false"), v["default"](n, function() {
                n.classList.toggle("open"), n.classList.toggle("Details--on"), e.setAttribute("aria-expanded", (e.getAttribute("data-initial-state") !== n.classList.contains("Details--on").toString()).toString()), g["default"](function() {
        ...
        r.on("click", ".js-details-target", function(e) {
            ...
            for (var t = !1, n = e.target;
                (n = n.parentNode) && n !== document.documentElement;) n.classList.contains("Details-content--shown") && (t = !0), n.classList.contains("js-details-container") && (n.classList.toggle("open", !t), n.classList.toggle("Details--on", !t), t = !1)
        })
        ...
        function h(e) {
            ...
            if (t && t.classList.contains("is-placeholder")) return g["default"](t instanceof HTMLElement, "previousElement must be an HTMLElement -- github/sticky.js:128"), t;
            var n = document.createElement("div");
            return n.style.visibility = "hidden", n.style.display = "none", n.style.height = window.getComputedStyle(e).height, n.className = e.className, n.classList.remove("js-sticky"), n.classList.add("is-placeholder"), g["default"](e.parentNode, "Element must be inserted into the dom -- github/sticky.js:141"), e.parentNode.insertBefore(n, e)
        }
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.scrollIntoView = a, e.scrollToFragmentTarget = i, e.computeFixedYOffset = o
        ...
        function v(e) {
            var t = e.querySelector(".js-diff-entry-loader"),
                ...
                r = e.querySelector("button.js-diff-load"),
                a = e.querySelector(".js-button-text");
            j["default"](t && n, "github/diffs/progressive.js:138"), j["default"](r instanceof HTMLButtonElement, "github/diffs/progressive.js:139"), j["default"](a instanceof HTMLElement, "github/diffs/progressive.js:140"), n.setAttribute("fill", "url('#animated-diff-gradient')"), a.textContent = r.getAttribute("data-disable-with") || "", r.disabled = !0;
        ...
        r.observe(".js-diff-progressive-container", function(e) {
            ...
            t && (t.addEventListener("load", function() {
                ...
                var n = u();
                n && l(e, n)
            }), t.addEventListener("error", y), t.addEventListener("error", g))
        ...
        function a(e) {
            var t = new URL(window.location.href, window.location.origin),
                r = e.closest(".file-header"),
                a = e.classList.contains("js-rendered"),
                i = e.classList.contains("js-source");
        ...
        function i(e) {
            var t = e.closest(".js-prose-diff-toggles"),
                n = !0,
                r = !1,
                a = void 0;
            try {
        ...
        t.on("click", ".js-prose-diff-toggles .btn", function(e) {
            ...
            var a = this.closest(".js-details-container"),
                i = a.querySelector(".js-file-content");
            if (i) {
        ...
        e.on("click", ".js-toc-retry", function(e) {
    ...
    }), define("github/google-analytics-octolytics", ["./send-beacon", "./google-analytics"], function(e, t) {
        function n(t) {
            var n = t.get("sendHitTask");
            t.set("sendHitTask", function(t) {
                n(t), "event" === t.get("hitType") && null != window._octo && e.guaranteedPost("//" + window._octo.host + "/collect", t.get("hitPayload"), "application/x-www-form-urlencoded")
            })
        }
        t.providePlugin("octolyticsPlugin", n)
        ...
        function s() {
            ...
            try {
                for (var s, u = document.querySelectorAll("meta[name=analytics-param-rename]")[Symbol.iterator](); !(r = (s = u.next()).done); r = !0) {
                    var l = s.value,
                        c = m["default"](l, HTMLMetaElement).content.split(":", 2);
        ...
        function c() {
            ...
            try {
                for (var f, h = document.querySelectorAll("meta.js-ga-set")[Symbol.iterator](); !(o = (f = h.next()).done); o = !0) {
                    var v = f.value,
                        g = m["default"](v, HTMLMetaElement);
                    n.setDimension(g.name, g.content)
                }
            } catch (p) {
                s = !0, c = p
            } finally {
        ...
        function f() {
            ...
            try {
                for (var a, i = document.querySelectorAll("meta[name=analytics-virtual-pageview]")[Symbol.iterator](); !(e = (a = i.next()).done); e = !0) {
                    var o = a.value;
                    n.trackPageview(m["default"](o, HTMLMetaElement).content, {
                        title: ""
                    })
                }
            } catch (s) {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.updateGlobalFields = c, e.applyEcommercePayload = d, e.trackPageviews = f, e.extractEventParams = h;
        var m = a(r)
        ...
        var u = s(n),
            l = document.querySelector("meta[name=google-analytics]");
        l && (t.setGlobalAccount(u["default"](l, HTMLMetaElement).content, "auto"), t.requirePlugin("octolyticsPlugin"), t.requirePlugin("ec"), e.updateGlobalFields()), i.ready.then(function() {
            ...
            capture: !0
        }), a.on("click", "[data-ga-deferred]", function() {
            o.setItem("ga-deferred", this.getAttribute("data-ga-deferred"))
        }, {
            capture: !0
        }), a.on("change", "[data-ga-change]", function() {
            e.applyEcommercePayload(this.getAttribute("data-ga-ec"));
        ...
        e.on("click", ".js-video-play, .js-video-close, .is-expanded", function(e) {
            e.preventDefault();
            var n = this,
                r = n.classList.contains("js-video-play"),
                a = n.closest(".js-video-container"),
                i = a.querySelector(".js-video-iframe"),
    ...
    }), define("github/issues/bookmark-toggler", ["../typecast", "../fetch", "delegated-events"], function(e, t, n) {
        function r(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function a(e) {
            var n = new FormData,
                r = e.getAttribute("data-authenticity-token"),
                a = i["default"](e.closest(".js-bookmark-toggler-container"), HTMLElement),
                o = i["default"](document.querySelector(".js-bookmarking-error"), HTMLElement),
                s = i["default"](o.querySelector(".js-bookmarking-error-message"), HTMLElement);
            return n.append("authenticity_token", r), a.classList.toggle("on"), t.fetch(e.getAttribute("data-url"), {
                method: "post",
                body: n
            })["catch"](function(e) {
                return e.response ? (a.classList.toggle("on"), o.classList.add("visible"), e.response.json().then(function(e) {
                    s.textContent = e.error
                })) : void 0
            })["catch"](function() {
                a.classList.toggle("on"), o.classList.add("visible"), s.textContent = "Something went wrong."
            })
        }
        var i = r(e);
        n.on("click", ".js-bookmark-toggler-container .js-unbookmark-target", function() {
            a(this)
        }), n.on("click", ".js-bookmark-toggler-container .js-bookmark-target", function() {
            a(this)
        })
        ...
        function u(e, t) {
            var n = void 0;
            if ((n = p.get(e)) || (n = new g["default"], p.set(e, n)), t.value.trim()) {
        ...
        var l = s(n),
            ...
            f = function() {
                ...
                return e.prototype.bindEvents = function(e, n) {
                    ...
                    var e = this.focusedInput;
                    this.inputValue !== e.value && (l["default"](e).removeData("autocompleted"), l["default"](e).trigger("autocomplete:autocompleted:changed")), this.fetchResults(e.value)
                }, e.prototype.fetchResults = function(e) {
                    var t = this.focusedResults.getAttribute("data-search-url");
                    if (t) {
                        var n = l["default"](this.focusedInput).closest(".js-autocomplete-container"),
                            r = e.trim() ? (t += ~t.indexOf("?") ? "&" : "?", t += "q=" + encodeURIComponent(e), n.addClass("is-sending"), o.fetchText(t)) : l["default"](this.focusedResults).find("[data-autocomplete-value]").length > 0 ? this.hideResults() : Promise.resolve("");
                    ...
                    if (null == e && (e = this.focusedInput), null == t && (t = this.focusedResults), !c["default"](t)) {
                        ...
                        var i = r + l["default"](e).innerHeight(),
                            o = l["default"](e).innerWidth();
                        l["default"](t).css({
                            display: "block",
                            position: "absolute",
                            width: o + 2
    ...
    }), define("github/legacy/behaviors/billing/addons", ["../../../observe", "../../../throttled-input", "../../../visible", "../../../pjax", "../../../history", "../../../fetch", "../../../sliding-promise-queue"], function(e, t, n, r, a, i, o) {
        function s(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function u(e) {
            function t(e) {
                ...
                t && t.classList.toggle("d-none", !l);
                var n = document.querySelector(".js-payment-summary");
                n && n.classList.toggle("d-none", l);
                var i = document.querySelector(".js-billing-section");
                i && i.classList.toggle("has-removed-contents", e.free);
                var o = document.querySelector(".js-upgrade-info");
                o && o.classList.toggle("d-none", 0 >= u);
                var s = document.querySelector(".js-downgrade-info");
                s && s.classList.toggle("d-none", u >= 0);
                ...
                for (var f in d) {
                    var h = !0,
                        ...
                        v = void 0;
                    try {
                        for (var g, p = document.querySelectorAll(f)[Symbol.iterator](); !(h = (g = p.next()).done); h = !0) {
                            var y = g.value;
                            y.textContent = d[f]
                        }
                    } catch (b) {
            ...
            var n = e.getAttribute("data-item-name") || "items",
                o = parseInt(e.getAttribute("data-item-minimum")) || 0,
                s = parseInt(e.getAttribute("data-item-count")) || 0,
                u = Math.max(o, parseInt(e.value) || 0),
                l = u > 300,
                c = document.querySelector(".js-purchase-button");
            c instanceof HTMLButtonElement && (c.disabled = 0 === u || l);
            var f = document.querySelector(".js-downgrade-button");
            f instanceof HTMLButtonElement && (f.disabled = u === s);
            var h = new URL(e.getAttribute("data-url"), window.location.origin),
                m = new URLSearchParams(h.search.slice(1));
            m.append(n, u.toString()), h.search = m.toString(), d.push(i.fetchJSON(h)).then(t)
        }
        var l = s(n),
            c = s(o),
            d = new c["default"];
        e.observe(".js-addon-purchase-field", function(e) {
            l["default"](e) && u(e), t.addThrottledInputEventListener(e, function() {
                u(e)
            })
        }), e.observe(".js-addon-downgrade-field", function(e) {
            l["default"](e) && u(e), e.addEventListener("change", function() {
                u(e)
            })
        })
    ...
    function() {
        ...
        define(["jquery"], function(n) {
            var r, a, i, o, s, u, l, c, d, f, h, m, v, g, p, y, b, j, w, L, S, x, k;
            return n.payment = {}, n.payment.fn = {}, n.fn.payment = function() {
                ...
                var t, n, r, a, o, s, u, l;
                for (e = (e + "").replace(/\D/g, ""), a = 0, s = i.length; s > a; a++)
                    for (t = i[a], l = t.patterns, o = 0, u = l.length; u > o; o++)
                        if (r = l[o], n = r + "", e.substr(0, n.length) === n) return t
            }, a = function(e) {
                var t, n, r;
                ...
                return this.on("keypress", S), this.on("keypress", L), this.on("keypress", c), this.on("keypress", f), this.on("keypress", d), this.on("keydown", u), this.on("change", p), this.on("input", p), this
            }, n.payment.fn.formatCardNumber = function() {
                return this.on("keypress", S), this.on("keypress", w), this.on("keypress", l), this.on("keydown", s), this.on("keyup", k), this.on("paste", g), this.on("change", g), this.on("input", g), this.on("input", k), this
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.installCardNumberFormatter = r, e.installCardCVCFormatter = a, e.cardType = i, e.formatCardNumber = o;
        var s = n(t)
        ...
        function s(e) {
            ...
            n && (t = n.textContent);
            var r = t ? d[t] : null,
                a = e.closest(".js-setup-creditcard");
            c["default"](a, "github/legacy/behaviors/billing/credit_card_fields.js:182"), a.classList.toggle("is-vat-country", null != r);
            var i = a.querySelector(".js-vat-help-text");
            c["default"](i, "github/legacy/behaviors/billing/credit_card_fields.js:186"), i.textContent = r ? "(" + r + ")" : "";
            ...
            var s = l["default"](a.querySelector(".js-postal-code-field"), HTMLInputElement),
                u = f.indexOf(t) >= 0;
        ...
        e.observe(".js-card-select-number-field", {
            ...
            var n = u["default"](e).closest("form"),
                r = n.find(".js-card"),
                a = n.find(".js-card-select-type-field");
            u["default"](e).on("input", function() {
                var e = void 0,
                    n = void 0,
                    i = u["default"](this).val(),
                    o = t.cardType(i);
                if (o)
        ...
        r["default"](document).on("change", ".js-payment-methods .js-payment-method", function() {
            var e = r["default"](this).closest(".js-payment-methods"),
                t = r["default"](this).attr("data-selected-tab");
    ...
    }), define("github/stats", ["exports", "./proxy-site-detection", "./metadata", "./send-beacon", "./document-ready"], function(e, t, n, r, a) {
        function i(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function s() {
            if (c = null, !u["default"](document)) {
                var e = n.getMetadataByName(document, "browser-stats-url");
                e && (r.guaranteedPost(e, JSON.stringify({
                    stats: l
                }), "application/json"), l = [])
            }
        }
        ...
        i["default"](document).on("change", "input.js-check-all", function(e) {
            ...
            if (!i["default"](e.relatedTarget).is("input.js-check-all-item")) {
                var o = i["default"](r(this)),
                    s = o.find("input.js-check-all-item");
        ...
        function o(e) {
            var t = document.body;
            c["default"](t, "github/legacy/behaviors/clippable_behavior.js:71");
            var n = a(e);
        ...
        e.on("click", ".js-zeroclipboard", function() {
            ...
            if (t) o(t);
                ...
                var n = this.closest(".js-zeroclipboard-container"),
                    r = n.querySelector(".js-zeroclipboard-target");
        ...
        function i(e) {
            return e.offsetParent ? {
                ...
                top: o["default"](document).scrollTop(),
                left: o["default"](document).scrollLeft()
            }
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.preserveInteractivePosition = i, e.preservingScrollPosition = s;
        var c = a(t),
            d = a(n),
            f = a(r)
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.updateContent = o, e.replaceContent = s;
        var l = i(t),
            c = new WeakMap
        ...
        i["default"](document).on("ajaxBeforeSend", ".js-new-comment-form", function(e) {
            ...
            if (this === n.target) {
                ...
                for (o in m) {
                    ...
                    g ? t.replaceContent(g, v) : console.warn("couldn't find " + o + " for immediate update")
                }
            }
        ...
        e.on("click", ".js-comment-edit-button", function() {
            ...
            if (e.target === e.currentTarget && (console.error("ajaxError for js-comment-update", r), 422 === t.status)) try {
                var s = JSON.parse(t.responseText),
                    u = this.closest(".js-comment"),
                    l = i["default"](u);
                if (o["default"](u, "expected .js-comment-update to be contained by .js-comment -- github/legacy/behaviors/commenting/edit.js:75"), s.stale) return t.stale = !0, l.addClass("is-comment-stale"), l.find(".btn-sm").addClass("disabled"), e.preventDefault();
                if (s.errors) {
            ...
            var e = this.closest(".js-comment"),
                t = this.closest(".js-comment-delete-container");
            ...
            if (e.target === e.currentTarget) {
                ...
                if (s) {
                    ...
                    return u.removeClass("is-comment-stale"),
                        u.removeClass("is-comment-editing")
                }
            }
    ...
    }), define("github/menu", ["exports", "delegated-events", "invariant", "./observe", "./perform-transition"], function(e, t, n, r, a) {
        function i(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function o(e) {
            f && s(f), t.fire(e, "menu:activate") && (document.addEventListener("keydown", l), document.addEventListener("click", u), f = e, d["default"](e, function() {
            ...
            }), t.fire(e, "menu:activated"))
        }

        function s(e) {
            e && t.fire(e, "menu:deactivate") && (document.removeEventListener("keydown", l), document.removeEventListener("click", u), f = null, d["default"](e, function() {
            ...
            }), t.fire(e, "menu:deactivated"))
        }

        function u(e) {
            if (f) {
                var t = f.contains(e.target) || e.target.closest("#facebox, .facebox-overlay");
                t || (e.preventDefault(), s(f))
            }
        }
        ...
        function l(e) {
            if (f) {
                ...
                t && "Escape" === e.key && (f.contains(t) && t.blur(), e.preventDefault(), s(f))
            }
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.activate = o, e.deactivate = s;
        var c = i(n),
            d = i(a),
            f = null;
        t.on("click", ".js-menu-container", function(e) {
            var t = this,
                n = e.target.closest(".js-menu-target");
            n ? (e.preventDefault(), t === f ? s(t) : o(t)) : e.target.closest(".js-menu-content") || t === f && (e.preventDefault(), s(t))
        }), t.on("click", ".js-menu-container .js-menu-close", function(e) {
            s(this.closest(".js-menu-container")), e.preventDefault()
        }), r.observe(".js-menu-container.active", {
            add: function() {
                var e = document.body;
                c["default"](e, "github/menu.js:192"), e.classList.add("menu-active")
            },
            remove: function() {
                var e = document.body;
                c["default"](e, "github/menu.js:197"), e.classList.remove("menu-active")
            }
        })
        ...
        function l(e, n) {
            var r = n.text,
                ...
                o = e.selectionStart,
                s = e.value.slice(0, o),
                u = e.value.slice(e.selectionEnd);
            if (null === y || y) {
                e.contenteditable = !0;
                try {
        ...
        function c(e, t) {
            var n = void 0,
                r = e.value.slice(e.selectionStart, e.selectionEnd);
            return n = t.orderedList ? v(e) : t.multiline && i(r) ? m(e, t) : h(e, t), l(e, n)
        }

        function d(e, t, n) {
            if (e.selectionStart === e.selectionEnd) e.selectionStart = s(e.value, e.selectionStart), e.selectionEnd = u(e.value, e.selectionEnd);
            else {
                var r = e.selectionStart - t.length,
                    a = e.selectionEnd + n.length,
                    i = e.value.slice(r, e.selectionStart) === t,
                    o = e.value.slice(e.selectionEnd, a) === n;
        ...
        function f(e) {
            var t = void 0,
                ...
                r = void 0,
                a = void 0,
                i = e.value.slice(0, e.selectionStart),
                s = e.value.slice(e.selectionEnd),
                u = null != (r = i.match(/\n*$/)) ? r[0].length : 0,
                l = null != (a = s.match(/^\n*/)) ? a[0].length : 0;
        ...
        function h(e, t) {
            var n = void 0,
                ...
                w = void 0,
                L = void 0;
            u = t.prefix, j = t.suffix, n = t.blockPrefix, r = t.blockSuffix, m = t.replaceNext, l = t.prefixSpace, g = t.scanFor, L = t.surroundWithNewlines;
            var S = e.selectionStart,
                x = e.selectionEnd;
            if (p = e.value.slice(e.selectionStart, e.selectionEnd), c = i(p) && n.length > 0 ? n + "\n" : u, w = i(p) && r.length > 0 ? "\n" + r : j, l) {
                var k = e.value[e.selectionStart - 1];
                0 === e.selectionStart || null == k || k.match(/\s/) || (c = " " + c)
            }
            p = d(e, c, w), b = e.selectionStart, y = e.selectionEnd;
            var E = m.length > 0 && w.indexOf(m) > -1 && p.length > 0;
            if (L && (h = f(e), a = h.newlinesToAppend, o = h.newlinesToPrepend, c = a + u, w += o), p.startsWith(c) && p.endsWith(w)) return v = p.slice(c.length, p.length - w.length), S === x ? (s = S - c.length, s = Math.max(s, b), s = Math.min(s, b + v.length), b = y = s) : (b = b, y = b + v.length), {
                text: v,
                selectionStart: b,
                selectionEnd: y
            };
            if (E) return g.length > 0 && p.match(g) ? (w = w.replace(m, p), v = c + w, b = y = b + c.length, {
                text: v,
                selectionStart: b,
                selectionEnd: y
            }) : (v = c + p + w, b = b + c.length + p.length + w.indexOf(m), y = b + m.length, {
                text: v,
                selectionStart: b,
                selectionEnd: y
            });
            if (v = c + p + w, b = S + c.length, y = x + c.length, t.trimFirst) {
                var _ = p.match(/^\s*|\s*$/g),
                    T = _[0] || "",
                    q = _[1] || "";
                v = T + c + p.trim() + w + q, b += T.length, y -= q.length
            }
            return {
                text: v,
                selectionStart: b,
        ...
        t.on("click", ".js-toolbar-item", function() {
            return e.deactivate(this.closest(".js-menu-container")), g(this)
        });
        var b = navigator.userAgent.match(/Macintosh/) ? "meta" : "ctrl",
            j = new WeakMap;
            ...
            if (!j.get(e)) {
                ...
                try {
                    for (var o, s = n.querySelectorAll(".js-toolbar .js-toolbar-item[data-toolbar-hotkey]")[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
                        var u = o.value,
                            l = u.getAttribute("data-toolbar-hotkey");
                        t[b + "+" + l] = u
                    }
                } catch (c) {
                    a = !0, i = c
                ...
                e.addEventListener("keydown", function(e) {
                    var n = p["default"](e),
                        r = n && t[n];
                    r && (g(r), e.preventDefault())
                })
            }
        })
    }), define("github/legacy/behaviors/commenting/preview", ["../../../observe", "../../../onfocus", "../../../typecast", "../../../jquery", "../../../fetch", "../../../sliding-promise-queue", "delegated-events"], function(e, t, n, r, a, i, o) {
        function s(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function l(e) {
            ...
            if (n) {
                ...
                a.style.minHeight = m["default"](r).height() + "px"
            }
            ...
            return regeneratorRuntime.async(function(s) {
                for (;;) switch (s.prev = s.next) {
                    ...
                    case 6:
                        t = JSON.stringify(n);
                    case 7:
                        return a = p.get(e), i = void 0, o = void 0, a && (i = a[0], o = a[1]), i !== t && (y = !1, o = g.push(d(n)), o.then(function() {
                            y = !0
                        }), p.set(e, [t, o])), s.abrupt("return", o);
                    case 12:
                    case "end":
                        return s.stop()
                }
        ...
        function d(e) {
            return a.fetchText(e.url, {
                method: "post",
                body: m["default"].param(e.data),
                headers: e.headers
            })
        }
        ...
        function f(e) {
            ...
            return c(e, t.value).then(function(e) {
                n.innerHTML = e || "<p>Nothing to preview</p>"
            }), y ? void 0 : n.innerHTML = "<p>Loading preview&hellip;</p>"
        }
        var h = s(n),
            m = s(r),
            v = s(i);
        o.on("click", ".js-write-tab", function() {
        ...
        }), m["default"](document).on("click", ".js-preview-tab", function() {
            l(this).then(function(e) {
                f(e)
            });
            var e = this.closest(".js-previewable-comment-form").querySelector(".js-toolbar");
            return null != e && e.classList.add("d-none"), !1
        }), m["default"](document).on("preview:render", ".js-previewable-comment-form", function() {
            var e = this.querySelector(".js-preview-tab");
        ...
        }), t.onKey("keydown", ".js-comment-field", function(e) {
            if ((e.ctrlKey || e.metaKey) && "P" === e.key) {
                var t = h["default"](e.target.closest(".js-previewable-comment-form"), HTMLElement);
                t.classList.contains("write-selected") && (e.target.blur(), t.dispatchEvent(new CustomEvent("preview:render", {
                    bubbles: !0,
                    cancelable: !1
        ...
        e.Jcrop = function(t, n) {
            ...
            function l(e, t, n) {
                if (I = o(U), me.setCursor("move" === e ? e : e + "-resize"), "move" === e) return me.activateHandlers(d(t), g, n);
                var r = de.getFixed(),
                    a = f(e),
                    i = de.getCorner(f(a));
                de.setPressed(de.getCorner(a)), de.setCurrent(i), me.activateHandlers(c(e, r), g, n)
            }
            ...
            function p(e) {
                if (!D.disabled && D.allowSelect) {
                    ...
                    var t = s(e);
                    return de.setPressed(t), he.update(), me.activateHandlers(y, g, "touch" === e.type.substring(0, 5)), ve.watchKeys(), e.stopPropagation(), e.preventDefault(), !1
                }
            }
            ...
            function j(e) {
                $.removeClass().addClass(a("holder")).addClass(e)
            }
            ...
            function w(e, t) {
                ...
                if (!ae) {
                    ...
                    var y = function() {
                        return function() {
                            g += (100 - g) / p, c[0] = Math.round(r + g / 100 * f), c[1] = Math.round(a + g / 100 * h), c[2] = Math.round(i + g / 100 * m), c[3] = Math.round(o + g / 100 * v), g >= 99.8 && (g = 100), 100 > g ? (S(c), n()) : (he.done(), he.animMode(!1), "function" == typeof t && t.call(ge))
                        }
                    }();
                    n()
                }
            ...
            function L(e) {
                S([e[0] / te, e[1] / ne, e[2] / te, e[3] / ne]), D.onSelect.call(ge, v(de.getFixed())), he.enableHandles()
            }
            ...
            function M() {
                $.remove(), F.show(), F.css("visibility", "visible"), e(t).removeData("Jcrop")
            }
            ...
            function A(e, t) {
                ...
                n.onload = function() {
                    var r = n.width,
                        ...
                        i = D.boxWidth,
                        o = D.boxHeight;
                    U.width(r).height(a), U.attr("src", e), Y.attr("src", e), m(U, i, o), W = U.width(), V = U.height(), Y.width(W).height(V), se.width(W + 2 * oe).height(V + 2 * oe), $.width(W).height(V), fe.resize(W, V), T(), "function" == typeof t && t.call(ge)
                }, n.src = e
            }

            function C(e, t, n) {
                var r = t || D.bgColor;
                D.bgFade && i() && D.fadeTime && !n ? e.animate({
                    backgroundColor: r
                }, {
                    queue: !1,
                    duration: D.fadeTime
            ...
            function H(e) {
                D.allowResize ? e ? he.enableOnly() : he.enableHandles() : he.disableHandles(), me.setCursor(D.allowSelect ? "crosshair" : "default"), he.setCursor(D.allowMove ? "move" : "default"), D.hasOwnProperty("trueSize") && (te = D.trueSize[0] / W, ne = D.trueSize[1] / V), D.hasOwnProperty("setSelect") && (L(D.setSelect), he.done(), delete D.setSelect), fe.refresh(), D.bgColor != ue && (C(D.shade ? fe.getShades() : $, D.shade ? D.shadeColor || D.bgColor : D.bgColor), ue = D.bgColor), le != D.bgOpacity && (le = D.bgOpacity, D.shade ? fe.refresh() : he.setBgOpacity(le)), G = D.maxSize[0] || 0, Q = D.maxSize[1] || 0, Z = D.minSize[0] || 0, ee = D.minSize[1] || 0, D.hasOwnProperty("outerImage") && (U.attr("src", D.outerImage), delete D.outerImage), he.refresh()
            }
            ...
            var W = U.width(),
                V = U.height(),
                $ = e("<div />").width(W).height(V).addClass(a("holder")).css({
                    position: "relative",
                    backgroundColor: D.bgColor
                }).insertAfter(F).append(U);
            D.addClass && $.addClass(D.addClass);
            var Y = e("<div />"),
                ...
                K = e("<div />").css({
                    ...
                    var e = de.getFixed();
                    D.onDblClick.call(ge, e)
                }).insertBefore(U).append(J, X);
            B && (Y = e("<img />").attr("src", U.attr("src")).css(N).width(W).height(V), J.append(Y)), O && K.css({
                overflowY: "hidden"
            });
            var G, Q, Z, ee, te, ne, re, ae, ie, oe = D.boundary,
                se = b().width(W + 2 * oe).height(V + 2 * oe).css({
                    position: "absolute",
                    top: r(-oe),
                    left: r(-oe),
                    zIndex: 290
            ...
            var ce = function() {
                ...
                de = function() {
                    ...
                    function r(e) {
                        var t = e[0],
                            n = e[1];
                        0 > f + t && (t -= t + f), 0 > h + n && (n -= n + h), v + n > V && (n += V - (v + n)), m + t > W && (t += W - (m + t)), f += t, m += t, h += n, v += n
                    }
                    ...
                    function i() {
                        ...
                        var e, t, n, r, a = D.aspectRatio,
                            ...
                            y = Math.abs(g),
                            b = p / y;
                        return 0 === o && (o = 10 * W), 0 === c && (c = 10 * V), a > b ? (t = v, n = y * a, e = 0 > d ? f - n : n + f, 0 > e ? (e = 0, r = Math.abs((e - f) / a), t = 0 > g ? h - r : r + h) : e > W && (e = W, r = Math.abs((e - f) / a), t = 0 > g ? h - r : r + h)) : (e = m, r = p / a, t = 0 > g ? h - r : h + r, 0 > t ? (t = 0, n = Math.abs((t - h) * a), e = 0 > d ? f - n : n + f) : t > V && (t = V, n = Math.abs(t - h) * a, e = 0 > d ? f - n : n + f)), e > f ? (i > e - f ? e = f + i : e - f > o && (e = f + o), t = t > h ? h + (e - f) / a : h - (e - f) / a) : f > e && (i > f - e ? e = f - i : f - e > o && (e = f - o), t = t > h ? h + (f - e) / a : h - (f - e) / a), 0 > e ? (f -= e, e = 0) : e > W && (f -= e - W, e = W), 0 > t ? (h -= t, t = 0) : t > V && (h -= t - V, t = V), l(s(f, h, e, t))
                    }

                    function o(e) {
                        return e[0] < 0 && (e[0] = 0), e[1] < 0 && (e[1] = 0), e[0] > W && (e[0] = W), e[1] > V && (e[1] = V), [Math.round(e[0]), Math.round(e[1])]
                    }
                    ...
                    function u() {
                        var e, t = m - f,
                            n = v - h;
                        return G && Math.abs(t) > G && (m = t > 0 ? f + G : f - G), Q && Math.abs(n) > Q && (v = n > 0 ? h + Q : h - Q), ee / ne && Math.abs(n) < ee / ne && (v = n > 0 ? h + ee / ne : h - ee / ne), Z / te && Math.abs(t) < Z / te && (m = t > 0 ? f + Z / te : f - Z / te), 0 > f && (m -= f, f -= f), 0 > h && (v -= h, h -= h), 0 > m && (f -= m, m -= m), 0 > v && (h -= v, v -= v), m > W && (e = m - W, f -= e, m -= e), v > V && (e = v - V, h -= e, v -= e), f > W && (e = f - V, v -= e, h -= e), h > V && (e = h - V, v -= e, h -= e), l(s(f, h, m, v))
                    }
                ...
                fe = function() {
                    ...
                    function u() {
                        f && (h.remove(), Y.show(), f = !1, he.isAwake() ? he.setBgOpacity(D.bgOpacity, 1, 1) : (he.setBgOpacity(1, 1, 1), he.disableHandles()), C($, 0, 1))
                    }
                ...
                he = function() {
                    ...
                    function d(e, t) {
                        K.width(Math.round(e)).height(Math.round(t))
                    }
                    ...
                    function g(e) {
                        var t = de.getFixed();
                        d(t.w, t.h), c(t.x, t.y), D.shade && fe.updateRaw(t), E || y(), e ? D.onSelect.call(ge, v(t)) : D.onChange.call(ge, v(t))
                    }

                    function p(e, t, n) {
                        (E || t) && (D.bgFade && !n ? U.animate({
                            opacity: e
                        }, {
                            queue: !1,
                            duration: D.fadeTime
                    ...
                    function y() {
                        K.show(), D.shade ? fe.opacity(le) : p(le, !0), E = !0
                    }

                    function j() {
                        S(), K.hide(), D.shade ? fe.opacity(1) : p(1), E = !1, D.onRelease.call(ge)
                    }
                    ...
                    var C = b().mousedown(h("move")).css({
                        cursor: "move",
                        position: "absolute",
                        zIndex: 360
                    });
                    return ce.support && C.bind("touchstart.jcrop", ce.createDragger("move")), J.append(C), S(), {
                        updateVisible: m,
                        update: g,
                        release: j,
                        refresh: f,
                ...
                me = function() {
                    function t(t) {
                        se.css({
                            zIndex: 450
                        }), t ? e(document).bind("touchmove.jcrop", o).bind("touchend.jcrop", u) : f && e(document).bind("mousemove.jcrop", r).bind("mouseup.jcrop", a)
                    }
                    ...
                    function a(e) {
                        return e.preventDefault(), e.stopPropagation(), re && (re = !1, d(s(e)), he.isAwake() && D.onSelect.call(ge, v(de.getFixed())), n(), c = function() {}, d = function() {}), !1
                    }
                    ...
                    var c = function() {},
                        d = function() {},
                        f = D.trackDocument;
                    return f || se.mousemove(r).mouseup(a).mouseout(a), U.before(se), {
                        activateHandlers: i,
                        setCursor: l
                    }
                }(),
                ve = function() {
                    ...
                    return D.keySupport && (i.keydown(a).blur(n), O || !D.fixedSupport ? (i.css({
                        position: "absolute",
                        left: "-20px"
                    }), o.append(i).insertBefore(U)) : i.insertBefore(U)), {
                        watchKeys: t
                    }
                }();
            ...
            return R && $.bind("selectstart", function() {
                return !1
            }), F.data("Jcrop", ge), ge
        ...
        var a = n(t),
            i = function() {
                ...
                return e.prototype.setTrueSize = function(e) {
                    ...
                    if (0 !== t && 0 !== n) {
                        var r = parseInt(this.croppedX.val()),
        ...
        var i = n(e),
            o = new WeakMap,
            s = ["input[type=submit][data-disable-with]", "button[data-disable-with]"].join(", ");
        t.on("submit", "form", function() {
            ...
            capture: !0
        }), i["default"](document).on("ajaxComplete", "form", function(e) {
            if (this === e.target) {
                var t = !0,
                    n = !1,
                    r = void 0;
    ...
    }), define("github/legacy/behaviors/facebox", ["../../history", "../../observe", "../../facebox", "../../jquery", "../../hash-change", "../../restrict-tab-behavior"], function(e, t, n, r, a, i) {
        function o(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        c["default"](function() {
            ...
            setTimeout(function() {
                s(e)
            }, 0), l["default"](e).on("keydown", d["default"])
        }), document.addEventListener("facebox:afterClose", function() {
            l["default"]("#facebox").off("keydown", d["default"]), l["default"]("#facebox :focus").blur()
        }), t.observe("a[rel*=facebox]", function(e) {
            n.addFaceboxEventListener(e)
        }), document.addEventListener("facebox:close", n.teardownOnClose), l["default"](document).on("click", ".js-facebox-close", n.close)
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.fuzzyScore = t, e.fuzzySort = n, e.fuzzyRegexp = a, e.fuzzyHighlightElement = i
        ...
        function a(e, n, r) {
            ...
            if (null == r && (r = {}), e) {
                n = n.toLowerCase();
                var w = null != r.content ? r.content : o,
                    L = null != r.text ? r.text : s,
                    S = null != r.score ? r.score : t.fuzzyScore,
                    x = r.limit;
                r.mark === !0 ? j = c : null != r.mark && null != r.mark.call && (j = r.mark);
                var k = l.get(e);
                for (k ? a = u["default"](e).children() : (a = k = u["default"](e).children(), l.set(e, k.slice(0))), d = 0, g = a.length; g > d; d++) f = a[d], e.removeChild(f), f.style.display = "";
                ...
                if (n) {
                    ...
                    for (h = 0, p = k.length; p > h; h++) f = k[h], (!x || x > _) && (T++, j && j(w(f)), E.appendChild(f)), _++;
        ...
        function r(e, t, n) {
            ...
            if (null == n && (n = {}), e) {
                t = t.toLowerCase();
                var l = null != n.text ? n.text : a,
                    c = o["default"](e).children(),
                    d = n.limit;
        ...
        function r(e, t, n) {
            ...
            if (null == n && (n = {}), e) {
                ...
                var l = null != n.text ? n.text : a,
                    c = n.limit,
                    d = o["default"](e).children();
                n.mark === !0 ? u = i : null != n.mark && null != n.mark.call && (u = n.mark);
                var f = 0;
                for (r = 0, s = d.length; s > r; r++) {
                    var h = d[r]; - 1 !== l(h).indexOf(t) ? c && f >= c ? h.style.display = "none" : (f++, h.style.display = "", u && (u(h), u(h, t))) : h.style.display = "none"
                }
                return f
            }
        }
        ...
        var o = n(t)
    }), define("github/substring-memory-filter-list", ["exports", "./typecast", "invariant", "./query-selector"], function(e, t, n, r) {
        function a(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function s(e, t, n) {
            function a(e) {
                var n = !(i && S >= i) && u(e).indexOf(t) >= 0,
                    r = n || e.selected;
                if (r) {
                    var a = l(e, o, s);
                    a.classList.toggle("d-none", !n), n && S++, x.appendChild(a)
                }
            }
            var i = n.limit,
                o = c["default"](e.querySelector("template"), HTMLTemplateElement),
                s = {},
                h = !0,
                m = !1,
                v = void 0;
            try {
                for (var g, p = r.querySelectorAll(e, "input[type=hidden]", HTMLInputElement)[Symbol.iterator](); !(h = (g = p.next()).done); h = !0) {
                    var y = g.value;
                    s["" + y.name + y.value] = y
                }
            } catch (b) {
            ...
            for (var j = o.nextElementSibling; j;) {
                var w = j;
                j = w.nextElementSibling, w.classList.contains("selected") || w.classList.contains("select-menu-divider") ? w.classList.add("d-none") : w.remove()
            }
            var L = f.get(e);
            d["default"](null != L, "github/substring-memory-filter-list.js:51");
            var S = 0,
                x = document.createDocumentFragment(),
                k = e.querySelector(".js-divider-suggestions"),
                E = e.querySelector(".js-divider-rest");
            if (k && L.suggestions) {
                var _ = !0,
                    T = !1,
                    q = void 0;
                try {
                    for (var M, A = L.suggestions[Symbol.iterator](); !(_ = (M = A.next()).done); _ = !0) {
                        var C = M.value;
                        a(C)
                    }
                } catch (b) {
                ...
                x.childNodes.length && (k.after(x), k.classList.toggle("d-none", 0 === S), x = document.createDocumentFragment())
            }
            var H = S,
                I = !0,
                D = !1,
                P = void 0;
            try {
                for (var R, O = L.users[Symbol.iterator](); !(I = (R = O.next()).done); I = !0) {
                    var N = R.value;
                    a(N)
                }
            } catch (b) {
            ...
            return e.append(x), E && E.classList.toggle("d-none", S === H || 0 === H), S
        }
        ...
        function l(e, t, n) {
            ...
            var r = t.content.cloneNode(!0),
                a = c["default"](r.querySelector("input[type=checkbox]"), HTMLInputElement);
            e.type && (a.name = "reviewer_" + e.type + "_ids[]"), a.value = e.id;
            var i = "" + a.name + e.id,
                o = e.selected;
            n[i] && (o = !0, n[i].remove(), delete n[i]);
            var s = r.querySelector(".js-navigation-item");
            d["default"](s instanceof HTMLElement, "github/substring-memory-filter-list.js:118"), o && (s.classList.add("selected"), a.checked = !0), e.disabled && s.classList.add("disabled");
            var u = r.querySelector(".js-username");
            u && (u.textContent = e.login);
            var l = r.querySelector(".js-description");
            l && (l.textContent = e.name);
            var f = r.querySelector(".js-extended-description");
            f && (e.description ? f.textContent = e.description : f.remove());
            var h = c["default"](r.querySelector(".js-avatar"), HTMLImageElement);
            return h.src = e.avatar, e.element = s, e.element
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.storeData = i, e.hasData = o, e.substringMemoryFilterList = s;
        var c = a(t),
            d = a(n),
            f = new WeakMap
    }), define("github/legacy/behaviors/filterable", ["../../observe", "delegated-events", "../../throttled-input", "../../jquery", "../../fuzzy-filter-sort-list", "../../prefix-filter-list", "../../substring-filter-list", "../../substring-memory-filter-list", "../../setimmediate"], function(e, t, n, r, a, i, o, s, u) {
        function l(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function c(e, t) {
            ...
            switch (e.getAttribute("data-filterable-type")) {
                ...
                case "substring-memory":
                    a = s.substringMemoryFilterList(e, t, {
                        limit: r
                    });
                    break;
                default:
        ...
        e.observe(".js-filterable-field", function(e) {
            function r() {
                var e = this;
                i !== this.value && (i = this.value, v["default"](function() {
        ...
        }), d["default"](document).on("filterable:change", ".js-filterable-field", function() {
            ...
            try {
                for (var i, o = t[Symbol.iterator](); !(n = (i = o.next()).done); n = !0) {
                    var u = i.value;
                    if ("substring-memory" !== u.getAttribute("data-filterable-type") || s.hasData(u)) {
                        c(u, e);
                        var l = new CustomEvent("filterable:change", {
                            bubbles: !0,
                            cancelable: !1
                        });
                        l.relatedTarget = this, u.dispatchEvent(l)
                    }
                }
            } catch (d) {
                r = !0, a = d
            ...
            var n = e.target.querySelector('[data-filterable-type="substring-memory"]');
            if (n) {
                s.storeData(n, e.detail.data);
                var r = e.target.querySelector(".js-filterable-field");
                r && r === document.activeElement && t.fire(r, "filterable:change")
            }
        })
        ...
        function n() {
            ...
            if (i = this.getAttribute("data-url")) {
                var o = e.fetchJSON(i),
                    ...
                    u = document.querySelectorAll(".js-issue-link[data-id='" + s + "']");
        ...
        e.onKey("keydown", "div.btn-sm, span.btn-sm", function(e) {
        ...
        function r(e, t) {
            var n = e.split("/", 3).join("/"),
                r = t.split("/", 3).join("/");
            return n === r
        }
        var a = n(e);
        t.on("pjax:click", "#js-repo-pjax-container a[href]", function(e) {
            r(this.pathname, location.pathname) || e.preventDefault()
        }), t.on("pjax:click", ".js-comment-body", function(e) {
            a["default"](e.target instanceof HTMLAnchorElement, "github/legacy/behaviors/pjax/exceptions.js:23"), "files" === e.target.pathname.split("/")[3] && e.preventDefault()
        })
        ...
        t.ready.then(function() {
            ...
            i["default"](e instanceof CustomEvent, "github/legacy/behaviors/pjax/head.js:18");
            var t = void 0,
                n = void 0,
                r = void 0,
                s = e.detail.contents;
            ...
            if (e) {
                ...
                var t = a["default"](e).not("title, script, link[rel='stylesheet']"),
                    n = a["default"](e).filter("link[rel='stylesheet']");
        ...
        e.ready.then(function() {
            var e = document.body;
            r["default"](e, "github/legacy/behaviors/print_popup.js:7"), e.classList.contains("js-print-popup") && (window.print(), setTimeout(window.close, 1e3))
        })
        ...
        var a = r(n);
        e.onKey("keydown", ".js-quick-submit", function(e) {
            if ((e.ctrlKey || e.metaKey) && "Enter" === e.key) {
                var n = e.target.form;
                a["default"](n instanceof HTMLFormElement, "github/legacy/behaviors/quick_submit.js:15");
                var r = n.querySelector("input[type=submit], button[type=submit]");
                r && r.disabled || t.submit(n), e.preventDefault()
            }
        })
    }), define("github/legacy/behaviors/quicksearch", ["../../form", "../../navigation", "../../sliding-promise-queue", "../../fetch", "../../onfocus", "../../typecast", "invariant", "delegated-events"], function(e, t, n, r, a, i, o, s) {
        function u(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function l(e) {
            v["default"](e instanceof HTMLInputElement, "github/legacy/behaviors/quicksearch.js:41");
            var n = m["default"](e.form, HTMLFormElement);
            t.push(n.querySelector(".js-quicksearch-results"))
        }

        function c(e) {
            v["default"](e.currentTarget instanceof HTMLFormElement, "github/legacy/behaviors/quicksearch.js:47");
            var n = e.currentTarget.querySelector(".js-quicksearch-results");
            n && (n.classList.remove("active"), t.pop(n))
        }

        function d(n) {
            v["default"](n instanceof CustomEvent, "github/legacy/behaviors/quicksearch.js:56");
            var r = n.currentTarget,
                a = r.closest("form");
            v["default"](a instanceof HTMLFormElement, "github/legacy/behaviors/quicksearch.js:59");
            var i = a.querySelector(".js-quicksearch-results");
            v["default"](i && n.detail.hotkey, "github/legacy/behaviors/quicksearch.js:61"), "esc" === n.detail.hotkey ? (i.classList.remove("active"), t.clear(i)) : "enter" !== n.detail.hotkey || r.classList.contains("js-navigation-item") || (e.submit(a), n.preventDefault())
        }
        ...
        function f(e) {
            ...
            var n = m["default"](e.target, HTMLInputElement),
                a = n.value.replace(/^\s+|\s+$/g, ""),
                i = n.closest("form");
            v["default"](i, "github/legacy/behaviors/quicksearch.js:75");
            var o = i.querySelector(".js-quicksearch-results");
            v["default"](o, "github/legacy/behaviors/quicksearch.js:77");
            var s = o.getAttribute("data-quicksearch-url");
            v["default"](s, "github/legacy/behaviors/quicksearch.js:79");
            var u = void 0;
            if (a.length) {
                var l = new URL(s, window.location.origin),
                    c = new URLSearchParams(l.search.slice(1));
                c.append("q", a), l.search = c.toString(), i.classList.add("is-sending"), u = r.fetchText(l)
            } else u = Promise.resolve("");
            v["default"](g, "github/legacy/behaviors/quicksearch.js:97"), g.push(u).then(function(e) {
                var t = i.querySelector(".js-quicksearch-results");
                v["default"](t, "github/legacy/behaviors/quicksearch.js:100"), t.innerHTML = e, t.classList.toggle("active", "" !== a)
            }).then(t, t)
        }
        var h = u(n),
            m = u(i),
            v = u(o),
            g = new h["default"];
        a.onFocus(".js-quicksearch-field", l), a.onInput(".js-quicksearch-field", f), s.on("navigation:keydown", ".js-quicksearch-results", d), s.on("submit", ".js-quicksearch-form", c)
        ...
        function a(e) {
            c["default"](null != e.parentNode && e.parentNode instanceof HTMLElement, "github/markdown-parsing.js:10");
        ...
        function l(e) {
            ...
            d = 0, c["default"](null != e.anchorNode && null != e.anchorNode.parentNode && e.anchorNode.parentNode instanceof HTMLElement, "selection's anchorNode and parentNode must not be null -- github/markdown-parsing.js:183");
            var n = e.anchorNode.parentNode.closest("li");
            if (n && (c["default"](null != n.parentNode, "github/markdown-parsing.js:188"), "OL" === n.parentNode.nodeName && (d = a(n)), !t.querySelector("li"))) {
                var r = document.createElement("li");
                c["default"](null != n.parentNode, "github/markdown-parsing.js:196");
        ...
        var c = n(t),
            ...
            f = {
                ...
                CODE: function(e) {
                    var t = e.textContent;
                    return c["default"](null != e.parentNode, "github/markdown-parsing.js:51"), "PRE" === e.parentNode.nodeName ? e.textContent = t.replace(/^/gm, "    ") : t.indexOf("`") >= 0 ? "`` " + t + " ``" : "`" + t + "`"
                },
                PRE: function(e) {
                    c["default"](null != e.parentNode && e.parentNode instanceof HTMLElement, "github/markdown-parsing.js:62");
                    var t = e.parentNode;
                ...
                A: function(e) {
                    ...
                    return c["default"](null != n, "github/markdown-parsing.js:92"), "[" + t + "](" + n + ")"
                },
                IMG: function(e) {
                    var t = e.getAttribute("alt");
                    if (c["default"](null != t, "github/markdown-parsing.js:100"), r(e, "emoji")) return t;
                    var n = e.getAttribute("src");
                    return c["default"](null != n, "github/markdown-parsing.js:107"), "![" + t + "](" + n + ")"
                },
                LI: function(e) {
                    var t = e.parentNode;
                    if (c["default"](null != t, "github/markdown-parsing.js:115"), !s(e)) switch (t.nodeName) {
                        case "UL":
                            e.prepend("* ");
                            break;
                        case "OL":
        ...
        function i(e, t) {
            var n = document.body;
            s["default"](n, "github/legacy/behaviors/quote-markdown-selection.js:16");
        ...
        e.on("quote:selection", ".js-quote-markdown", function(e) {
            s["default"](e instanceof CustomEvent, "github/legacy/behaviors/quote-markdown-selection.js:37");
        ...
        o["default"](document).on("ajaxSuccess", ".js-pick-reaction", function(e, n, a, i) {
            ...
            var s = this.closest(".js-comment");
            if (s) {
                var u, l, c = o["default"].parseHTML(i.reactions_container.trim()),
                    d = o["default"].parseHTML(i.comment_header_reaction_button.trim());
        ...
        i["default"](document).on("focusin", ".js-repo-filter .js-filterable-field", function() {
            ...
            var n = void 0,
                ...
                o = i.querySelector(".js-more-repos-link");
            o && a(o);
                ...
                try {
                    for (var d, f = JSON.parse(a)[Symbol.iterator](); !(o = (d = f.next()).done); o = !0) {
                        ...
                        if (e.fire(document, "session:resume", {
                            ...
                            p && (p instanceof HTMLInputElement || p instanceof HTMLTextAreaElement) && p.value === p.defaultValue && (p.value = g, i.push(p))
                        }
                    }
                } catch (y) {
                    s = !0, u = y
            ...
            if (e instanceof HTMLMetaElement) {
                ...
                window.addEventListener("storage", function(e) {
                    if (e.storageArea === localStorage && "logged-in" === e.key && e.newValue !== a) {
                        ...
                        r["default"](n instanceof HTMLElement, "Flash element must exist and be an HTMLElement -- github/legacy/behaviors/stale_session.js:40"), n.classList.toggle("is-signed-in", "true" === a), n.classList.toggle("is-signed-out", "false" === a), n.classList.remove("d-none"), window.addEventListener("popstate", function(e) {
        ...
        function r(e, t) {
            ...
            var m = void 0,
                v = void 0;
            if ("number" == typeof t) {
                var g = e.value.substring(0, t);
                g && (m = document.createTextNode(g)), g = e.value.substring(t), g && (v = document.createTextNode(g))
            } else {
                var p = e.value;
                p && (m = document.createTextNode(p))
            }
            return m && r.appendChild(m), h && r.appendChild(h), v && r.appendChild(v), r.parentElement || (a["default"](e.parentElement, "textField must have a parentElement to mirror -- github/text-field-mirror.js:114"), e.parentElement.insertBefore(r, e)), r.scrollTop = e.scrollTop, r.scrollLeft = e.scrollLeft, r
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e["default"] = r;
        var a = n(t),
            i = ["position:absolute;", "overflow:auto;", "word-wrap:break-word;", "top:0px;", "left:-9999px;"],
            o = ["box-sizing", "font-family", "font-size", "font-style", "font-variant", "font-weight", "height", "letter-spacing", "line-height", "max-height", "min-height", "padding-bottom", "padding-left", "padding-right", "padding-top", "border-bottom", "border-left", "border-right", "border-top", "text-decoration", "text-indent", "text-transform", "width", "word-spacing"],
            s = new WeakMap
        ...
        function a(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e.selectionEnd,
                n = o["default"](e, t),
                r = i["default"](n).find(".text-field-mirror-marker").position();
        ...
        var i = r(t),
            o = r(n)
    }), define("github/suggester", ["exports", "./fetch", "./navigation", "./jquery", "./typecast", "invariant", "./parse-html", "./text-field-selection-position"], function(e, t, n, r, a, i, o, s) {
        function u(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        var c = u(r),
            ...
            y = function() {
                function e(t) {
                    l(this, e), this.setup = this.setup.bind(this), this.teardown = this.teardown.bind(this), this.textarea = t.input, this.types = t.types, this.suggester = t.suggester, this.repositionManually = t.repositionManually, this.teardownManually = t.teardownManually, this.onActivate = t.onActivate, this.suggestions = t.suggestions || document.createElement("div"), this.disable = t.disable
                }
                return v(e, [{
                    key: "setup",
                    value: function() {
                    ...
                    value: function(e) {
                        var t = this,
                            ...
                            r = this.textarea.value.substring(0, this.currentSearch.endIndex),
                            a = this.textarea.value.substring(this.currentSearch.endIndex);
                        this.currentSearch.type.onSelection ? this.currentSearch.type.onSelection(n) : (r = r.replace(this.currentSearch.type.match, this.currentSearch.type.replace.replace("$value", n)), this.textarea.value = r + a), this.deactivate(), this.textarea.focus(), this.textarea.selectionStart = r.length, this.textarea.selectionEnd = r.length;
                        var i = this.suggester.getAttribute("data-log-mention-url");
                        if (i) {
                            var o = this.suggester.getAttribute("data-log-mention-authenticity-token");
                            o && requestIdleCallback(function() {
                                return t.logMention(i, o, e.target, t.currentSearch.query)
                            })
                        }
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        if (t) {
                            var n = null,
                                r = null;
                            if ("mention" === t.type.typeid && (n = this.suggestions.querySelector(".js-mention-suggestion-template"), n && (r = g.get(n), !r))) {
                                var a = n.getAttribute("data-mentions-json");
                                f["default"]("string" == typeof a, "must have data-mentions-json attribute -- github/suggester.js:217"), r = JSON.parse(a), g.set(n, r)
                            }
                            if (this.currentSearch && this.currentSearch === t.query) return;
                            return this.currentSearch = t, this.search(t.type, t.query, r, n).then(function(n) {
                    ...
                    value: function(e, t, n) {
                        ...
                        try {
                            for (var o, s = t[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
                                ...
                                var l = e.children[e.children.length - 1];
                                "user" === u.type ? this.renderUserResult(u, l) : "team" === u.type && this.renderTeamResult(u, l), l.setAttribute("data-mentionable-type", u.type), l.setAttribute("data-mentionable-id", u.id)
                            }
                        } catch (c) {
                            a = !0, i = c
                        } finally {
                    ...
                    value: function(e, t) {
                        var n = d["default"](t.querySelector(".js-suggestion-text"), HTMLElement);
                        n.textContent = e.login;
                        var r = d["default"](t.querySelector(".js-suggestion-secondary-text"), HTMLElement);
                        r.textContent = e.name, t.setAttribute("data-value", e.login), t.setAttribute("data-text", e.login + " " + e.name)
                    }
                }, {
                    ...
                    value: function(e, t) {
                        ...
                        var r = d["default"](t.querySelector(".js-suggestion-secondary-text"), HTMLElement);
                        r.textContent = e.description, t.setAttribute("data-value", e.name), t.setAttribute("data-text", e.name + " " + e.description)
                    }
                }, {
                    key: "activate",
                    value: function(e) {
                        this.textarea === document.activeElement && (this.onActivate && this.onActivate(this.suggester), this.repositionManually || c["default"](this.suggester).css(h["default"](this.textarea, e + 1)), this.suggester.classList.contains("active") || (this.suggester.classList.add("active"), this.textarea.classList.add("js-navigation-enable"), n.push(this.suggester), n.focus(this.suggester)))
                    }
                }, {
                    key: "deactivate",
                    value: function() {
                    ...
                    value: function(e, t, r, a) {
                        var i = this;
                        return e.search(this.suggestions, t, r).then(function(e) {
                            var t = m(e, 2),
                                o = t[0],
                                s = t[1],
                                u = s;
                            if (s && "number" != typeof s && (u = s.length), u > 0) {
                                var l = o[0].cloneNode(!0);
                                return r && i.renderResults(l, s, a), i.suggester.innerHTML = "", i.suggester.appendChild(l), l.style.display = "block", n.focus(i.suggester), !0
                            }
                            return !1
                        })
                    }
                    ...
                    value: function(e) {
                        var t = o.parseHTML(document, e);
                        return this.suggestions.appendChild(t), document.activeElement === this.textarea ? (this.currentSearch = null, this.checkQuery()) : void 0
                    }
                }]), e
            }();
        e["default"] = y
    }), define("github/fuzzy-filter-sort", ["exports", "./fuzzy-filter"], function(e, t) {
        function n(e, n, a) {
            n = n.toLowerCase();
            var i = a.text,
                o = null != a.score ? a.score : t.fuzzyScore,
                s = e;
            if (n) {
                s = [];
                var u = !0,
                ...
                try {
                    for (var d, f = e[Symbol.iterator](); !(u = (d = f.next()).done); u = !0) {
                        var h = d.value;
                        null == h.fuzzyFilterTextCache && (h.fuzzyFilterTextCache = i(h)), h.fuzzyFilterScoreCache = o(h.fuzzyFilterTextCache, n, h), h.fuzzyFilterScoreCache > 0 && s.push(h)
                    }
                } catch (m) {
                    l = !0, c = m
                } finally {
            ...
            return a.limit ? s.slice(0, a.limit) : s
        }
    ...
    }), define("github/legacy/behaviors/suggester", ["../../jquery", "../../suggester", "../../fuzzy-filter-sort", "../../fuzzy-filter-sort-list"], function(e, t, n, r) {
        function a(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function v(e) {
            var t = e.match(/`{3,}/g);
            return t || (t = g(e).match(/`/g)), null != t && t.length % 2
        }
            ...
            w = {
                mention: {
                    ...
                    search: function(e, t, n) {
                        var r = m(t),
                            a = p["default"](e).find("ul.mention-suggestions"),
                            i = void 0;
                        return i = n ? b["default"](n, t, {
                            limit: 5,
                            score: function(e, t, n) {
                                var a = r.score(e),
                                    i = n.score;
                                return "number" == typeof i ? a * i : a
                            },
                            text: function(e) {
                            ...
                            score: function(e, t, n) {
                                var a = r.score(e, t, n),
                                    i = n.getAttribute("data-mentionable-score");
                ...
                hashed: {
                    ...
                    search: function(e, t) {
                        var n = void 0,
                            r = p["default"](e).find("ul.hashed-suggestions"),
                            a = /^\d+$/.test(t) ? (n = new RegExp("\\b" + t), function(e) {
                                return l(e, n)
                            }) : m(t).score,
                            i = j["default"](r[0], t, {
                                limit: 5,
        ...
        var d = l(e),
            ...
            p = function() {
                ...
                return g(e, [{
                    ...
                    value: function(e, t) {
                        var n = this,
                            a = f["default"](e).find("ul.js-tag-suggestions"),
                            i = a[0];
                        if (i.hasAttribute("data-url")) return new Promise(function(e) {
                            clearTimeout(n.delayTimer), n.delayTimer = setTimeout(function() {
                                ...
                                var o = new URL(i.getAttribute("data-url"), window.location.origin),
    ...
    }), define("github/legacy/behaviors/team-members", ["../../fetch", "../../observe"], function(e, t) {
        function n() {
            var t = this,
                n = this.getAttribute("data-url");
            if (n) {
                var i = e.fetchJSON(n),
                    o = this.getAttribute("data-id"),
                    s = document.querySelectorAll(".js-team-mention[data-id='" + o + "']"),
                    u = !0,
                    l = !1,
                    c = void 0;
                try {
                    for (var d, f = s[Symbol.iterator](); !(u = (d = f.next()).done); u = !0) {
                        var h = d.value;
                        h.removeAttribute("data-url")
                    }
                } catch (m) {
                    l = !0, c = m
                } finally {
                ...
                i.then(function(e) {
                    0 === e.total ? e.members.push("This team has no members") : e.total > e.members.length && e.members.push(e.total - e.members.length + " more"), r(s, a(e.members))
                })["catch"](function(e) {
                    var n = e.response ? e.response.status : 500,
                        a = t.getAttribute(404 === n ? "data-permission-text" : "data-error-text");
                    r(s, a)
                })
            }
        }
        ...
        function r(e, t) {
            ...
            try {
                for (var i, o = e[Symbol.iterator](); !(n = (i = o.next()).done); n = !0) {
                    var s = i.value;
                    s.setAttribute("aria-label", t), s.classList.add("tooltipped", "tooltipped-s", "tooltipped-multiline")
                }
            } catch (u) {
                r = !0, a = u
            } finally {
        ...
        var d = a(t),
            ...
            h = 0,
            m = -1
    }), define("github/legacy/behaviors/unread_comments", ["../../observe", "delegated-events", "../../form", "../../in-viewport"], function(e, t, n, r) {
        function a(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function i() {
            if (document.hasFocus()) {
                ...
                e && e instanceof HTMLFormElement && n.submit(e)
            }
        }
        ...
        }), t.on("socket:message", ".js-discussion", function(e) {
            if (this === e.target) {
                var t = !0,
                    n = !1,
                    r = void 0;
                try {
                    for (var a, i = document.querySelectorAll(".js-unread-item")[Symbol.iterator](); !(t = (a = i.next()).done); t = !0) {
                        var s = a.value;
                        o(s)
                    }
                } catch (u) {
        ...
        var i = n(e),
            o = n(t);
        i["default"].event.special["user:resize"] = {
            setup: r,
            teardown: a
        }
        ...
        t.on("click", ".js-new-user-contrib-example", function(e) {
            ...
            a["default"](i instanceof HTMLElement, "`js-calendar-graph` element must exist -- github/legacy/graphs/calendar-sample.js:14"), i.classList.contains("sample-graph") || (i.classList.add("sample-graph"), n.fetchText(this.getAttribute("href")).then(t, r))
        })
    }), define("github/legacy/graphs/network", ["../../typecast", "../../observe", "../../dimensions", "../../fetch", "invariant"], function(e, t, n, r, a) {
        function i(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        var s = i(e),
            ...
            c = function() {
                function e(t, n, r) {
                    o(this, e), this.container = t, this.width = n, this.height = r, this.ctx = this.initCanvas(this.container), this.startLoader("Loading graph data"), this.loadMeta()
                }
                return l(e, [{
                    key: "initCanvas",
                    value: function(e) {
                        var t = e.getElementsByTagName("canvas")[0];
                        u["default"](t instanceof HTMLCanvasElement, "github/legacy/graphs/network.js:38"), t.style.zIndex = "0";
                        var n = t.width,
                            r = t.height,
                            a = t.getContext("2d");
                        u["default"](a, "github/legacy/graphs/network.js:44");
                        var i = window.devicePixelRatio || 1,
                            o = a.webkitBackingStorePixelRatio || a.mozBackingStorePixelRatio || a.msBackingStorePixelRatio || a.oBackingStorePixelRatio || a.backingStorePixelRatio || 1,
                            s = i / o;
                    ...
                    value: function() {
                        ...
                        u["default"](e, "github/legacy/graphs/network.js:72"), e.classList.add("d-none")
                    }
                }, {
                    key: "displayLoader",
                    value: function() {
                        var e = this.container.querySelector(".large-loading-area");
                        u["default"](e, "github/legacy/graphs/network.js:78"), e.classList.remove("d-none")
                    }
                }, {
                    key: "loadMeta",
                    value: function() {
                        ...
                        return regeneratorRuntime.async(function(a) {
                            for (;;) switch (a.prev = a.next) {
                                case 0:
                                    return a.prev = 0, e = this.container.getAttribute("data-network-graph-meta-url"), a.next = 4, regeneratorRuntime.awrap(r.fetchPoll(e, {
                                        headers: {
                                ...
                                case 7:
                                    n = a.sent, this.init(n), a.next = 14;
                                    break;
                                case 11:
                                    a.prev = 11, a.t0 = a["catch"](0), this.initError();
                                case 14:
                                case "end":
                                    return a.stop()
                            }
                    ...
                    value: function(e) {
                        var t = void 0,
                            ...
                            a = void 0;
                        if (g) {
                            var i = this.focus = e.focus,
                                o = this.nethash = e.nethash,
                                s = this.spaceMap = e.spacemap,
                                u = this.userBlocks = e.blocks,
                                l = this.commits = function() {
                                    var n = void 0,
                                        a = void 0,
                                        i = e.dates,
                                        o = [];
                                    for (r = n = 0, a = i.length; a > n; r = ++n) t = i[r], o.push(new d(r, t));
                                    return o
                                }(),
                                c = this.users = {},
                                p = e.users;
                            for (n = 0, a = p.length; a > n; n++) {
                                var y = p[n];
                                this.users[y.name] = y
                            }
                            var b = this.chrome = new f(this, this.ctx, this.width, this.height, i, l, u, c),
                                j = this.graph = new h(this, this.ctx, this.width, this.height, i, l, c, s, u, o);
                            this.mouseDriver = new m(this.container, b, j), this.keyDriver = new v(b, j), this.stopLoader(), j.drawBackground(), b.draw(), j.requestInitialChunk()
                        }
                    }
                }, {
                    key: "initError",
            ...
            h = function() {
                function e(t, n, r, a, i, s, u, l, c, d) {
                    ...
                    for (h = 0, g = S.length; g > h; h++)
                        for (f = S[h], m = v = w = f.start, L = f.start + f.count; L >= w ? L > v : v > L; m = L >= w ? ++v : --v) this.spaceUserMap[m] = this.users[f.name];
                    this.headsMap = {};
                    var x = this.userBlocks;
                    for (b = 0, p = x.length; p > b; b++) {
                        f = x[b];
                        var k = this.users[f.name],
                            E = k.heads;
                ...
                return l(e, [{
                    ...
                    value: function(e, t) {
                        ...
                        for (r = n = a = o.min, i = o.max; i >= a ? i >= n : n >= i; r = i >= a ? ++n : --n) {
                            var s = this.commits[r],
                                u = this.offsetX + s.time * this.nameLineHeight,
                                l = this.offsetY + this.graphTopOffset + s.space * this.nameLineHeight;
                    ...
                    value: function(e, t) {
                        var n = void 0,
                            ...
                            l = void 0;
                        for (i = null, r = n = u = e;
                            (0 >= u ? 0 >= n : n >= 0) && r > e - t; r = 0 >= u ? ++n : --n)
                            if (!this.commits[r].requested) {
                                i = r;
                                break
                            }
                        if (null !== i) {
                            for (o = null, s = null, r = a = l = i;
                                (0 >= l ? 0 >= a : a >= 0) && r > i - t; r = 0 >= l ? ++a : --a)
                                if (this.commits[r].requested) {
                                    o = r;
                                    break
                                }
                    ...
                    value: function(e, t) {
                        var n = void 0,
                            ...
                            c = void 0,
                            d = void 0;
                        for (l = null, r = n = i = e, o = this.commits.length;
                            (o >= i ? o > n : n > o) && e + t > r; r = o >= i ? ++n : --n)
                            if (!this.commits[r].requested) {
                                l = r;
                                break
                            }
                        if (null !== l) {
                            for (c = null, d = null, r = a = s = l, u = this.commits.length;
                                (u >= s ? u > a : a > u) && l + t > r; r = u >= s ? ++a : --a)
                                if (this.commits[r].requested) {
                                    c = r;
                                    break
                                }
                    ...
                    key: "chunkUrl",
                    value: function(e) {
                        var t = s["default"](document.querySelector(".js-network-graph-container"), HTMLElement),
                            n = t.getAttribute("data-network-graph-chunk-url");
                        u["default"](n, "github/legacy/graphs/network.js:671");
                        var r = new URL(n, window.location.origin),
                            a = new URLSearchParams(r.search.slice(1));
                        for (var i in e) a.append(i, e[i]);
                        return r.search = a.toString(), r.toString()
                    }
                }, {
                    key: "requestInitialChunk",
                    value: function() {
                        var e, t;
                        return regeneratorRuntime.async(function(n) {
                            for (;;) switch (n.prev = n.next) {
                                ...
                                case 2:
                                    return e = this.chunkUrl({
                                        nethash: this.nethash
                                    }), n.next = 5, regeneratorRuntime.awrap(r.fetchJSON(e));
                                case 5:
                                    t = n.sent, this.importChunk(t), this.draw(), u["default"](this.network && this.network.chrome, "github/legacy/graphs/network.js:690"), this.network.chrome.draw();
                                case 10:
                                case "end":
                                    return n.stop()
                            }
                    ...
                    value: function(e, t) {
                        ...
                        return regeneratorRuntime.async(function(c) {
                            for (;;) switch (c.prev = c.next) {
                                case 0:
                                    if (n = void 0, a = void 0, i = void 0, o = void 0, g) {
                                        c.next = 6;
                                        break
                                    }
                                    return c.abrupt("return");
                                case 6:
                                    for (a = n = i = e, o = t; o >= i ? o >= n : n >= o; a = o >= i ? ++n : --n) this.commits[a].requested = new Date;
                                    return s = this.chunkUrl({
                                        nethash: this.nethash,
                                        start: e,
                                        end: t
                                    }), c.next = 10, regeneratorRuntime.awrap(r.fetchJSON(s));
                                case 10:
                                    l = c.sent, this.importChunk(l), this.draw(), u["default"](this.network && this.network.chrome, "github/legacy/graphs/network.js:710"), this.network.chrome.draw(), this.lastHotLoadCenterIndex = this.focus;
                                case 16:
                                case "end":
                                    return c.stop()
                            }
                    ...
                    value: function() {
                        var e = void 0,
                            ...
                            S = void 0;
                        this.drawBackground();
                        var x = this.timeWindow(),
                            k = x.min,
                            E = x.max;
                        this.ctx.save(), this.ctx.translate(this.offsetX, this.offsetY + this.graphTopOffset);
                        var _ = {},
                            T = this.spaceMap;
                        for (n = t = 0, i = T.length; i > t; n = ++t)
                            for (L = this.spaceMap.length - n - 1, r = a = v = k, g = E; g >= v ? g >= a : a >= g; r = g >= v ? ++a : --a) e = this.commits[r], e.populated && e.space === L && (this.drawConnection(e), _[e.id] = !0);
                        for (n = l = p = k, y = E; y >= p ? y >= l : l >= y; n = y >= p ? ++l : --l) {
                            var q = this.connectionMap[n];
                            if (q)
                                for (c = 0, o = q.length; o > c; c++) e = q[c], _[e.id] || (this.drawConnection(e), _[e.id] = !0)
                        }
                        var M = this.spaceMap;
                        for (n = d = 0, s = M.length; s > d; n = ++d)
                            for (L = this.spaceMap.length - n - 1, r = f = b = k, j = E; j >= b ? j >= f : f >= j; r = j >= b ? ++f : --f) e = this.commits[r], e.populated && e.space === L && (e === this.activeCommit ? this.drawActiveCommit(e) : this.drawCommit(e));
                        if (this.showRefs)
                            for (r = h = w = k, m = E; m >= w ? m >= h : h >= m; r = m >= w ? ++h : --h)
                                if (e = this.commits[r], e.populated) {
                                    ...
                                    if (A) {
                                        ...
                                        for (S = 0, u = A.length; u > S; S++) {
                                            ...
                                            if (this.spaceUserMap[e.space].name === H.name) {
                                                var I = this.drawHead(e, H.head, C);
                                                C += I
                                            }
                                        }
                                    }
                    ...
                    value: function(e) {
                        var t = void 0,
                            ...
                            i = 340,
                            o = 56,
                            s = e.message ? this.splitLines(e.message, 48) : [],
                            u = Math.max(o, 38 + 16 * s.length),
                    ...
                    value: function(e, t, n) {
                        ...
                        this.ctx.restore();
                        var a = e.time * this.nameLineHeight,
                            i = e.space * this.nameLineHeight + 5 + n,
                            o = 2.5;
                    ...
                    key: "drawMergeConnection",
                    value: function(e, t) {
                        var n = void 0,
                            r = this.spaceColor(e.space);
            ...
            m = function() {
                function e(t, r, a) {
                    ...
                    o(this, e);
                    var s = document.body;
                    u["default"](s, "github/legacy/graphs/network.js:1304"), this.chrome = r, this.graph = a, this.dragging = !1, this.lastPoint = {
                        x: 0,
                        y: 0
                    }, this.lastHoverCommit = null, this.lastHoverUser = null, this.pressedCommit = null, this.pressedUser = null, this.canvas = t.getElementsByTagName("canvas")[0], this.canvasOffset = n.offset(this.canvas), this.canvas.style.cursor = "move", s.addEventListener("mouseup", function() {
                        return i.up()
                ...
                return l(e, [{
                    ...
                    value: function(e) {
                        ...
                        if (this.dragging) this.graph.moveX(t - this.lastPoint.x), this.graph.moveY(n - this.lastPoint.y), this.graph.draw(), this.chrome.moveX(t - this.lastPoint.x), this.chrome.moveY(n - this.lastPoint.y), this.chrome.draw();
                            ...
                            if (r !== this.lastHoverUser) this.canvas.style.cursor = r ? "pointer" : "move", this.chrome.activeUser = r, this.chrome.draw(), this.lastHoverUser = r;
                            else {
        ...
        function a(e) {
            ...
            i["default"](t, "github/legacy/pages/account_membership.js:9");
            var n = t.hasAttribute("data-already-member"),
                r = e.form;
            i["default"](r, "github/legacy/pages/account_membership.js:13"), r.classList.toggle("is-member", n), r.classList.toggle("is-not-member", !n)
        }
        var i = r(t),
            o = r(n);
    ...
    }), define("github/legacy/pages/billing_settings/coupon_redemption", ["../../../observe", "../../../document-ready", "delegated-events", "invariant", "../../../typecast"], function(e, t, n, r, a) {
        function i(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function o(e) {
            ...
            if (t && n) {
                var r = !0,
                    ...
                    i = void 0;
                try {
                    for (var o, u = document.querySelectorAll(".js-account-row, .js-choose-account")[Symbol.iterator](); !(r = (o = u.next()).done); r = !0) {
                        var c = o.value;
                ...
                e.classList.add("selected");
                var f = e.querySelector(".js-choose-account");
                f && f.classList.add("selected");
                var h = l["default"](document.querySelector(".js-account"), HTMLInputElement);
                h && (h.value = t);
                var m = document.querySelector(".js-plan-section");
                m && m.classList.remove("d-none");
                var v = !0,
                    g = !1,
                    p = void 0;
                try {
                    for (var y, b = document.querySelectorAll(".js-billing-plans")[Symbol.iterator](); !(v = (y = b.next()).done); v = !0) {
                        var j = y.value;
                ...
                var w = document.querySelector(".js-billing-plans[data-login='" + t + "']");
                if (w) {
                    w.classList.remove("d-none");
                    var L = w.querySelectorAll(".js-plan-row"),
                        S = 1 === L.length ? L[0] : w.querySelector("[data-name='" + n + "']");
                    S && s(S)
                }
            }
        }
        ...
        function s(e) {
            ...
            if (n) {
                ...
                if (r) {
                    var a = "true" === n.getAttribute("data-has-billing"),
                        i = parseInt(e.getAttribute("data-cost"), 10),
                        o = !0,
                        s = !1,
                        u = void 0;
                    try {
                        for (var c, d = document.querySelectorAll(".js-plan-row, .js-choose-plan")[Symbol.iterator](); !(o = (c = d.next()).done); o = !0) {
                            var f = c.value;
                    ...
                    var v = e.querySelector(".js-choose-plan-radio");
                    v instanceof HTMLInputElement && (v.checked = !0);
                    var g = l["default"](document.querySelector(".js-plan"), HTMLInputElement);
                    if (g && (g.value = t || ""), 0 === i || a) {
                        var p = document.querySelector(".js-billing-section");
                        p && p.classList.add("has-removed-contents")
                    } else if (r) {
                        var y = document.querySelector(".js-billing-section[data-login='" + r + "']");
                        y && y.classList.remove("has-removed-contents")
                    }
                }
            }
        }
        var u = i(r),
            l = i(a);
        n.on("submit", ".js-find-coupon-form", function(e) {
            var t = l["default"](e.target, HTMLFormElement),
                n = t.action,
                r = l["default"](document.getElementById("code"), HTMLInputElement);
            window.location = n + "/" + encodeURIComponent(r.value), e.preventDefault()
        }), n.on("click", ".js-choose-account", function(e) {
            var t = !0,
                n = !1,
                r = void 0;
            try {
                for (var a, i = document.querySelectorAll(".js-plan-row, .js-choose-plan")[Symbol.iterator](); !(t = (a = i.next()).done); t = !0) {
                    var s = a.value;
                    s.classList.remove("selected")
                }
            } catch (u) {
            ...
            var c = l["default"](document.querySelector(".js-plan"), HTMLInputElement);
            c.value = "";
            var d = !0,
                f = !1,
                h = void 0;
            try {
                for (var m, v = document.querySelectorAll(".js-billing-section")[Symbol.iterator](); !(d = (m = v.next()).done); d = !0) {
                    var g = m.value;
                    g.classList.add("has-removed-contents")
                }
            } catch (u) {
                f = !0, h = u
            } finally {
            ...
            var p = e.currentTarget.closest(".js-account-row");
            p && o(p)
        }), n.on("click", ".js-choose-plan", function(e) {
            var t = e.target.closest(".js-plan-row");
            u["default"](t, "github/legacy/pages/billing_settings/coupon_redemption.js:42"), s(t)
        }), e.observe(".js-choose-plan-radio:checked", {
            add: function(e) {
                s(e.closest(".js-plan-row"))
            }
        }), e.observe(".js-plan-row.selected", {
            add: function(e) {
                var t = e.closest("form"),
                    n = t.querySelector(".js-redeem-button");
                u["default"](n instanceof HTMLButtonElement, "github/legacy/pages/billing_settings/coupon_redemption.js:56"), n.disabled = e.classList.contains("free-plan")
            }
        }), t.ready.then(function() {
        ...
        function t(t, n) {
            var r = t.closest(".js-survey-question-form"),
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.parseLineRange = t, e.parseFileAnchor = r, e.formatLineRange = a
    }), define("github/legacy/pages/blob", ["delegated-events", "../../blob-anchor", "../../hash-change", "../../typecast"], function(e, t, n, r) {
        function a(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function i(e) {
            ...
            if (0 !== r.length) {
                ...
                for (var d = t[0]; d <= t[t.length - 1]; d++) {
                    var f = document.querySelector("#" + n + "LC" + d);
                    f && f.classList.add("highlighted")
                }
            }
        }

        function o(e) {
            null == e && (e = t.parseFileAnchor(window.location.hash)), i(e), d();
            var n = e,
                r = n.lineRange,
                a = n.anchorPrefix,
                o = document.querySelector("#" + a + "LC" + r[0]);
            !v && o && o.scrollIntoView(), v = !1
        }
        ...
        function u(e) {
            for (var t = [], n = 0; n < e.length; n++) t.push(e[n].innerText);
            t = t.join("\n");
            var r = document.getElementById("js-copy-lines");
            r && r.setAttribute("data-clipboard-text", t)
        }

        function l() {
            var e = document.getElementsByClassName("js-permalink-shortcut")[0];
            if (e instanceof HTMLAnchorElement) {
                var t = "" + e.href + window.location.hash,
                    n = document.getElementById("js-copy-permalink");
                return n && n.setAttribute("data-clipboard-text", t), t
            }
        }

        function c(e) {
            var t = document.getElementById("js-new-issue");
            if (t instanceof HTMLAnchorElement && e) {
                var n = t.getAttribute("href");
                if (n) {
                    var r = new URL(n, window.location.origin),
                        a = new URLSearchParams(r.search.slice(1));
                    a.set("permalink", e), r.search = a.toString(), t.setAttribute("href", r.toString())
                }
            }
        }
        ...
        function d() {
            ...
            if (t && e && r) {
                u(n);
                var a = l();
                c(a), t.textContent = n.length + (n.length > 1 ? " lines" : " line") + " selected ", e.style.top = r.offsetTop - e.offsetHeight - 7 + "px", e.style.visibility = "visible"
            }
        }

        function f(e) {
            var t = window.scrollY;
            v = !0, e(), window.scrollTo(0, t)
        }
        var h = a(n),
            m = a(r),
            v = !1;
        h["default"](function() {
            if (document.querySelector(".js-file-line-container")) {
                ...
                var e = window.location.hash,
                    ...
                    r = void 0;
                try {
                    for (var a, i = document.querySelectorAll(".js-update-url-with-hash")[Symbol.iterator](); !(t = (a = i.next()).done); t = !0) {
                        var u = a.value;
                        s(u, e)
                    }
                } catch (l) {
        ...
        }), e.on("click", "#js-copy-permalink, #js-copy-lines", function(e) {
            var t = e.target.getAttribute("data-original-text");
            t && (e.target.innerText = "Copied!", setTimeout(function() {
                e.target.innerText = t
            }, 2e3))
        }), e.on("click", ".js-line-number", function(e) {
            var n = t.parseFileAnchor(e.currentTarget.id);
            if (e.shiftKey) {
                var r = t.parseLineRange(window.location.hash);
                n.lineRange.unshift(r[0])
            }
            f(function() {
                window.location.hash = t.formatLineRange(n)
            })
        }), e.on("submit", ".js-jump-to-line-form", function(t) {
            var n = m["default"](t.currentTarget, HTMLFormElement),
                r = m["default"](n.querySelector(".js-jump-to-line-field"), HTMLInputElement),
                a = r.value.replace(/[^\d-]/g, ""),
        ...
        function l(e) {
            ...
            return t ? "true" === t.getAttribute("data-allow-unchanged") ? !0 : p(t) : !0
        }
        ...
        function f(e) {
            ...
            return t ? _["default"](t).attr("data-allow-unchanged") ? !0 : p(t) : !1
        }
        ...
        function y(e) {
            var t = e.querySelector(".js-blob-contents"),
                ...
                r = e.querySelector(".js-blob-filename");
        ...
        function w(e) {
            ...
            try {
                for (var a, i = document.querySelectorAll(".js-template-suggestion")[Symbol.iterator](); !(t = (a = i.next()).done); t = !0) {
                    var o = a.value,
                        s = o.getAttribute("data-template-suggestion-pattern");
                    if (s) {
        ...
        function L(e) {
            var t = void 0,
                ...
                s = void 0,
                u = e.closest("form"),
                l = _["default"](".js-blob-contents"),
                c = u.find(".js-new-blob-commit-summary");
            a = e.val() ? "Create " + e.val() : "Create new file";
            var d = q.get(l[0]) || "",
                f = _["default"](".js-new-filename-field").val();
            return a = (null != d ? d.length : void 0) && f !== d && null != e[0] ? (n = p(l[0]), t = n ? "Update and rename" : "Rename", e.val().length && f.length ? (s = d.split("/"), i = f.split("/"), o = !0, r = s.length - 1, s.forEach(function(e, t) {
        ...
        function S(e) {
            var t = _["default"](".breadcrumb").children(".js-path-segment"),
                n = "";
        ...
        function k(e, t, n) {
            ...
            if (null == n && (n = ""), t = t.replace(/[^-.a-z_0-9 ]+/gi, "-"), t = t.replace(/^-+|-+$/g, ""), t = t.trim(), t.length > 0) {
                ...
                if (!a) {
                    var i = e.parent().children(".js-repo-root, [itemtype]").children("span").children("a").last(),
                        o = i.attr("data-branch"),
                        s = i.attr("href");
                    a = s + "/tree/" + o
                }
        ...
        o.observe(".js-blob-form", function(e) {
            g(e), y(e), v(), M = m(e), _["default"](e).on("submit", function() {
        ...
        }), e.onKey("keydown", ".js-breadcrumb-nav", function(e) {
            var t = e.target;
            if ("Backspace" === e.key && 0 === t.selectionStart && 0 === t.selectionEnd) {
                var n = E["default"](t.parentNode, HTMLElement);
                1 !== n.querySelectorAll(".separator").length && (x(_["default"](t), !0), e.preventDefault())
            }
            b(_["default"](t))
        }), e.onInput(".js-new-blob-commit-summary", function(e) {
            var t = e.target,
                n = E["default"](t.closest(".js-file-commit-form"), HTMLElement),
                r = E["default"](n.querySelector(".js-too-long-error"), HTMLElement);
            ...
            var e = n.getCodeEditor(_["default"](this).closest(".js-blob-form").find(".js-code-editor")[0]),
                t = _["default"](this).attr("data-template-contents");
            return null == t || null == e ? void 0 : e.setCode(t)
        })
    }), define("github/legacy/pages/blob/csv", ["../../../onfocus"], function(e) {
        e.onInput(".js-csv-filter-field", function(e) {
            ...
            if (t) {
                ...
                var n = !0,
                    ...
                    a = void 0;
                try {
                    for (var i, o = document.querySelectorAll(".js-csv-data tbody tr")[Symbol.iterator](); !(n = (i = o.next()).done); n = !0) {
                        var s = i.value,
                            u = s.textContent.toLowerCase(); - 1 === u.indexOf(t) ? s.classList.add("d-none") : s.classList.remove("d-none")
                    }
                } catch (l) {
                    r = !0, a = l
                } finally {
        ...
        function a() {
            ...
            var t = void 0;
            t = [];
            var n = o["default"](".js-advanced-search-input").val(),
                r = {
                    Repositories: 0,
                    Users: 0,
                    Code: 0
        ...
        function i(e, t) {
            return o["default"].map(e, function(e) {
                ...
                var r = o["default"].trim(o["default"](e).val()),
                    a = o["default"](e).attr("data-search-prefix"),
                    i = o["default"](e).attr("data-search-type");
    ...
    }), define("github/legacy/pages/commits", ["../../navigation", "invariant", "delegated-events"], function(e, t, n) {
        function r(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        var a = r(t);
        n.on("navigation:keyopen", ".commits-list-item", function(e) {
            var t = e.target.querySelector(".commit-title > a");
            t && t.click()
        }), n.on("navigation:keydown", ".commits-list-item", function(e) {
            a["default"](e instanceof CustomEvent, "github/legacy/pages/commits.js:14");
            var t = e.target.querySelector(".commit-title > a");
            "c" === e.detail.hotkey && t && (t.click(), e.preventDefault(), e.stopPropagation())
        }), n.on("menu:activated", ".js-diffbar-commits-menu", function(t) {
            var n = t.target.querySelector(".in-range");
            n && e.focus(t.target, n, "instant")
        })
        ...
        u["default"](document).on("click", ".js-compare-tabs a", function() {
            ...
            c["default"](e instanceof CustomEvent, "github/legacy/pages/compare.js:49");
            ...
            add: function() {
                var e = document.body;
                c["default"](e, "github/legacy/pages/compare.js:75"), e.classList.add("is-pr-composer-expanded")
            },
            remove: function() {
                var e = document.body;
                c["default"](e, "github/legacy/pages/compare.js:80"), e.classList.remove("is-pr-composer-expanded")
            }
        })
        ...
        function c(t, n) {
            var r = void 0;
            if (n) {
                var a = "R" === n.slice(-1) ? "data-right-range" : "data-left-range",
                    i = parseInt(t.getAttribute(a).split("-")[0], 10);
                r = n + i
            ...
            return o = t.getAttribute("data-url"), o += "&anchor=" + encodeURIComponent(r), o = o.replace(/[?&]/, "?"), new Promise(function(n, r) {
                return s.fetchText(o).then(function(r) {
                    var a = f["default"](t).closest(".js-expandable-line"),
                        i = a.next(".file-diff-line");
        ...
        function d(e, t, n, r) {
            ...
            var l = f["default"](e).find(".js-expand"),
                c = [];
            for (i = 0, o = l.length; o > i; i++) {
                var d = l[i],
                    h = "R" === t ? "data-right-range" : "data-left-range";
                    ...
                    return (t = function() {
                        ...
                        if (u = f["default"](r.findElementByFragmentName(document, e)).next()[0]) {
                            if ((i = d(u, c, n, s)).length) return l(i, v).then(function() {
                                ...
                                if ((i = d(u, c, n, s)).length) return t();
                                if (e instanceof HTMLElement) a.scrollIntoView(e);
                                else if (p > g) return g++, t()
                            });
                            var h = r.findElementByFragmentName(document, m);
                            if (h instanceof HTMLElement) a.scrollIntoView(h);
                            else if (!h) {
        ...
        function v() {
            ...
            try {
                for (var r, a = document.querySelectorAll(".file .js-inline-comments-container")[Symbol.iterator](); !(e = (r = a.next()).done); e = !0) {
                    var i = r.value,
                        o = w["default"](i).find(".js-comments-holder > *"),
                        s = o.length > 0,
                        u = w["default"](i).find(".js-inline-comment-form-container").hasClass("open");
        ...
        function g(e) {
            ...
            j["default"](t instanceof HTMLElement, "undefined -- github/legacy/pages/diffs/line-comments.js:245");
            var n = t.firstElementChild;
            j["default"](null != n, "template must have a child -- github/legacy/pages/diffs/line-comments.js:249");
            var r = n.cloneNode(!0),
        ...
        function p(e, t, n) {
            ...
            if (r) return r;
            r = g("#js-inline-comments-split-form-container-template"), r.classList.add(t);
        ...
        r.on("click", ".js-add-single-line-comment", function() {
            ...
            f(this)
        }), a.onKey("keydown", ".js-inline-comment-form .js-comment-field", function(e) {
            var t = e.target;
            t.classList.contains("js-navigation-enable") || "Escape" === e.key && 0 === t.value.length && (h(t.closest(".js-inline-comment-form")), e.preventDefault())
            ...
            if (this === e.target) {
                var n = void 0,
                    ...
                    a = this.querySelector(".js-comment-form-error");
        ...
        r(".diff-table", "td.blob-code, td.blob-num", function(e, t) {
            var n = void 0,
                ...
                d = c.children;
            if (4 === d.length)
                for (r = i = 0, s = d.length; s > i; r = ++i) n = d[r], n === e && (l = a(r));
            var f = [];
        ...
        function s() {
            ...
            if (h) {
                var m = h[1],
                    ...
                    g = h[3],
                    p = m + v + g;
                if (p && (c = r.findElementByFragmentName(document, p)), c && c.classList.contains("js-linkable-line-number")) {
                    var y = c.parentNode,
                        b = y.children;
                    if (4 === b.length)
                        for (t = i = 0, u = b.length; u > i; t = ++i) e = b[t], e === c && (d = o(t));
                    l = function() {
                        var n = void 0,
                            r = void 0,
                            a = [];
        ...
        function r() {
            var e = document.body;
            a["default"](e, "github/legacy/pages/diffs/split.js:8");
            var t = document.querySelector("meta[name=diff-view]"),
                n = t && t instanceof HTMLMetaElement ? t.content : "",
                r = document.querySelector(".file-diff-split"),
                i = document.querySelector(".CommunityTemplate-header"),
                o = "split" === n && r || document.querySelector(".wants-full-width-container") ? !0 : !1;
            e.classList.toggle("full-width", o);
            var s = i ? !0 : !1;
            e.classList.toggle("full-width-p0", s)
        }
        var a = n(t);
        e.observe("meta[name=diff-view]", {
            ...
            add: r,
            remove: r
        }), e.observe(".CommunityTemplate-header", {
            add: r,
            remove: r
        })
        ...
        r.on("change", ".js-toggle-file-notes", function() {
            ...
            var t = document.querySelectorAll(".js-toggle-file-notes"),
                r = !1,
                a = !0,
                o = !1,
                s = void 0;
            ...
            var f = !0,
                ...
                m = void 0;
            try {
                for (var v, g = t[Symbol.iterator](); !(f = (v = g.next()).done); f = !0) {
                    var p = v.value;
                    i["default"](p instanceof HTMLInputElement, "Element must be an HTMLInputElement -- github/legacy/pages/diffs/toggle-file-notes.js:26"), n.changeValue(p, !r)
                }
            } catch (d) {
                h = !0, m = d
            } finally {
        ...
        e.onInput(".js-repository-name", function(e) {
            var t = e.target,
                n = s["default"](e.target.form, HTMLFormElement),
                r = s["default"](n.querySelector(".js-rename-repository-button"), HTMLButtonElement),
                a = u["default"](".js-form-note");
        ...
        function l(e) {
            ...
            if (r) {
                var a = 0,
                    i = r.querySelectorAll(".js-repo-access-team-select-option");
        ...
        n.observe(".js-add-new-collab", u), d["default"](document).on("autocomplete:autocompleted:changed", ".js-add-repo-access-field", function() {
            ...
            var a = void 0,
                o = this.closest(".js-repo-access-group"),
        ...
        l["default"](document).on("change", ".js-default-branch", function() {
            ...
            u["default"](e instanceof HTMLInputElement, ".js-default-branch-confirmation must exist and be an HTMLInputElement -- github/legacy/pages/edit_repositories/repository-options.js:18");
            var t = document.querySelector(".js-change-default-branch-button");
            u["default"](t instanceof HTMLButtonElement, ".js-change-default-branch-button must exist and be an HTMLButtonElement -- github/legacy/pages/edit_repositories/repository-options.js:22"), t.disabled = this.value === e.getAttribute("data-original-value"), e.value = this.value
            ...
            var r = this.closest(".js-protected-branch-options"),
                ...
                i = new URL(a.getAttribute("data-url"), window.location.origin),
                o = new URLSearchParams(i.search.slice(1));
            ...
            a.addThrottledInputEventListener(e, function() {
                ...
                u["default"](e instanceof HTMLButtonElement, ".js-pages-cname-save-btn must be a button -- github/legacy/pages/edit_repositories/repository-options.js:191"), e.disabled = this.value === this.defaultValue
            })
        }), l["default"](document).on("selectmenu:selected", ".js-pages-source", function() {
            var e = document.querySelector(".js-pages-source-btn-text");
            u["default"](e instanceof HTMLElement, ".js-pages-source-btn-text must exist -- github/legacy/pages/edit_repositories/repository-options.js:200");
            var t = e.getAttribute("data-original-text") === e.textContent,
                n = document.querySelector(".js-pages-source-save-btn");
            u["default"](n instanceof HTMLButtonElement, "Missing element [`.js-pages-source-save-btn`] -- github/legacy/pages/edit_repositories/repository-options.js:205"), n.disabled = t;
            ...
            if (r && r instanceof HTMLInputElement) {
                var a = this.querySelector(".selected input").value,
                    i = document.querySelector(".js-pages-theme-source-note"),
                    o = document.querySelector(".js-pages-theme-source-note-value");
                if (u["default"](i instanceof HTMLElement && o instanceof HTMLElement, ".js-pages-theme-source-note and .js-pages-theme-source-note-value must exist -- github/legacy/pages/edit_repositories/repository-options.js:215"), "none" === a) {
                    var s = r.getAttribute("data-original-value"),
                        l = o.getAttribute("data-original-text");
                    u["default"](null != s && null != l, "Missing attributes [`data-original-value`, `data-original-text`] -- github/legacy/pages/edit_repositories/repository-options.js:222"), r.value = s, o.textContent = l, i.classList.remove("hide-note")
        ...
        function o(e) {
            if (!g.get(e[0])) {
                ...
                r.load = Date.now(), r.helloTimer = setTimeout(l(e, function() {
                    return !r.hello
                }), 1e3 * t), r.loadTimer = setTimeout(l(e), 1e3 * n), g.set(e[0], r)
            }
        }
        ...
        function l(e, t) {
            return null == t && (t = function() {
                ...
                function() {
                    ...
                    return !r || e.hasClass("is-render-ready") || e.hasClass("is-render-failed") || e.hasClass("is-render-failed-fatally") || t && !t() ? void 0 : (n = g.get(e[0])) ? (console.error("Render timeout: " + JSON.stringify(n) + " Now: " + Date.now()), u(e)) : console.error("No timing data on $:", e)
                }
        }

        function c(e) {
            var t = h["default"](e || this),
                n = g.get(t[0]);
        ...
        function f(e, n, r, a, i) {
            ...
            switch (a) {
                ...
                case "error:invalid":
                    return u(e), e.addClass("is-render-failed-invalid");
                case "loading":
        ...
        var o = a(e),
            ...
            c = function() {
                function e() {
                    ...
                    }), s["default"](".theme-picker-view-toggle").click(function(e) {
                        return t.onHideClick(e)
                    }), s["default"]("#page-edit").click(this.onEditClick), s["default"]("#page-publish").click(function() {
                ...
                return u(e, [{
                    ...
                    key: "onScrollBackwardsClick",
                    value: function() {
                        return this.scrollThemeLinksContainer(-1)
                    }
                }, {
                    key: "onScrollForwardsClick",
                    value: function() {
                        return this.scrollThemeLinksContainer(1)
                    }
                }, {
                    ...
                    value: function(e, t) {
                        ...
                        var n = this.linkForTheme(e),
                            r = this.themes.indexOf(e),
                            a = n.outerWidth(!0),
                            i = r * a,
                            o = this.themeLinksContainer.scrollLeft(),
                            s = o + this.themeLinksContainer.outerWidth(!1);
                        return o > i || i + a > s ? t ? this.themeLinksContainer.animate({
                            scrollLeft: i
        ...
        t.ready.then(function() {
            document.getElementById("theme-picker-wrap") && new c
        })
        ...
        function u(e) {
            return new Promise(function(t, n) {
                ...
                return r.onload = function() {
                    c["default"]("string" == typeof r.result, "github/legacy/pages/gist/drag_drop.js:74");
                    var a = r.result;
                    return a && !/\0/.test(a) ? t({
                        file: e,
                        data: a
        ...
        t.observe(".js-gist-dropzone", {
            add: function() {
                var e = document.body;
                c["default"](e, "github/legacy/pages/gist/drag_drop.js:53"), e.addEventListener("dragenter", i), e.addEventListener("dragleave", o), e.addEventListener("dragover", i), e.addEventListener("drop", s)
            },
            remove: function() {
                var e = document.body;
                c["default"](e, "github/legacy/pages/gist/drag_drop.js:61"), e.removeEventListener("dragenter", i), e.removeEventListener("dragleave", o), e.removeEventListener("dragover", i), e.removeEventListener("drop", s)
            }
        })
        ...
        function l(e) {
            var t = void 0,
                ...
                a = void 0,
                i = void 0,
                o = e.querySelector(".js-gist-files"),
                s = document.getElementById("js-gist-file-template");
            g["default"](s, "github/legacy/pages/gist/gist_edit.js:24");
        ...
        function c(e) {
            ...
            for (t = 0, n = r.length; n > t; t++) {
                var a = r[t],
                    i = a.querySelector(".js-gist-filename"),
                    o = a.querySelector(".js-blob-contents");
        ...
        function h() {
            ...
            for (e = 0, t = n.length; t > e; e++) {
                var a = n[e];
                g["default"](a instanceof HTMLButtonElement, "`.js-gist-create` must be HTMLButtonElement -- github/legacy/pages/gist/gist_edit.js:86"), r.push(a.disabled = !f(a.form))
            }
            return r
        }
        ...
        var g = u(e),
            p = u(i),
            y = u(o);
        p["default"](document).on("change", ".js-code-textarea", function() {
            return h()
        ...
        }), p["default"](document).on("click", ".js-add-gist-file", function() {
            var e = this.closest(".js-blob-form");
            return l(e).scrollIntoView(), !1
        }), p["default"](document).on("gist:filedrop", ".js-blob-form", function(e) {
            var t = void 0,
                n = void 0,
                r = void 0;
        ...
        }), p["default"](document).on("click", ".js-remove-gist-file", function() {
            var e = void 0,
                t = void 0,
                n = this.closest(".js-gist-file"),
                r = n.querySelectorAll(".js-gist-deleted input");
            for (e = 0, t = r.length; t > e; e++) {
                var a = r[e];
                a.disabled = !1
            }
    ...
    }), define("github/legacy/pages/header", ["delegated-events"], function(e) {
        e.on("click", ".js-skip-to-content", function(e) {
    ...
    }), define("github/legacy/pages/hooks", ["invariant", "../../form", "../../throttled-input", "../../fetch", "../../jquery", "../../sudo", "../../facebox", "delegated-events", "../../observe", "../../typecast", "../../query-selector"], function(e, t, n, r, a, i, o, s, u, l, c) {
        function d(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function f(e) {
            var t = c.querySelectorAll(document, ".js-hook-event-checkbox", HTMLInputElement),
                n = !0,
                r = !1,
                a = void 0;
            try {
            ...
            if (e) {
                var l = Array.from(t).filter(function(t) {
                        return t.matches(e)
                    }),
                    d = !0,
                    f = !1,
                    h = void 0;
                try {
                    for (var m, v = l[Symbol.iterator](); !(d = (m = v.next()).done); d = !0) {
                        var g = m.value;
                        g.checked = !0
                    }
                } catch (u) {
        ...
        function h(e) {
            var n = e.currentTarget,
                r = e.currentTarget.querySelector(".js-value"),
                a = n.closest("form");
            m["default"](a instanceof HTMLFormElement, "github/legacy/pages/hooks.js:257");
            var i = a.querySelector(".js-enforcement-value");
            m["default"](r, "github/legacy/pages/hooks.js:259"), m["default"](i instanceof HTMLInputElement, "github/legacy/pages/hooks.js:260");
            var o = r.textContent.split("_"),
                s = b(o, 2),
                u = s[0],
                l = s[1];
            i.value = u;
            var c = y["default"](a.querySelector(".js-final-value"), HTMLInputElement);
            c && (l ? c.value = "false" : c.value = "true"), t.submit(a)
        }
        var m = d(e),
            v = d(a),
            g = d(i),
        ...
        u.observe(".js-hook-url-field", function(e) {
            ...
            n.addThrottledInputEventListener(e, t), t()
        }), s.on("click", ".js-hook-toggle-ssl-verification", function(e) {
            e.preventDefault();
            var t = document.querySelector(".js-ssl-hook-fields"),
                n = y["default"](document.querySelector(".js-hook-ssl-verification-field"), HTMLInputElement);
            m["default"](t && n, "github/legacy/pages/hooks.js:40"), t.classList.toggle("is-not-verifying-ssl"), t.classList.contains("is-not-verifying-ssl") ? (n.value = "1", s.fire(document, "facebox:close")) : n.value = "0"
        }), s.on("change", ".js-hook-event-choice", function(e) {
            m["default"](e.currentTarget instanceof HTMLInputElement, "github/legacy/pages/hooks.js:69");
            var t = "custom" === e.currentTarget.value,
                n = document.querySelector(".js-hook-events-field");
            n && n.classList.toggle("is-custom", t)
        }), s.on("submit", ".js-hook-form", function(e) {
            var t = y["default"](e.currentTarget, HTMLFormElement),
                n = t.querySelector(".js-hook-event-choice:checked"),
                r = y["default"](document.querySelector(".js-hook-wildcard-event"), HTMLInputElement);
            m["default"](n instanceof HTMLInputElement, "github/legacy/pages/hooks.js:79"), "custom" === n.value && (r.checked = !1), "push" === n.value && f('[value="push"]'), "all" === n.value && f(".js-hook-wildcard-event")
        }), s.on("details:toggled", ".js-hook-secret", function(e) {
            var t = e.currentTarget,
                n = y["default"](t.querySelector("input[type=password]"), HTMLInputElement);
            t.classList.contains("open") ? (n.disabled = !1, n.focus()) : n.disabled = !0
        }), s.on("details:toggled", ".js-hook-delivery-item", function(e) {
            var t = e.currentTarget,
                n = t.querySelector(".js-hook-delivery-details");
            n && !j.get(t) && g["default"]("low").then(function() {
                function e(e) {
                    n.outerHTML = e, n.classList.remove("is-loading")
                }

                function a() {
                    n.classList.add("has-error"), n.classList.remove("is-loading")
                }
                j.set(t, !0), n.classList.add("is-loading"), r.fetchText(n.getAttribute("data-url")).then(e, a)
            })
        }), s.on("click", ".js-hook-delivery-details .js-tabnav-tab", function(e) {
            var t = e.currentTarget,
                n = t.closest(".js-hook-delivery-details");
            m["default"](n, "github/legacy/pages/hooks.js:138");
            var r = !0,
                a = !1,
                i = void 0;
            try {
                for (var o, s = n.querySelectorAll(".js-tabnav-tab, .js-tabnav-tabcontent")[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
                    var u = o.value;
            ...
            var c = t.getAttribute("data-tab-target");
            m["default"](c, "github/legacy/pages/hooks.js:145");
            var d = n.querySelector('.js-tabnav-tabcontent[data-tab-name="' + c + '"]');
            d && d.classList.add("selected")
        }), s.on("click", ".js-hook-deliveries-pagination-button", function(e) {
            e.preventDefault();
            var t = e.currentTarget,
                n = t.parentElement;
            m["default"](n, "github/legacy/pages/hooks.js:156"), g["default"]("low").then(function() {
                n.classList.add("loading"), r.fetchText(t.getAttribute("href")).then(function(e) {
                    n.outerHTML = e
                })
            })
        }), s.on("click", ".js-redeliver-hook-delivery-init-button", function(e) {
            e.preventDefault();
            var t = e.currentTarget.getAttribute("href");
            g["default"]("low").then(function() {
                p["default"]({
                    div: t
                })
            })
        }), v["default"](document).on("ajaxSuccess", ".js-redeliver-hook-form", function(e, t) {
            var n = e.currentTarget.getAttribute("data-delivery-guid"),
                r = document.querySelector('.js-hook-delivery-details[data-delivery-guid="' + n + '"]');
            m["default"](r, "github/legacy/pages/hooks.js:183");
            var a = r.parentElement;
            m["default"](a, "github/legacy/pages/hooks.js:185"), s.fire(document, "facebox:close"), r.outerHTML = t.responseText;
            var i = a.querySelector("poll-include-fragment");
            m["default"](i, "github/legacy/pages/hooks.js:190"), i.addEventListener("load", function() {
                var e = a.querySelector(".js-hook-delivery-details"),
                    t = a.querySelector(".js-item-status");
                m["default"](t && e, "github/legacy/pages/hooks.js:195");
                var n = e.getAttribute("data-status-class");
                t.classList.remove("success", "pending", "failure"), n && t.classList.add(n);
                var r = a.querySelector(".js-item-status-tooltip"),
                    i = e.getAttribute("data-status-message");
                r && i && r.setAttribute("aria-label", i)
            })
        }), v["default"](document).on("ajaxError", ".js-redeliver-hook-form", function(e) {
            e.currentTarget.parentElement.querySelector(".js-redelivery-dialog").classList.add("failed")
        }), s.on("submit", ".js-test-hook-form", function(e) {
            e.preventDefault();
            var t = y["default"](e.currentTarget, HTMLFormElement);
            g["default"]("low").then(function() {
                function e() {
                ...
                function a(e) {
                    ...
                    m["default"](t instanceof HTMLElement, "Missing `.js-test-hook-message-errors` element -- github/legacy/pages/hooks.js:235"), null != e.response ? e.response.json().then(function(e) {
                        t.textContent = e.errors
                    }) : t.textContent = "Network request failed"
                }
                var i = document.querySelector(".js-test-hook-message");
                m["default"](i instanceof HTMLElement, "Missing `.js-test-hook-message` element -- github/legacy/pages/hooks.js:218"), i.classList.remove("error", "success"), r.fetch(t.action, {
                    method: t.method,
                    body: new FormData(t)
                }).then(n, a).then(e, e)
            })
        }), s.on("click", ".js-hook-enforcement-select .js-navigation-item", h)
        ...
        t.observe(".js-integration-permissions-selector", function() {
            i["default"]("[id^=integration_permission_]").on("change", function() {
                var e = this.getAttribute("data-permission"),
                    ...
                    r = n.querySelectorAll(document, '.js-integration-hook-event[data-resource="' + t + '"]', HTMLInputElement),
                    o = n.querySelectorAll(document, ".js-integration-single-file-resource", HTMLInputElement),
                    s = n.querySelectorAll(document, '.js-dropdown-container[data-resource="' + t + '"]', HTMLElement);
                ...
                return this.readOnly === !0 ? (i["default"](this.closest(".js-single-file")).find(".js-integration-single-file-permission-error").removeClass("d-none"), !1) : void 0
            })
        })
        ...
        r["default"](document).on("navigation:open", ".js-issues-custom-filter", function() {
            var t = this,
                n = r["default"](t),
                a = n.find(".js-new-item-name").text(),
                i = n.attr("data-name"),
                o = r["default"]("<input>", {
                    type: "hidden",
                    name: i,
        ...
        function o(e) {
            ...
            s["default"](r instanceof HTMLElement, "Missing `.js-labels-count` element -- github/legacy/pages/issues/labels.js:23");
            var a = n.parseFormattedNumber(r.textContent),
                i = a + e;
            r.textContent = n.formatNumber(i);
            var o = document.querySelector(".js-labels-label");
            return s["default"](o instanceof HTMLElement, "Missing `.js-labels-label` element -- github/legacy/pages/issues/labels.js:30"), t.pluralizeNode(i, o), i
        }
        var s = a(e),
            u = a(r);
        ...
        n["default"](function(e) {
            ...
            var t = void 0,
                n = void 0,
                r = e.newURL,
                a = r.match(/\/issues#issue\/(\d+)\/comment\/(\d+)$/);
        ...
        t.observe(".js-issues-list-check:checked", {
            ...
            u["default"](e instanceof CustomEvent, "github/legacy/pages/issues/list.js:28"), "x" === e.detail.hotkey && (o(this), e.preventDefault(), e.stopPropagation())
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.replaceText = n, e.insertText = r
        ...
        t.on("selectmenu:selected", ".js-saved-reply-container", function(e) {
            ...
            a["default"](t instanceof HTMLElement, "github/legacy/pages/issues/replies.js:9");
            var r = t.textContent.trim(),
                i = this.closest(".js-previewable-comment-form"),
                o = i.querySelector(".js-comment-field");
            n.insertText(o, r);
        ...
        i.on("selectmenu:selected", ".js-issue-sidebar-form", function(t) {
            ...
            var r = this,
                a = t.target,
                i = a.closest(".js-select-menu");
            h["default"](i instanceof HTMLElement, "github/legacy/pages/issues/sidebar.js:28");
            var o = i.hasAttribute("data-multiple");
            if (a.hasAttribute("data-clear-assignees")) {
                var s = a.closest(".js-menu-content");
                h["default"](s instanceof HTMLElement, "github/legacy/pages/issues/sidebar.js:33");
                var l = s.querySelectorAll('input[name="issue[user_assignee_ids][]"]:checked'),
                    c = !0,
                    f = !1,
                    m = void 0;
                try {
                    for (var v, g = l[Symbol.iterator](); !(c = (v = g.next()).done); c = !0) {
                        var p = v.value;
                        h["default"](p instanceof HTMLInputElement, "github/legacy/pages/issues/sidebar.js:37"), p.disabled = !1, p.checked = !1
                    }
                } catch (y) {
                    f = !0, m = y
                } finally {
                ...
                if (b) {
                    var j = Number(b),
                        w = i.querySelectorAll('input[type="checkbox"]:checked').length,
                        L = w > j;
                    h["default"](i instanceof HTMLElement, "github/legacy/pages/issues/sidebar.js:48");
                    var S = i.querySelector(".js-max-warning");
                    h["default"](S instanceof HTMLElement, "github/legacy/pages/issues/sidebar.js:50"), S.classList.toggle("d-none", !L)
                }
            ...
            var e = f["default"](this, HTMLInputElement),
                t = f["default"](this.closest(".js-project-menu-container"), HTMLElement),
                n = !0,
                r = !1,
                a = void 0;
            try {
        ...
        s["default"](document).on("change", ".js-issues-list-check", function() {
            ...
            var e = i.querySelectorAll(document, ".js-issues-list-check:checked", HTMLInputElement),
            ...
            var e = void 0,
                ...
                a = s["default"](this).hasClass("selected"),
                i = s["default"](this).attr("data-name"),
                o = s["default"](this).attr("data-value");
            e = t ? s["default"]("<input>", {
                type: "hidden",
                name: i + "[" + o + "]",
                value: a ? "1" : "0"
        ...
        r.DEFAULT_OPTS = {
            ...
            build: function() {
                ...
                var n = a["default"]("<div></div>").append(e, t),
                    r = "<table><thead><tr>";
        ...
        s["default"](document).on("click", ".js-notification-target", function(e) {
            ...
            var e = void 0,
                ...
                n = void 0,
                r = void 0,
                a = this.closest(".js-notifications-browser"),
                i = a.querySelectorAll(".unread");
            ...
            switch (o["default"](e instanceof CustomEvent, "github/legacy/pages/notifications.js:73"), e.detail.hotkey) {
                case "I":
                case "e":
                case "y":
        ...
        d["default"](document).on("ajaxSend", ".js-toggler-container .js-set-approval-state", function() {
            ...
            var n = e.querySelector(".js-integrations-install-form-submit"),
                ...
                a = r.getAttribute("data-search-url"),
                i = e.querySelector(".js-autocomplete-field");
            e.addEventListener("change", t), d["default"](document).on("click", ".js-repository-picker-remove", function() {
                ...
                var e = void 0,
                    t = void 0,
                    n = a,
                    i = document.querySelectorAll(".js-integrations-install-repo-picked .js-selected-repository-field");
                for (e = 0, t = i.length; t > e; e++) {
                ...
                var a = this.querySelector("#repo-result-" + r),
                    o = e.querySelector(".js-integrations-install-repo-picked");
        ...
        function a() {
            ...
            if (e && 1 === t.length) {
                ...
                i["default"](null != n, "Missing attribute `data-form` -- github/legacy/pages/orgs/invitations/reinstate.js:17");
                var r = e.getElementsByClassName("js-togglable-form"),
                    a = !0,
                    o = !1,
                    s = void 0;
                try {
                ...
                i["default"](f, "undefined -- github/legacy/pages/orgs/invitations/reinstate.js:27"), f.classList.remove("d-none")
            }
        }
        var i = r(e);
        ...
        t.on("change", ".js-change-org-role-selector", function(e) {
            var t = e.target;
            if (r["default"](t instanceof HTMLInputElement, "github/legacy/pages/orgs/members/change-role.js:7"), t.form) {
        ...
        function m(e) {
            var n = this,
                a = e.target;
            v["default"](a instanceof HTMLElement, "github/legacy/pages/orgs/members/index.js:143");
            var i = e.currentTarget;
            v["default"](i instanceof HTMLElement, "github/legacy/pages/orgs/members/index.js:146");
                ...
                if (s) {
                    ...
                    if (u) {
                        ...
                        if (isNaN(l) || 1 > l) b["default"](function() {
                            ...
                            e.preventDefault();
                            var c = new URL(u.getAttribute("data-url"), window.location.origin),
        ...
        n.on("click", ".js-member-remove-confirm-button", function(e) {
            ...
            var n = new URL(this.getAttribute("data-url"), window.location.origin),
                r = new URLSearchParams(n.search.slice(1)),
                a = this.getAttribute("data-member-id");
            if (a) r.append("member_ids[]", a);
            else {
                var i = !0,
                    o = !1,
                    s = void 0;
            ...
            var e = this.getAttribute("data-membership"),
                t = document.querySelector(".js-member-filter-field"),
                n = "membership";
            v["default"](t instanceof HTMLInputElement, "`.js-member-filter-field` must be an input -- github/legacy/pages/orgs/members/index.js:52");
            var r = t.value,
                a = new RegExp(n + ":[a-z-]+"),
                o = r.toString().trim().replace(a, "");
            t.value = (o + " " + e).replace(/\s\s/, " "), t.focus(), i.dispatchThrottledInputEvent(t);
            var s = p["default"](document.querySelector(".js-membership-tabs"), HTMLElement);
            ...
            v["default"](r instanceof HTMLInputElement, "`.js-member-filter-field` must be an input -- github/legacy/pages/orgs/members/index.js:74");
            var a = r.value,
                o = new RegExp(n + ":[a-z]+"),
                s = a.toString().trim().replace(o, "");
            r.value = (s + " " + t).replace(/\s\s/, " "), r.focus(), i.dispatchThrottledInputEvent(r)
        }), g["default"](document).on("ajaxSend ajaxComplete", ".js-add-team-member-or-repo-form", function(e) {
            this === e.target && this.classList.toggle("is-sending", "ajaxSend" === e.type)
        });
        for (var w = [".js-add-team-member-or-repo-form", ".js-add-team-member-form"], L = 0; L < w.length; L++) {
            var S = w[L];
            a.onKey("keydown", S + " .js-autocomplete-field", function(e) {
                "Enter" === e.key && e.preventDefault()
            })
        }
        g["default"](document).on("autocomplete:result", ".js-bulk-add-team-form .js-autocomplete-field", function(e) {
            var n = g["default"](this).data("autocompleted");
            if (n.indexOf("/") > 0) {
                var r = this.form.action,
                    a = this.form.method,
        ...
        }), g["default"](document).on("autocomplete:result", ".js-add-team-member-or-repo-form", function() {
            var e = this;
            b["default"](function() {
                return r.submit(e)
            })
        ...
        d.ready.then(function() {
            ...
            e && (x = e.innerHTML)
        }), n.on("click", ".js-approve-membership-request", m), g["default"](document).on("autocomplete:result", ".js-add-team-member-form", m), document.addEventListener("facebox:close", function() {
            var e = document.querySelector(".js-add-members-container");
            e && (e.innerHTML = x)
        }), g["default"](document).on("ajaxSuccess", ".js-add-team-member-or-repo-form", function(e, t) {
            var n = void 0,
                r = void 0,
                a = void 0,
                i = void 0;
            ...
            n = i ? g["default"](i.list_item_html) : g["default"](t.responseText);
            var s = g["default"](".js-member-list");
        ...
        }), g["default"](document).on("ajaxError", ".js-add-team-member-or-repo-form", function(e, t) {
            if (!/<html/.test(t.responseText)) {
                var n = g["default"](".js-member-list").siblings(".js-blankslate"),
                    r = void 0;
                try {
                    var a = JSON.parse(t.responseText);
                    r = a.message_html
                } catch (i) {
                    r = g["default"](t.responseText)
                }
                return g["default"](".flash-messages").remove(), n.before(r), !1
            }
        })
        ...
        function i(e, t) {
            o["default"](document.querySelector(".js-rename-owners-team-button"), HTMLElement).classList.toggle("disabled", !e), o["default"](document.querySelector(".js-rename-owners-team-errors"), HTMLElement).innerHTML = t, o["default"](document.querySelector(".js-rename-owners-team-note"), HTMLElement).classList.toggle("d-none", "" !== t)
        }
        var o = a(t);
        r.observe(".js-rename-owners-team-input", function(t) {
            e.addThrottledInputEventListener(t, function() {
                ...
                var r = new URL(this.getAttribute("data-check-url"), window.location.origin),
                    a = new URLSearchParams(r.search.slice(1));
                a.append("name", t), r.search = a.toString(), n.fetchText(r).then(function(t) {
                    t = t.trim();
                    var n = "" === t;
                    e.classList.remove("is-sending"), i(n, t)
                })
            })
        })
        ...
        a.onInput(".js-new-organization-name", function(e) {
            var t = e.target,
                n = s["default"](t.closest("dd"), HTMLElement),
                r = n.querySelector(".js-field-hint-name");
            ...
            if (t) {
                var n = s["default"](document.querySelector(".js-tos-link"), HTMLElement),
                    r = s["default"](document.querySelector(".js-corp-tos-link"), HTMLElement);
            ...
            add: function() {
                var e = s["default"](document.querySelector(".js-company-name-input"), HTMLInputElement),
                    n = s["default"](document.querySelector(".js-company-name-text"), HTMLElement),
                    r = s["default"](document.querySelector(".js-tos-link"), HTMLElement),
                    a = s["default"](document.querySelector(".js-corp-tos-link"), HTMLElement);
            ...
            add: function() {
                ...
                e.setAttribute("required", "required"), n.fire(e, "change"), a.onInput(".js-company-name-input", function() {
                    var e = s["default"](document.querySelector(".js-company-name-text"), HTMLElement),
                        t = s["default"](document.querySelector(".js-tos-link"), HTMLElement),
                        n = s["default"](document.querySelector(".js-corp-tos-link"), HTMLElement);
                    return e ? function() {
        ...
        e.observe(".js-two-factor-needs-enforced", function(e) {
            e.addEventListener("submit", function(e) {
                ...
                n.checked && (e.preventDefault(), r["default"]({
        ...
        i["default"](document).on("click", ".js-change-default-repository-permission-confirm", function(e) {
            ...
            a["default"](n instanceof HTMLFormElement, "`.js-change-default-repository-permission-form` must be a form -- github/legacy/pages/orgs/settings/change-default-repository-permission.js:11"), t.submit(n)
        })
        ...
        function n(e) {
            ...
            if (n instanceof HTMLFormElement) {
                var r = t(n);
                if (e.name) {
                    var a = e.matches("input[type=submit]") ? "Submit" : "",
                        i = e.value || a;
        ...
        function c() {
            ...
            return E["default"](e instanceof HTMLInputElement, "`.js-org-saml-previously-enforced` must be HTMLInputElement -- github/legacy/pages/orgs/settings/security.js:26"), "1" === e.value
        }
        ...
        function f() {
            ...
            return E["default"](e instanceof HTMLInputElement, "`.js-org-has-unlinked-saml-members` must be HTMLInputElement -- github/legacy/pages/orgs/settings/security.js:36"), "1" === e.value
        }
        ...
        function v() {
            ...
            return E["default"](e instanceof HTMLInputElement, "`.js-org-enable-saml` must be an HTMLInputElement -- github/legacy/pages/orgs/settings/security.js:55"), e.checked
        }
        ...
        function p() {
            ...
            return E["default"](e instanceof HTMLInputElement, "`.is-submit-button-value` must be an HTMLInputElement -- github/legacy/pages/orgs/settings/security.js:71"), e
        }

        function y() {
            return "test_settings" === p().name
        }

        function b() {
            return "save_settings" === p().name
        }

        function j() {
            var e = document.querySelector(".js-org-saml-enforce");
            return E["default"](e instanceof HTMLInputElement, "`.js-org-saml-enforce` must be an HTMLInputElement -- github/legacy/pages/orgs/settings/security.js:92"), e.checked
        }
        ...
        e.on("click", ".js-org-enable-saml", function(e) {
            ...
            e.preventDefault(), y() ? x() : b() && (g() ? L() : w() ? S() : x())
        }), document.addEventListener("facebox:close", function() {
        ...
        s["default"](document).on("autocomplete:autocompleted:changed", ".js-team-add-user-name", function() {
            ...
            var n = this.closest(".js-team-add-user-form"),
                r = n.querySelector(".js-team-add-user-name"),
                a = r.value;
            if (a && s["default"](r).data("autocompleted")) {
                r.value = "";
                var i = o["default"](document.querySelector(".js-team-user-logins"), HTMLElement),
                    l = !0,
                    c = !1,
                    d = void 0;
                try {
        ...
        t.on("change", ".js-change-team-visibility-selector", function(e) {
            var t = e.target;
            if (r["default"](t instanceof HTMLInputElement, "github/legacy/pages/orgs/teams/change-visibility.js:7"), t.form) {
                var n = t.form.querySelector(".js-change-team-visibility-submit");
                n instanceof HTMLButtonElement && (n.disabled = !1)
            }
        })
    }), define("github/legacy/pages/orgs/teams/import", ["../../../../typecast", "../../../../throttled-input", "../../../../observe", "../../../../jquery", "delegated-events", "../../../../fetch", "../../../../sliding-promise-queue"], function(e, t, n, r, a, i, o) {
        function s(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        var l = s(e),
            ...
            d = s(o),
            f = new d["default"];
        c["default"](document).on("ajaxSend", ".js-ldap-import-groups-container", function(e, t) {
            return t.setRequestHeader("X-Context", "import")
        }), c["default"](document).on("autocomplete:autocompleted:changed", ".js-team-ldap-group-field", function() {
            var e = this.closest(".js-ldap-group-adder");
            e && (e.classList.remove("is-exists"), e.querySelector(".js-ldap-group-adder-button").disabled = !c["default"](this).data("autocompleted"))
        }), c["default"](document).on("navigation:open", ".js-team-ldap-group-autocomplete-results .js-navigation-item", function() {
            var e = this.closest(".js-ldap-group-adder"),
                t = this.getAttribute("data-dn"),
                n = this.closest(".js-ldap-import-groups-container");
            e.querySelector(".js-team-ldap-dn-field").value = t;
            var r = !0,
                a = !1,
                i = void 0;
            try {
                for (var o, s = n.querySelectorAll(".js-ldap-group-dn")[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
                    var u = o.value;
                    u.textContent === t && (e.classList.add("is-exists"), e.querySelector(".js-ldap-group-adder-button").disabled = !0)
                }
            } catch (l) {
                a = !0, i = l
            } finally {
        ...
        }), c["default"](document).on("ajaxSend", ".js-import-container", function() {
            this.classList.add("is-importing"), this.querySelector(".js-ldap-group-adder-button").disabled = !0
        }), c["default"](document).on("ajaxComplete", ".js-import-container", function() {
            return this.classList.remove("is-importing")
        }), c["default"](document).on("ajaxSuccess", ".js-ldap-group-adder", function(e, t, n, r) {
            var a = this.closest(".js-ldap-import-groups-container"),
                i = document.querySelector(".js-import-form-actions");
            a.classList.remove("is-empty");
            var o = a.querySelector(".js-ldap-imported-groups");
            o.insertAdjacentHTML("afterbegin", r), this.reset(), this.querySelector(".js-team-ldap-group-field").focus();
            var s = this.querySelector(".js-ldap-group-adder-button");
            s && (s.disabled = !0), i && i.classList.remove("d-none")
        }), c["default"](document).on("submit", ".js-team-remove-group", function() {
            this.closest(".js-team").classList.add("is-removing"), l["default"](document.querySelector(".js-team-ldap-group-field"), HTMLElement).focus()
        }), c["default"](document).on("ajaxSuccess", ".js-team-remove-group", function() {
            this.closest(".js-team").remove(), document.querySelector(".js-team:not(.is-removing)") || (l["default"](document.querySelector(".js-ldap-import-groups-container"), HTMLElement).classList.add("is-empty"), l["default"](document.querySelector(".js-import-form-actions"), HTMLElement).classList.add("d-none"))
        }), c["default"](document).on("ajaxError", ".js-team-remove-group", function() {
            this.closest(".js-team").classList.remove("is-removing")
        }), a.on("click", ".js-edit-team", function() {
        ...
        }), a.on("click", ".js-cancel-team-edit", function() {
            var e = this.closest(".js-team"),
        ...
        }), c["default"](document).on("ajaxSuccess", ".js-team-form:not(.is-checking)", function(e, t, n, r) {
            ...
            t.addThrottledInputEventListener(e, function() {
                ...
                var n = new URL(e.getAttribute("data-check-url"), window.location.origin),
                    r = new URLSearchParams(n.search.slice(1));
                r.append("name", e.value), n.search = r.toString(), f.push(i.fetchJSON(n, {
                    headers: {
                        "X-Context": "import"
                    }
                })).then(function(e) {
        ...
        n.on("click", ".js-team-search-filter", function(e) {
            ...
            var n = this.getAttribute("data-filter"),
                r = this.closest(".js-select-menu").getAttribute("data-filter-on"),
                i = a["default"](document.querySelector(".js-team-search-field"), HTMLInputElement),
                o = i.value,
                s = new RegExp(r + ":[a-z]+"),
                u = o.toString().trim().replace(s, "");
            i.value = (u + " " + n).replace(/\s\s/, " "), i.focus(), t.dispatchThrottledInputEvent(i)
        })
    }), define("github/legacy/pages/orgs/teams/new", ["../../../../throttled-input", "../../../../fetch", "../../../../observe", "delegated-events", "../../../../typecast", "../../../../facebox", "invariant"], function(e, t, n, r, a, i, o) {
        function s(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function u(e) {
            ...
            var a = new URL(e.getAttribute("data-check-url"), window.location.origin),
                i = new URLSearchParams(a.search.slice(1));
            i.append("name", n), a.search = i.toString(), t.fetchText(a).then(function(t) {
                ...
                var i = null != (a = e.getAttribute("data-original")) ? a.trim() : void 0,
                    o = i && n === i,
                    s = !!r.querySelector(".js-error"),
                    u = (s || !n) && !o;
        ...
        n.observe(".js-new-team", function(t) {
            ...
            var n = l["default"](e.currentTarget.closest("form"), HTMLElement),
                r = n.querySelector("#selected-team-name");
            if (r instanceof HTMLInputElement && r.value !== r.getAttribute("data-original-team-name")) {
                e.preventDefault();
                var a = n.getAttribute("data-change-parent-summary-url");
                d["default"](a, "github/legacy/pages/orgs/teams/new.js:53"), a = a + "?parent_team=" + encodeURIComponent(r.value), c["default"](function() {
                    t.fetchSafeDocumentFragment(document, a).then(function(e) {
                        c["default"](e, "change-parent-summary")
                    })
                })
            }
        }), r.on("click", ".js-confirm-change-parent", function() {
            l["default"](document.querySelector(".js-org-team-form"), HTMLFormElement).submit()
        })
    ...
    }), define("github/legacy/pages/pages_composer", ["delegated-events", "invariant", "../../typecast"], function(e, t, n) {
        function r(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        var i = r(t),
            o = r(n);
        e.on("click", "#load-readme", function(e) {
            function t(e) {
                e.currentTarget.value !== u && (s.classList.add("d-none"), n.removeEventListener("input", t))
            }
            var n = o["default"](document.getElementById("gollum-editor-body"), HTMLTextAreaElement),
                r = document.getElementById("editor-body-buffer"),
                s = document.getElementById("undo-load-readme");
            i["default"](r && s, "github/legacy/pages/pages_composer.js:11");
            var u = r.textContent,
                l = e.currentTarget.getAttribute("data-readme-name");
            i["default"](l, "github/legacy/pages/pages_composer.js:14"), a(n, r), i["default"](e.currentTarget instanceof HTMLButtonElement, "github/legacy/pages/pages_composer.js:17"), e.currentTarget.disabled = !0, e.currentTarget.textContent = l + " loaded", s.classList.remove("d-none"), n.addEventListener("input", t)
        }), e.on("click", "#undo-load-readme", function(e) {
            var t = o["default"](document.getElementById("gollum-editor-body"), HTMLTextAreaElement),
                n = document.getElementById("editor-body-buffer");
            i["default"](n, "github/legacy/pages/pages_composer.js:35"), a(t, n);
            var r = document.getElementById("load-readme");
            i["default"](r instanceof HTMLButtonElement, "github/legacy/pages/pages_composer.js:38");
            var s = r.getAttribute("data-readme-name");
            i["default"](s, "github/legacy/pages/pages_composer.js:40"), r.disabled = !1, r.textContent = "Load " + s, e.currentTarget.classList.add("d-none")
        })
        ...
        function t(e, t) {
            var n = e.querySelector("table.timeline-commits > tbody"),
                r = t.querySelectorAll("table.timeline-commits > tbody > tr.commit");
        ...
        a["default"](document).on("details:toggled", ".js-pull-merging", function() {
            ...
            var l = e.closest(".js-pull-merging"),
                c = l.getAttribute("data-url");
        ...
        r["default"](document).on("ajaxError", ".js-handle-pull-merging-errors", function(e, t) {
            var n = void 0,
                a = this.closest(".js-pull-merging");
            ...
            var e = this.closest(".js-pull-merging"),
                ...
                i = document.getElementById("merge_title_field");
            if (i instanceof HTMLInputElement) {
                var o = i.value;
                a.set("commit_title", o)
            }
            var s = document.getElementById("merge_message_field");
            if (s instanceof HTMLTextAreaElement) {
                var u = s.value;
                a.set("commit_message", u)
            }
            return n.search = a.toString(), t.fetchText(n.toString()).then(function(t) {
    ...
    }), define("github/legacy/pages/pulls/show", ["delegated-events"], function(e) {
        document.addEventListener("pjax:end", function() {
            var t = !0,
                n = !1,
                r = void 0;
            try {
                for (var a, i = document.querySelectorAll(".js-pull-refresh-on-pjax")[Symbol.iterator](); !(t = (a = i.next()).done); t = !0) {
                    var o = a.value;
                    e.fire(o, "socket:message", {})
                }
            } catch (s) {
                n = !0, r = s
            } finally {
        ...
        document.addEventListener("facebox:reveal", function() {
            ...
            if (e) {
                ...
                n["default"](t, "Missing attribute `data-url` -- github/legacy/pages/repositories/fork.js:13"), e.setAttribute("src", t)
            }
        })
        ...
        r["default"](document).on("change", ".js-pulse-period", function(e) {
            ...
            return a["default"]({
                url: t,
                container: document.getElementById("js-repo-pjax-container")
            })
        })
    }), define("github/legacy/pages/repositories/repo_new", ["../../../form", "../../../observe", "../../../onfocus", "../../../jquery", "invariant", "delegated-events"], function(e, t, n, r, a, i) {
        function o(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function s() {
            var e = document.querySelector(".js-privacy-toggle:checked");
            return h["default"](e instanceof HTMLInputElement, "github/legacy/pages/repositories/repo_new.js:24"), "false" === e.value
        }

        function u() {
            var e = document.querySelector(".js-repo-name");
            h["default"](null != e, "github/legacy/pages/repositories/repo_new.js:30"), i.fire(e, "change");
            var t = f["default"](".js-owner-container"),
                n = t.find(".select-menu-item.selected");
            if (!m) {
                var r = document.querySelector(".js-privacy-toggle[value=false]"),
                    a = document.querySelector(".js-privacy-toggle[value=true]");
                h["default"](r instanceof HTMLInputElement, "github/legacy/pages/repositories/repo_new.js:40"), h["default"](a instanceof HTMLInputElement, "github/legacy/pages/repositories/repo_new.js:41"), "private" === n.attr("data-default") ? (r.checked = !0, i.fire(r, "change")) : (a.checked = !0, i.fire(a, "change"))
            }
            "yes" === n.attr("data-permission") ? (f["default"](".with-permission-fields").show(), f["default"](".without-permission-fields").hide(), f["default"](".errored").show(), f["default"]("dl.warn").show()) : (f["default"](".with-permission-fields").hide(), f["default"](".without-permission-fields").show(), f["default"](".errored").hide(), f["default"]("dl.warn").hide()), c(), l()
        }

        function l(e) {
            var t = f["default"]("#js-upgrade-container"),
                n = f["default"]("#new_repository"),
                r = e ? e.target : null;
            r || (r = document.querySelector(".js-privacy-toggle:checked")), h["default"](r instanceof HTMLInputElement, "github/legacy/pages/repositories/repo_new.js:77");
            var a = t.find(".js-billing-section");
            "false" === r.value ? (t.show(), a.removeClass("has-removed-contents"), t.find("input[type=checkbox]").prop("checked", "checked")) : (t.hide(), a.addClass("has-removed-contents"), t.find("input[type=checkbox]").prop("checked", null), n.attr("action", n.attr("data-url"))), d()
        }

        function c() {
            var e = f["default"]("#js-upgrade-container"),
                t = f["default"](".js-upgrade"),
                n = document.querySelector("input[name=owner]:checked");
            h["default"](n instanceof HTMLInputElement, "github/legacy/pages/repositories/repo_new.js:98");
            var r = t.filter('[data-login="' + n.value + '"]');
            e.html(r)
        }

        function d() {
            var e = f["default"]("#js-upgrade-container"),
                t = document.querySelector("#new_repository");
            h["default"](null != t, "github/legacy/pages/repositories/repo_new.js:108");
            var n = t.querySelector(".js-repo-name");
            h["default"](null != n, "github/legacy/pages/repositories/repo_new.js:111");
            var r = n.classList.contains("is-autocheck-successful"),
                a = e.find("input[type=checkbox]");
            s() && a.length && !a.is(":checked") && (r = !1);
            var i = t.querySelector("button[type=submit]");
            h["default"](i instanceof HTMLButtonElement, "github/legacy/pages/repositories/repo_new.js:121"), i.disabled = !r
        }
        var f = o(r),
            h = o(a),
            m = !1;
        t.observe(".page-new-repo", function() {
            m = s(), f["default"]("#js-upgrade-container").hide(), u()
        }), i.on("click", ".js-reponame-suggestion", function() {
            var t = document.querySelector(".js-repo-name");
            h["default"](t instanceof HTMLInputElement, "github/legacy/pages/repositories/repo_new.js:133"), e.changeValue(t, this.textContent)
        }), i.on("click", ".js-privacy-toggle", function() {
            m = !0
        }), i.on("change", ".js-privacy-toggle", l), f["default"](document).on("navigation:open", ".js-owner-container", u), i.on("change", "#js-upgrade-container input", d), n.onInput("#js-upgrade-container input", d), i.on("autocheck:send", "#repository_name", function(e) {
            h["default"](e instanceof CustomEvent, "github/legacy/pages/repositories/repo_new.js:149");
            var t = this.form.querySelector("input[name=owner]:checked").value;
            e.detail.owner = t
        }), i.on("autocheck:complete", "#repository_name", function() {
            d()
        }), i.on("autocheck:success", "#repository_name", function(e) {
            h["default"](e instanceof CustomEvent, "github/legacy/pages/repositories/repo_new.js:161");
            var t = e.detail ? e.detail.trim() : null;
            if (t) {
    ...
    }), define("github/legacy/pages/repository_imports/show", ["../../../typecast", "../../../form", "invariant", "delegated-events", "../../../jquery"], function(e, t, n, r, a) {
        function i(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        var s = i(e),
            u = i(n),
            l = i(a);
        l["default"](document).on("change", ".js-repository-import-owner-container input", function() {
            var e = this.getAttribute("data-upsell"),
                t = this.getAttribute("data-billing-url");
            s["default"](document.querySelector(".js-repository-import-billing-url"), HTMLAnchorElement).href = t, s["default"](document.querySelector(".js-repository-import-upsell"), HTMLElement).classList.toggle("d-none", "false" == e), s["default"](document.querySelector(".js-repository-import-no-upsell"), HTMLElement).classList.toggle("d-none", "true" == e)
        }), r.on("socket:message", ".repository-import", function(e) {
            u["default"](e instanceof CustomEvent, "github/legacy/pages/repository_imports/show.js:22");
            var t = e.detail.data;
            t.redirect_to && (document.location.href = t.redirect_to, e.stopImmediatePropagation())
        }), l["default"](document).on("change", ".js-repository-import-lfs-opt", function() {
        ...
        }), l["default"](document).on("menu:activated selectmenu:load", ".js-repository-import-author-select-menu", function() {
            var e = this.querySelector(".js-repository-import-author-autocomplete");
            e.focus(), e.select()
        }), l["default"](document).on("autocomplete:result", ".js-repository-import-author-autocomplete", function() {
            var e = this.closest(".js-repository-import-author"),
                n = e.querySelector(".js-author-login-info");
            t.changeValue(n, this.value)
        }), l["default"](document).on("ajaxSuccess", ".js-repository-import-author-form", function(e, t, n, r) {
            var a = l["default"].parseHTML(r.trim()),
                i = this.closest(".js-repository-import-author");
            i.replaceWith.apply(i, o(a))
        }), l["default"](document).on("click", ".js-repository-import-projects-cancel-button", function() {
            var e = s["default"](document.querySelector(".js-repository-import-projects-cancel-form"), HTMLFormElement);
            t.submit(e)
        })
        ...
        function o() {
            var e = document.body;
            d["default"](e, "github/legacy/pages/sessions/two_factor.js:16"), e.classList.add("is-sending"), e.classList.remove("is-sent", "is-not-sent")
        }

        function s() {
            var e = document.body;
            d["default"](e, "github/legacy/pages/sessions/two_factor.js:24"), e.classList.add("is-sent"), e.classList.remove("is-sending")
        }

        function u(e) {
            var t = document.body;
            d["default"](t, "github/legacy/pages/sessions/two_factor.js:32"), e && (l["default"](document.querySelector(".js-sms-error"), HTMLElement).textContent = e), t.classList.add("is-not-sent"), t.classList.remove("is-sending")
        }
        var l = i(e),
            c = i(r),
            d = i(a);
        c["default"](document).on("ajaxSend", ".js-send-auth-code", o), c["default"](document).on("ajaxSuccess", ".js-send-auth-code", s), c["default"](document).on("ajaxError", ".js-send-auth-code", function(e, t) {
            ...
            var e = this.form,
                ...
                r = e.querySelector(".js-sms-number").value,
                a = n + " " + r;
            o();
        ...
        r.observe(".js-email-global-unsubscribe-form", function(e) {
            ...
            var e = void 0,
                t = function() {
                    var t = void 0,
                        n = void 0,
                        r = this.querySelectorAll(".js-email-global-unsubscribe"),
                        a = [];
            ...
            var e = this.closest(".js-uploadable-container"),
                n = e.closest("form"),
                r = this.getAttribute("data-app-logo-destroy-path"),
                a = this.getAttribute("data-app-logo-destroy-method"),
                i = this.getAttribute("data-app-logo-destroy-field-name"),
                o = this.getAttribute("data-app-logo-destroy-field-value"),
                s = this.getAttribute("data-app-logo-destroy-authenticity-token");
            ...
            var e = void 0,
                ...
                r = n.querySelectorAll(".js-checkbox-scope"),
                a = [];
            for (e = 0, t = r.length; t > e; e++) {
                var i = r[e];
            ...
            var i = l["default"](document.querySelector(".js-user-block-settings-list"), HTMLElement),
                o = l["default"](i.querySelector(".js-blocked-list"), HTMLElement);
            u(this);
        ...
        function i(e, t) {
            ...
            var r = void 0,
                a = void 0;
            t ? (r = n.getAttribute("data-scoped-search-url"), a = e.getAttribute("data-scoped-placeholder")) : (r = n.getAttribute("data-unscoped-search-url"), a = e.getAttribute("data-unscoped-placeholder")), s["default"]("string" == typeof r, "github/legacy/pages/site-search.js:21"), s["default"]("string" == typeof a, "github/legacy/pages/site-search.js:22"), n.setAttribute("action", r), e.setAttribute("placeholder", a)
        }
        var o = a(n),
            s = a(r);
        e.onKey("keyup", ".js-site-search-field", function(e) {
            var t = e.target,
                n = 0 === t.value.length;
            n && "Backspace" === e.key && t.classList.contains("is-clearable") && i(t, !1), n && "Escape" === e.key && i(t, !0), t.classList.toggle("is-clearable", n)
        }), e.onFocus(".js-site-search-focus", function(e) {
            function t() {
                n.classList.remove("focus"), s["default"](e instanceof HTMLInputElement, "github/legacy/pages/site-search.js:46"), 0 === e.value.length && e.classList.contains("js-site-search-field") && i(e, !0), e.removeEventListener("blur", t)
            }
        ...
        n["default"](document).on("click", ".js-segmented-nav-button", function(e) {
            var t = n["default"](this).attr("data-selected-tab"),
                r = n["default"](this).closest(".js-segmented-nav");
    ...
    }), define("github/legacy/pages/site/header_notifications", ["../../../jquery", "invariant", "delegated-events"], function(e, t, n) {
        function r(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        var a = r(e),
            i = r(t);
        n.on("socket:message", ".js-notification-indicator", function(e) {
            i["default"](e instanceof CustomEvent, "github/legacy/pages/site/header_notifications.js:12");
            var t = e.detail.data;
            a["default"](this).attr({
                "aria-label": t.aria_label,
                "data-ga-click": t.ga_click
            }), a["default"]("span", this).attr("class", t.span_class)
        })
    }), define("github/legacy/pages/site/keyboard_shortcuts", ["../../../visible", "../../../facebox", "../../../document-ready", "../../../fetch", "delegated-events", "invariant"], function(e, t, n, r, a, i) {
        function o(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        var u = o(e),
            l = o(t),
            c = o(i);
        a.on("click", ".js-keyboard-shortcuts", function(e) {
            s(), e.preventDefault()
        }), a.on("click", ".js-see-all-keyboard-shortcuts", function(e) {
            e.currentTarget.remove();
            var t = document.querySelector(".facebox .js-hidden-pane");
            c["default"](t, "github/legacy/pages/site/keyboard_shortcuts.js:26"), t.style.display = "table-row-group", e.preventDefault()
        }), n.ready.then(function() {
            document.body && document.body.addEventListener("keypress", function(e) {
                if (e.target instanceof HTMLElement) {
                    var n = e.target === document.body,
                        r = e.target.classList.contains("facebox-header");
                    (n || r) && "?" === e.key && (Array.from(document.querySelectorAll(".facebox")).some(u["default"]) ? t.close() : s(), e.preventDefault())
                }
            })
        })
        ...
        t.observe(".js-site-status-container", function(e) {
            var t = e.querySelector(".js-site-status-message"),
                ...
                i = r["default"](document.querySelector("meta[name=site-status-api-url]"), HTMLMetaElement).content;
        ...
        n["default"](document).on("ajaxSend", ".js-action-ldap-create", function() {
            ...
            var r = n["default"](this),
                a = 500 === t.status ? "Oops, something went wrong." : t.responseText;
        ...
        function u(e, t) {
            var a = e.getAttribute("data-results");
            if (a) {
                var i = document.getElementById(a);
                if (i) {
                    var s = d.get(i);
                    if (!s) return void(null == c && (c = n.fetchJSON(i.getAttribute("data-url")).then(function(t) {
                        d.set(i, t.paths), u(e), c = null
                    })["catch"](function() {
                        c = null
                    })));
                    var f = l["default"](l["default"](i.querySelector(".js-tree-browser-result-template"), HTMLElement).firstElementChild, HTMLElement),
                        h = l["default"](i.querySelector(".js-tree-finder-results"), HTMLElement);
                    null == t && (t = e.value);
                    var m = void 0,
                        v = void 0;
                    t ? (m = r.fuzzyRegexp(t), v = r.fuzzySort(s, t)) : v = s, i.classList.toggle("filterable-empty", !v.length);
                    for (var g = document.createDocumentFragment(), p = v.slice(0, 50), y = 0, b = p.length; b > y; y++) {
                        var j = p[y],
                            w = f.cloneNode(!0),
                            L = l["default"](w.getElementsByClassName("js-tree-finder-path")[0], HTMLAnchorElement),
                            S = new URL(L.href);
                        S.pathname = S.pathname + "/" + encodeURI(j), L.href = S.href, L.textContent = j, r.fuzzyHighlightElement(L, t, m), g.appendChild(w)
                    }
                    h.innerHTML = "", h.appendChild(g), o.focus(h)
                }
            }
        }
        var l = s(e),
            c = null,
            d = new WeakMap;
        a.onKey("keydown", ".js-tree-finder-field", function(e) {
            "Escape" === e.key && (e.preventDefault(), history.back())
        }), t.observe(".js-tree-finder-field", function(e) {
            function t() {
                u(e)
            }
            return t(), {
                add: function(e) {
                    i.addThrottledInputEventListener(e, t), e.focus()
                },
                remove: function(e) {
                    i.removeThrottledInputEventListener(e, t)
                }
            }
        }, HTMLInputElement)
        ...
        function m(e) {
            var t = document.body;
            q["default"](t, "github/legacy/pages/users/contributions.js:75");
            var n = S(e.getAttribute("data-date")),
                r = parseInt(e.getAttribute("data-count")),
                a = 0 === r ? "No" : u.formatNumber(r),
                i = P[n.getUTCMonth()].slice(0, 3) + " " + n.getUTCDate() + ", " + n.getUTCFullYear(),
                o = M["default"]('<div class="svg-tip svg-tip-one-line">\n  <strong>' + a + " " + s.pluralize(r, "contribution") + "</strong> on " + i + "\n</div>").get(0);
            M["default"](".svg-tip").remove(), t.appendChild(o);
            var l = e.getBoundingClientRect(),
                c = l.left + window.pageXOffset - o.offsetWidth / 2 + l.width / 2,
                d = l.bottom + window.pageYOffset - o.offsetHeight - 2 * l.height;
        ...
        function g(e, n) {
            ...
            return regeneratorRuntime.async(function(s) {
                for (;;) switch (s.prev = s.next) {
                    case 0:
                        return r = T["default"](document.querySelector(".js-calendar-graph"), HTMLElement), a = r.getAttribute("data-graph-url"), q["default"](null != a, "Missing attribute `data-graph-url` -- github/legacy/pages/users/contributions.js:105"), i = a + "?from=" + L(e) + "&to=" + L(n) + "&full_graph=1", s.next = 6, regeneratorRuntime.awrap(t.fetchSafeDocumentFragment(document, i));
                    case 6:
        ...
        function j(e, t) {
            ...
            var r = void 0,
                ...
                o = void 0,
                s = void 0,
                u = T["default"](document.querySelector(".js-calendar-graph"), HTMLElement),
        ...
        o.on("click", ".js-year-link", function(e) {
            e.stopPropagation();
            var t = T["default"](document.querySelector(".js-year-link.selected"), HTMLElement),
                n = e.target;
            ...
            if (a) {
                ...
                q["default"](null != i, "Missing attribute `data-year` -- github/legacy/pages/users/contributions.js:354");
                var o = T["default"](document.querySelector(".js-year-link.selected"), HTMLElement),
                    s = T["default"](document.getElementById("year-link-" + i), HTMLElement);
        ...
        function a(e, t, n) {
            var r = e.querySelector(".js-remaining-pinned-repos-count"),
                a = r.getAttribute("data-remaining-label"),
                i = n - t;
        ...
        function i(e) {
            var t = parseInt(e.getAttribute("data-max-repo-count"), 10),
                ...
                r = Array.from(e.querySelectorAll("input[type=checkbox]"));
        ...
        function u(e) {
            ...
            l["default"](t instanceof HTMLElement, "github/legacy/pages/users/pinned-repositories.js:68");
            var n = t.querySelector(".js-pinned-repos-filter");
            l["default"](n instanceof HTMLInputElement, "github/legacy/pages/users/pinned-repositories.js:70");
            var r = (n.value || "").trim().toLowerCase(),
                a = r.length < 1,
                i = t.querySelectorAll(".js-pinned-repos-selection"),
                u = o(t),
                f = d(u, 2),
                h = f[0],
                m = f[1],
            ...
            Array.from(i).forEach(function(e) {
                l["default"](e instanceof HTMLElement, "github/legacy/pages/users/pinned-repositories.js:78");
                var t = e.querySelector(".js-repo");
                l["default"](t instanceof HTMLElement, "github/legacy/pages/users/pinned-repositories.js:81");
                var n = t.textContent.trim(),
                    i = s(e),
                    o = d(i, 2),
                    u = o[0],
                    c = o[1],
                    f = e.querySelector('input[type="checkbox"]');
                l["default"](f instanceof HTMLInputElement, "github/legacy/pages/users/pinned-repositories.js:87");
                var g = f.checked,
                    p = n.toLowerCase().indexOf(r) > -1,
                    y = (a || p) && (u && h || c && m),
                    b = g || y;
                b && (v = !0), e.classList.toggle("d-none", !b)
            });
            var g = t.querySelector(".js-no-repos-message");
            l["default"](g instanceof HTMLElement, "github/legacy/pages/users/pinned-repositories.js:102"), g.classList.toggle("d-none", v)
        }
        var l = r(e),
            c = r(n),
            d = function() {
        ...
        t.on("change", ".js-pinned-repos-selection-list input[type=checkbox]", function() {
            ...
            if (e) {
                var t = e.getAttribute("data-url");
                l["default"](t, "`data-url` must exist -- github/legacy/pages/users/pinned-repositories.js:123"), e.setAttribute("src", t)
            }
        })
    ...
    function(e) {
        ...
        function e(e, t) {
            ...
            this.el = e, this.options = t = p({}, t), e[R] = this;
            var n = {
                group: Math.random(),
                sort: !0,
                disabled: !1,
            ...
            this.nativeDraggable = t.forceFallback ? !1 : B, a(e, "mousedown", this._onTapStart), a(e, "touchstart", this._onTapStart), this.nativeDraggable && (a(e, "dragover", this), a(e, "dragenter", this)), V.push(this._onDragOver), t.store && this.sort(t.store.get(this))
        }
        ...
        function n(e, t, n) {
            if (e) {
                ...
                do
                    if (">*" === r && e.parentNode === n || ("" === r || e.nodeName.toUpperCase() == r) && (!t.length || ((" " + e.className + " ").match(a) || []).length == t.length)) return e;
        ...
        function c(e, t, n, r, a, i) {
            var o, s, u = e[R],
                l = u.options.onMove;
            return o = N.createEvent("Event"), o.initEvent("move", !0, !0), o.to = t, o.from = e, o.dragged = n, o.draggedRect = r, o.related = a || t, o.relatedRect = i || t.getBoundingClientRect(), e.dispatchEvent(o), l && (s = l.call(u, o)), s
        }
        ...
        var y, b, j, w, L, S, x, k, E, _, T, q, M, A, C, H, I, D = {},
            P = /\s+/g,
            ...
            $ = g(function(e, t, n) {
                if (n && t.scroll) {
                    var r, a, i, o, s = t.scrollSensitivity,
                        u = t.scrollSpeed,
                        l = e.clientX,
                        c = e.clientY,
                        d = window.innerWidth,
                    ...
                    if (k !== n && (x = t.scroll, k = n, x === !0)) {
                        x = n;
                        do
                            if (x.offsetWidth < x.scrollWidth || x.offsetHeight < x.scrollHeight) break;
                        while (x = x.parentNode)
                    }
                    x && (r = x, a = x.getBoundingClientRect(), i = (W(a.right - l) <= s) - (W(a.left - l) <= s), o = (W(a.bottom - c) <= s) - (W(a.top - c) <= s)), i || o || (i = (s >= d - l) - (s >= l), o = (s >= f - c) - (s >= c), (i || o) && (r = O)), (D.vx !== i || D.vy !== o || D.el !== r) && (D.el = r, D.vx = i, D.vy = o, clearInterval(D.pid), r && (D.pid = setInterval(function() {
                        r === O ? O.scrollTo(O.pageXOffset + i * u, O.pageYOffset + o * u) : (o && (r.scrollTop += o * u), i && (r.scrollLeft += i * u))
                    }, 24)))
                }
            }, 30),
            Y = function(e) {
        ...
        return e.prototype = {
            ...
            _prepareDragStart: function(e, t, n) {
                var r, i = this,
                    ...
                    l = i.options,
                    c = s.ownerDocument;
                n && !y && n.parentNode === s && (C = e, L = s, y = n, b = y.parentNode, S = y.nextSibling, A = l.group, r = function() {
            ...
            _triggerDragStart: function(e) {
                e ? (C = {
                    ...
                    clientX: e.clientX,
                    clientY: e.clientY
                }, this._onDragStart(C, "touch")) : this.nativeDraggable ? (a(y, "dragend", this), a(L, "dragstart", this._onDragStart)) : this._onDragStart(C, !0);
                try {
            ...
            _onTouchMove: function(t) {
                if (C) {
                    ...
                    var n = t.touches ? t.touches[0] : t,
                        r = n.clientX - C.clientX,
                        a = n.clientY - C.clientY,
                        i = t.touches ? "translate3d(" + r + "px," + a + "px,0)" : "translate(" + r + "px," + a + "px)";
            ...
            _appendGhost: function() {
                if (!j) {
                    var e, t = y.getBoundingClientRect(),
                        n = s(y),
                        r = this.options;
                    j = y.cloneNode(!0), o(j, r.ghostClass, !1), o(j, r.fallbackClass, !0), s(j, "top", t.top - F(n.marginTop, 10)), s(j, "left", t.left - F(n.marginLeft, 10)), s(j, "width", t.width), s(j, "height", t.height), s(j, "opacity", "0.8"), s(j, "position", "fixed"), s(j, "zIndex", "100000"), s(j, "pointerEvents", "none"), r.fallbackOnBody && N.body.appendChild(j) || L.appendChild(j), e = j.getBoundingClientRect(), s(j, "width", 2 * t.width - e.width), s(j, "height", 2 * t.height - e.height)
                }
            },
            _onDragStart: function(e, t) {
                var n = e.dataTransfer,
                    r = this.options;
                this._offUpEvents(), "clone" == A.pull && (w = y.cloneNode(!0), s(w, "display", "none"), L.insertBefore(w, y)), t ? ("touch" === t ? (a(N, "touchmove", this._onTouchMove), a(N, "touchend", this._onDrop), a(N, "touchcancel", this._onDrop)) : (a(N, "mousemove", this._onTouchMove), a(N, "mouseup", this._onDrop)), this._loopId = setInterval(this._emulateDragOver, 50)) : (n && (n.effectAllowed = "move", r.setData && r.setData.call(this, n, y)), a(N, "drop", this), setTimeout(this._dragStarted, 0))
            },
            _onDragOver: function(e) {
                var r, a, i, o = this.el,
                    ...
                    m = A === l,
                    v = u.sort;
                if (void 0 !== e.preventDefault && (e.preventDefault(), !u.dragoverBubble && e.stopPropagation()), I = !0, A && !u.disabled && (m ? v || (i = !L.contains(y)) : A.pull && d && (A.name === l.name || d.indexOf && ~d.indexOf(A.name))) && (void 0 === e.rootEl || e.rootEl === this.el)) {
                    if ($(e, u, this.el), U) return;
                    ...
                    if (0 === o.children.length || o.children[0] === j || o === e.target && (r = h(o, e))) {
                        ...
                        t(m), c(L, o, y, a, r, p) !== !1 && (y.contains(o) || (o.appendChild(y), b = o), this._animate(a, y), r && this._animate(p, r))
                    } else if (r && !r.animated && r !== y && void 0 !== r.parentNode[R]) {
                        E !== r && (E = r, _ = s(r), T = s(r.parentNode));
                        var g, p = r.getBoundingClientRect(),
                            x = p.right - p.left,
                            k = p.bottom - p.top,
                            q = /left|right|inline/.test(_.cssFloat + _.display) || "flex" == T.display && 0 === T["flex-direction"].indexOf("row"),
                            M = r.offsetWidth > y.offsetWidth,
                            C = r.offsetHeight > y.offsetHeight,
                            H = (q ? (e.clientX - p.left) / x : (e.clientY - p.top) / k) > .5,
                            D = r.nextElementSibling,
                            P = c(L, o, y, a, r, p);
                        if (P !== !1) {
                            if (U = !0, setTimeout(f, 30), t(m), 1 === P || -1 === P) g = 1 === P;
                            else if (q) {
                                var O = y.offsetTop,
                                    N = r.offsetTop;
                                g = O === N ? r.previousElementSibling === y && !M || H && M : N > O
                            } else g = D !== y && !C || H && C;
                            y.contains(o) || (g && !D ? o.appendChild(y) : r.parentNode.insertBefore(y, g ? D : r)), b = y.parentNode, this._animate(a, y), this._animate(p, r)
                        }
                    }
                }
            },
            ...
            _offUpEvents: function() {
                var e = this.el.ownerDocument;
                i(N, "touchmove", this._onTouchMove), i(e, "mouseup", this._onDrop), i(e, "touchend", this._onDrop), i(e, "touchcancel", this._onDrop)
            },
            _onDrop: function(t) {
                var n = this.el,
                    r = this.options;
                clearInterval(this._loopId), clearInterval(D.pid), clearTimeout(this._dragStartTimer), i(N, "mousemove", this._onTouchMove), this.nativeDraggable && (i(N, "drop", this), i(n, "dragstart", this._onDragStart)), this._offUpEvents(), t && (I && (t.preventDefault(), !r.dropBubble && t.stopPropagation()), j && j.parentNode.removeChild(j), y && (this.nativeDraggable && i(y, "dragend", this), d(y), o(y, this.options.ghostClass, !1), o(y, this.options.chosenClass, !1), L !== b ? (M = v(y), M >= 0 && (l(null, b, "sort", y, L, q, M), l(this, L, "sort", y, L, q, M), l(null, b, "add", y, L, q, M), l(this, L, "remove", y, L, q, M))) : (w && w.parentNode.removeChild(w), y.nextSibling !== S && (M = v(y), M >= 0 && (l(this, L, "update", y, L, q, M), l(this, L, "sort", y, L, q, M)))), e.active && ((null === M || -1 === M) && (M = q), l(this, L, "end", y, L, q, M), this.save())), L = y = b = j = S = w = x = k = C = H = I = M = E = _ = A = e.active = null)
            },
            ...
            destroy: function() {
                ...
                }), V.splice(V.indexOf(this._onDragOver), 1), this._onDrop(), this.el = e = null
            }
        }, e.utils = {
            on: a,
            off: i,
    ...
    }), define.registerEnd(), define("github/sortable-button", ["exports", "delegated-events"], function(e, t) {
        function n(e, n) {
            t.on("click", e + " .js-sortable-button", function() {
                var t = this.closest(e),
                    r = this.getAttribute("data-direction"),
                    a = Array.from(t.parentElement.children).indexOf(t);
                "up" === r ? t.previousElementSibling.insertAdjacentElement("beforebegin", t) : "down" === r && t.nextElementSibling && t.nextElementSibling.insertAdjacentElement("afterend", t);
                var i = Array.from(t.parentElement.children).indexOf(t);
                this.focus(), n({
                    oldIndex: a,
                    newIndex: i,
                    item: t
    ...
    }), define("github/legacy/pages/users/pinned-repository-reordering", ["delegated-events", "../../../fetch", "../../../observe", "sortablejs", "../../../sortable-button"], function(e, t, n, r, a) {
        function i(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function s(e) {
            var n = e.oldIndex,
                ...
                a = e.item;
            if (n !== r) {
                var i = a.closest(".js-pinned-repos-reorder-form"),
                    o = i.closest(".js-pinned-repos-reorder-container"),
                    s = o.querySelector(".js-pinned-repos-spinner"),
                    u = o.querySelector(".js-pinned-repos-reorder-message");
                u.textContent = "", s.style.display = "inline-block", c.option("disabled", !0), t.fetchText(i.action, {
                    method: i.method,
                    body: new FormData(i)
                })["catch"](function() {
                    ...
                    u.textContent = u.getAttribute("data-success-text"), s.style.display = "none", c.option("disabled", !1)
                })
            }
        }
        var u = i(r),
        ...
        n.observe(".js-pinned-repos-reorder-list", function(e) {
            ...
            e.preventDefault()
        }), l["default"](".js-pinned-repo-list-item", s)
    ...
    }), define("github/legacy/pages/wiki", ["../../fetch", "../../document-ready", "../../jquery", "../../sso"], function(e, t, n, r) {
        function a(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        t.ready.then(function() {
            function t() {
                ...
                if (r instanceof HTMLInputElement) {
                    var a = r.value;
                    a && o["default"]().then(function() {
                        e.fetchText("_current").then(function(e) {
                            if (a == e) setTimeout(t, 5e3);
                            else if (!n) {
                                var r = document.getElementById("gollum-error-message");
                                r && (r.textContent = "Someone has edited the wiki since you started. Please reload this page and re-apply your changes.", r.style.display = "block"), i["default"]("#gollum-editor-submit").attr("disabled", "disabled"), i["default"]("#gollum-editor-submit").attr("value", "Cannot Save, Someone Else Has Edited")
                            }
                        })
                    })
                }
        ...
        function t() {
            ...
            var i = e.getAttribute("data-warning-text"),
                o = e.closest(".js-length-limited-input-container"),
                s = o.querySelector(".js-length-limited-input-warning");
        ...
        function r(e, t) {
            var n = a["default"](t.querySelector(".js-marketplace-plan-name"), HTMLElement),
                r = a["default"](e.querySelector(".js-marketplace-plan-name-field"), HTMLInputElement).value;
            n.textContent = r;
            var i = a["default"](e.querySelector(".js-marketplace-edit-price-model"), HTMLSelectElement).value,
                o = t.querySelectorAll(".js-marketplace-plan-unit-name"),
                s = a["default"](t.querySelector(".js-marketplace-plan-per-unit-info"), HTMLElement);
            if ("PER_UNIT" === i) {
                var u = a["default"](e.querySelector(".js-marketplace-plan-unit-name-field"), HTMLInputElement).value,
                    l = !0,
                    c = !1,
                    d = void 0;
                try {
                ...
                var g = !0,
                    ...
                    y = void 0;
                try {
                    for (var b, j = o[Symbol.iterator](); !(g = (b = j.next()).done); g = !0) {
                        var w = b.value;
            ...
            if ("FREE" === i) {
                var L = t.querySelectorAll(".js-marketplace-plan-dollars-container"),
                    S = !0,
                    x = !1,
                    k = void 0;
                try {
                ...
                var q = a["default"](t.querySelector(".js-marketplace-plan-monthly-dollars"), HTMLElement),
                    M = a["default"](e.querySelector(".js-marketplace-plan-monthly-price-field"), HTMLInputElement).value;
                q.textContent = M;
                var A = a["default"](q.closest(".js-marketplace-plan-dollars-container"), HTMLElement);
                A.classList.remove("d-none");
                var C = a["default"](t.querySelector(".js-marketplace-plan-yearly-dollars"), HTMLElement),
                    H = a["default"](e.querySelector(".js-marketplace-plan-yearly-price-field"), HTMLInputElement).value;
                C.textContent = H;
                var I = a["default"](C.closest(".js-marketplace-plan-dollars-container"), HTMLElement);
                I.classList.remove("d-none")
            }
            var D = a["default"](t.querySelector(".js-marketplace-plan-bullets"), HTMLElement);
            D.innerHTML = "";
            var P = e.querySelectorAll(".js-marketplace-plan-bullet-field"),
                R = a["default"](t.querySelector(".js-marketplace-plan-bullet-template"), HTMLTemplateElement),
                O = !0,
                N = !1,
                F = void 0;
            try {
                for (var B, z = P[Symbol.iterator](); !(O = (B = z.next()).done); O = !0) {
                    var U = B.value,
                        W = a["default"](U, HTMLInputElement).value;
                    if (!(W.trim().length < 1)) {
                        var V = R.content.cloneNode(!0),
                            $ = a["default"](V.querySelector(".js-marketplace-plan-bullet"), HTMLElement);
                        $.textContent = W, D.appendChild(V)
                    }
                }
            } catch (v) {
                N = !0, F = v
            ...
            var Y = a["default"](t.querySelector(".js-marketplace-plan-description"), HTMLElement),
                J = a["default"](e.querySelector(".js-marketplace-plan-description-field"), HTMLInputElement).value;
            Y.textContent = J
        }
        var a = n(e);
        t.on("change", "select.js-marketplace-edit-price-model", function() {
            var e = a["default"](this, HTMLSelectElement),
                t = e.options[e.selectedIndex],
                n = a["default"](e.closest(".js-marketplace-edit-plan-editor"), HTMLElement),
                r = t.value,
                i = String(t.getAttribute("data-note")),
                o = a["default"](n.querySelector(".js-marketplace-plan-edit-unit-note"), HTMLElement);
            n.setAttribute("data-model", r), o.innerText = i;
            var s = String(e.getAttribute("data-related-input")),
                u = a["default"](n.querySelector(s), HTMLInputElement);
            u.required = t.hasAttribute("data-related-input-required")
        }), t.on("click", ".js-marketplace-plan-preview-toggle", function() {
            var e = a["default"](this, HTMLButtonElement),
                t = this.closest(".js-marketplace-edit-plan-container"),
                n = String(e.getAttribute("data-default-text")),
                i = String(e.getAttribute("data-toggle-text")),
                o = a["default"](t.querySelector(".js-marketplace-edit-plan-editor"), HTMLElement),
                s = a["default"](t.querySelector(".js-marketplace-edit-plan-preview"), HTMLElement);
            ...
            var e = a["default"](this, HTMLInputElement),
                t = a["default"](e.closest(".js-marketplace-plan-dollar-field-container"), HTMLElement);
        ...
        function i(e) {
            var t = Array.from(e.querySelectorAll("input:checked")),
                n = t.map(function(e) {
        ...
        function o(e, t) {
            u["default"](e instanceof HTMLElement, "github/marketplace/supported-languages.js:14");
            var n = s["default"](e.querySelector(".js-preview-supported-languages-button"), HTMLButtonElement),
                r = s["default"](e.querySelector(".js-no-supported-languages-container"), HTMLElement);
            t.length > 0 ? (n.textContent = t.join(", "), r.classList.add("d-none"), n.classList.remove("d-none")) : (n.classList.add("d-none"), r.classList.remove("d-none"))
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.selectedLanguageNames = i;
        var s = a(t),
            u = a(n);
        r.on("selectmenu:selected", ".js-languages-select-menu", function() {
            var e = s["default"](this, HTMLElement),
                t = i(e);
            o(e, t)
        })
        ...
        function f(e) {
            var t = e.closest(".js-marketplace-listing-form-container"),
                n = t.querySelector(".js-marketplace-listing-error-container");
            n.classList.remove("visible")
        }

        function h(e, t) {
            var n = L["default"](e.closest(".js-marketplace-listing-form-container"), HTMLElement),
                r = L["default"](n.querySelector(".js-marketplace-listing-error-container"), HTMLElement);
        ...
        function y(e, t, n) {
            S["default"](n instanceof HTMLElement, "github/marketplace/edit.js:78");
            var r = L["default"](n.closest(".js-listing-characters-remaining-container"), HTMLElement),
                a = L["default"](r.querySelector(".js-listing-characters-remaining"), HTMLElement),
                i = String(a.getAttribute("data-suffix")),
                o = p(e),
                s = t - o;
        ...
        function b(e) {
            ...
            var n = t.querySelector(".js-marketplace-listing-screenshot-resequence-form"),
                r = n.elements.namedItem("marketplace_listing_screenshot[previousScreenshotId]"),
        ...
        o.on("click", ".js-marketplace-error-dismiss", function() {
            ...
            var t = L["default"](this.parentElement, HTMLElement),
                n = parseInt(t.getAttribute("data-old-index"), 10),
                r = L["default"](t.parentElement, HTMLElement);
            ...
            var e = L["default"](this.querySelector(".js-marketplace-listing-screenshot-caption-field"), HTMLInputElement),
                t = L["default"](this.querySelector(".js-marketplace-listing-screenshot-caption-present"), HTMLElement),
                n = L["default"](this.querySelector(".js-marketplace-listing-screenshot-caption-empty"), HTMLElement);
            ...
            var t = L["default"](e.target, HTMLTextAreaElement),
                n = parseInt(t.getAttribute("data-character-limit"), 10);
            y(t.value, n, t)
        }), s.onInput("input.js-listing-characters-remaining-field", function(e) {
            var t = L["default"](e.target, HTMLInputElement),
                n = t.maxLength;
            y(t.value, n, t)
        }), o.on("menu:deactivate", ".js-edit-marketplace-listing-supported-languages .js-select-menu", function() {
            var e = L["default"](this, HTMLElement),
                t = e.getAttribute("data-supported-language-names") || "",
                n = t.split(","),
                a = u.selectedLanguageNames(e),
                i = L["default"](e.closest("form"), HTMLFormElement),
                o = !d(n, a);
            if (o) {
                if (0 === a.length) {
    ...
    }), define("github/marketplace/order", ["../typecast", "../fetch", "invariant", "delegated-events", "../onfocus"], function(e, t, n, r, a) {
        function i(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        var o = i(e),
            s = i(n);
        a.onInput(".js-marketplace-order-quantity", function(e) {
            var n = o["default"](e.target, HTMLInputElement),
                r = parseInt(n.value, 10).toFixed(),
                a = n.getAttribute("data-url");
            s["default"](a, "`data-url` must exist -- github/marketplace/order.js:14");
            var i = new URL(a, window.location.origin),
                u = new URLSearchParams(i.search.slice(1));
            u.set("quantity", r), i.search = u.toString(), t.fetchSafeDocumentFragment(document, i).then(function(e) {
                var t = o["default"](document.querySelector(".js-marketplace-order-preview"), HTMLElement);
                t.innerHTML = "", t.appendChild(e)
            })
        }), r.on("change", ".js-grant-oap-checkbox", function() {
            var e = o["default"](document.querySelector(".js-marketplace-complete-order"), HTMLButtonElement);
            e && (e.disabled = !this.checked)
        })
    }), define("github/milestone-dragging", ["./jquery", "sortablejs", "./sortable-button", "./debounce", "./fetch", "./has-interactions", "invariant", "./navigation", "./observe", "delegated-events", "./preserve-position", "./form", "./google-analytics", "./sso"], function(e, t, n, r, a, i, o, s, u, l, c, d, f, h) {
        function m(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function v(e) {
            ...
            return regeneratorRuntime.async(function(r) {
                for (;;) switch (r.prev = r.next) {
                    case 0:
                        if (!i.hasInteractions(e)) {
                            r.next = 2;
                            break
                        }
                        return r.abrupt("return");
                    case 2:
                        return t = e.getAttribute("data-url"), r.next = 5, regeneratorRuntime.awrap(a.fetchSafeDocumentFragment(document, t));
                    case 5:
                        n = r.sent, c.preserveInteractivePosition(function() {
                            e.replaceWith(n)
                        });
                    case 7:
                    case "end":
        ...
        var j = m(e),
            ...
            k = m(h),
            E = new WeakMap;
        l.on("socket:message", ".js-milestone-issues", function() {
            ...
            var t = this;
            k["default"]().then(function() {
                v(t)
            })
        }), j["default"](document).on("ajaxSuccess", ".js-milestone-sort-form", function(e, t, n, r) {
            var a = this.querySelector(".js-milestone-reorder-feedback");
            a.textContent = "", r.error ? this.querySelector(".js-milestone-changed").classList.remove("d-none") : (this.querySelector(".js-timestamp").value = r.updated_at, a.textContent = a.getAttribute("data-success-text"))
        });
        var _ = S["default"](function(e) {
            var t = e.newIndex,
                n = e.item,
                r = n.closest(".js-draggable-issues-container"),
                a = n.getAttribute("data-id"),
                i = g(r, t - 1),
                o = i && i.getAttribute("data-id"),
                s = r.closest(".js-milestone-sort-form");
            s.querySelector(".js-item-id").value = a, s.querySelector(".js-prev-id").value = o || "", f.trackEvent({
                category: "Milestone",
                action: "reorder",
                label: e.trackingLabel || "drag-and-drop"
            }), r.setAttribute("data-is-sorting", "1"), d.submit(s)
        }, 200);
        L["default"](".js-draggable-issue", _), l.on("navigation:keydown", ".js-draggable-issue", function(e) {
            x["default"](e instanceof CustomEvent, "github/milestone-dragging.js:99");
        ...
        }), u.observe(".js-draggable-issues-container", {
            add: y,
            remove: b
        }), u.observe(".js-backfill-status", function(e) {
            setTimeout(function() {
        ...
        a.on("click", ".js-toggle-notifications-sidebar", function(e) {
            ...
            var t = document.querySelector(".js-notifications-sidebar");
            t && (t.classList.toggle("d-none"), s["default"](null != document.body && document.body instanceof HTMLElement, "body doesn't exist. -- github/notifications.js:44"), document.body.classList.toggle("notifications-sidebar-showing"), o())
        ...
        r.on("click", ".js-notification-domain-button", function(n) {
            var r = n.target;
            i["default"](r instanceof HTMLElement, "github/notifications/filtering.js:10");
            var a = r.getAttribute("data-src"),
                o = r.closest(".js-notifications-sidebar");
            i["default"](o instanceof HTMLElement, "github/notifications/filtering.js:13");
            var s = o.querySelector(".js-notifications-content-container");
            i["default"](s instanceof HTMLElement, "github/notifications/filtering.js:15"), s instanceof HTMLElement && (e.deactivate(r.closest(".js-menu-container")), t.fetchSafeDocumentFragment(document, a).then(function(e) {
                s.innerHTML = "", s.appendChild(e);
                var t = o.querySelector(".js-notification-inbox-title");
                i["default"](t instanceof HTMLElement, "github/notifications/filtering.js:24"), t.textContent = r.title
            }))
        })
    }), define("github/notifications/live-updates", ["exports", "../fetch", "invariant", "delegated-events"], function(e, t, n, r) {
        function a(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function i(e) {
            o["default"](e.classList.contains("js-notification-cell"), "refreshNotificationCell must be passed a js-notification-cell -- github/notifications/live-updates.js:8");
            var n = e.getAttribute("data-src");
            t.fetchSafeDocumentFragment(document, n).then(function(t) {
                var n = t.querySelector(".js-notification-cell");
                n.classList.toggle("navigation-focus", e.classList.contains("navigation-focus")),
                    e.replaceWith(n)
            })
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.refreshNotificationCell = i;
        var o = a(n);
        r.on("socket:message", ".js-notification-channel", function(e) {
            if (e.target === e.currentTarget) {
                var t = this.querySelector(".js-load-newer-notifications");
                t && t.classList.add("js-notification-include-fragment")
            }
        }), r.on("socket:message", ".js-notification-cell", function(e) {
            e.target === e.currentTarget && (o["default"](e.target instanceof HTMLElement, "github/notifications/live-updates.js:39"), i(e.target))
        })
        ...
        n.on("navigation:keydown", ".js-notification-cell", function(e) {
            l["default"](e instanceof CustomEvent, "github/notifications/quick-actions.js:38");
        ...
        t.observe("#js-oauth-authorize-btn", function(e) {
            i["default"](document).then(function() {
                setTimeout(function() {
                    a["default"](e instanceof HTMLButtonElement, "github/oauth.js:9"), e.disabled = !1
                }, 1e3)
            })
        })
    }), define("github/octolytics-tracking", ["./typecast", "./send-beacon", "delegated-events"], function(e, t, n) {
        function r(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function a(e) {
            ...
            e.timestamp = n;
            var r = i["default"](document.head && document.head.querySelector('meta[name="octolytics-event-url"]'), HTMLMetaElement),
                a = r.content;
            t.guaranteedPost(a, JSON.stringify(e), "application/vnd.github-octolytics+json")
        }
        var i = r(e);
        n.on("click", "[data-octo-click]", function(e) {
            if (window._octo) {
                var t = e.target,
                ...
                var c = document.head ? document.head.querySelectorAll("meta[name]") : [],
                    d = !0,
                    f = !1,
                    h = void 0;
                try {
                    for (var m, v = c[Symbol.iterator](); !(d = (m = v.next()).done); d = !0) {
                        var g = m.value,
                            p = i["default"](g, HTMLMetaElement);
                        if (p.name.startsWith("octolytics-dimension-")) {
                            var y = p.name.replace(/^octolytics-dimension-/, "");
                            o[y] = p.content
                        } else if (p.name.startsWith("octolytics-measure-")) {
                            var b = p.name.replace(/^octolytics-measure-/, "");
                            s[b] = p.content
                        } else if (p.name.startsWith("octolytics-context-")) {
                            var j = p.name.replace(/^octolytics-context-/, "");
                            u[j] = p.content
                        } else if (p.name.startsWith("octolytics-actor-")) {
                            var w = p.name.replace(/^octolytics-/, "").replace(/-/g, "_");
                            o[w] = p.content
                        } else if (p.name.startsWith("octolytics-")) {
                            var L = p.name.replace(/^octolytics-/, "").replace(/-/g, "_");
                            r[L] = p.content
                        }
                    }
                } catch (S) {
                ...
                if (t.hasAttribute("data-ga-click")) {
                    var x = t.getAttribute("data-ga-click") || "",
                        k = x.split(",").map(function(e) {
                            return e.trim()
                        });
                ...
                r.dimensions = o, r.measures = s, r.context = u, a(r)
            }
        })
        ...
        function a(e) {
            ...
            if (t) {
                var n = t.querySelector(".js-comment-container"),
                    r = t.querySelector(".js-post-placeholder");
        ...
        function i(e, t) {
            e.innerText = (parseInt(e.innerText) + t).toString()
        }
        var o = r(e),
            s = r(t);
        n.on("click", ".js-team-discussions-team-description-toggle", function() {
            var e = document.querySelector(".js-team-discussions-team-description"),
                t = document.querySelector(".js-team-discussions-team-description-form");
            ...
            if (t) {
                var n = t.querySelector(".js-comment-container"),
                    r = t.querySelector(".js-post-placeholder"),
                    a = t.querySelector(".js-comment-field");
            ...
            a(e)
        }), o["default"](document).on("ajaxComplete", ".js-new-comment-form", function(e) {
            a(e)
        }), o["default"](document).on("ajaxComplete", ".js-team-discussions-team-description-form", function() {
            var e = document.querySelector(".js-team-discussions-team-description"),
                t = document.querySelector(".js-team-discussions-team-description-form"),
                n = document.querySelector(".js-team-discussions-team-description .description"),
                r = document.querySelector(".js-team-discussions-team-description-field");
            s["default"](n instanceof HTMLSpanElement, "github/orgs/team-discussions.js:55"), s["default"](r instanceof HTMLTextAreaElement, "github/orgs/team-discussions.js:56"), e && e.classList.toggle("d-none"), t && t.classList.toggle("d-none"), r.value.trim() ? (n.innerText = r.value, r.defaultValue = r.value) : (n.innerText = "This team has no description", r.defaultValue = "")
        }), o["default"](document).on("ajaxSend", ".js-comment-pin", function(e) {
            var t = e.target.querySelector("button[type=submit]");
            t && t.blur()
        }), o["default"](document).on("ajaxSuccess", ".js-comment-pin", function(e) {
            var t = e.target.querySelector("button[type=submit]"),
                n = e.target.querySelector('input[name="discussion_post[pinned]"]'),
                r = document.querySelector("#pinned_posts_counter"),
                a = !1;
            if (t) {
                var o = t.getAttribute("data-alternate-aria-label");
                if (t.setAttribute("data-alternate-aria-label", t.getAttribute("aria-label")), t.setAttribute("aria-label", o), t.classList.toggle("pinned"), a = t.classList.contains("pinned"), r) {
                    i(r, a ? 1 : -1);
                    var s = r.closest(".teamnav-item");
                    if (!a && s && s.classList.contains("selected")) {
                        var u = e.target.closest(".js-comment-delete-container");
                        u && (u.addEventListener("transitionend", function(e) {
                            "opacity" === e.propertyName && u.remove()
                        }), u.classList.add("fade-out"))
                    }
                }
            }
            n && n.setAttribute("value", a ? "0" : "1")
        }), o["default"](document).on("ajaxSuccess", ".js-comment-delete", function(e) {
            var t = e.target.closest(".discussion-post"),
                n = t && t.querySelector(".js-comment-pin button[type=submit]");
            if (n && n.classList.contains("pinned")) {
                var r = document.querySelector("#pinned_posts_counter");
                r && i(r, -1)
            }
        })
        ...
        function r(e) {
            ...
            return t.style.position = "fixed", t.style.top = "0", t.style.left = "0", t.style.opacity = "0", a["default"](e.body, "github/capture-keypresses.js:18"), e.body.appendChild(t), t.focus(),
                function() {
        ...
        n.on("pjax:click", ".js-pjax-history-navigate", function(t) {
            a["default"](t instanceof CustomEvent, "github/pjax/history-navigate.js:15"), this.href === e.getBackURL() ? (history.back(), t.detail.relatedEvent.preventDefault(), t.preventDefault()) : this.href === e.getForwardURL() && (history.forward(), t.detail.relatedEvent.preventDefault(), t.preventDefault())
        })
        ...
        function i(e, t) {
            for (var n in t) {
                var r = e.getAttribute("data-card-" + n) || "",
                    a = [];
        ...
        function l(e, t) {
            ...
            try {
                for (var i, o = document.querySelectorAll(".js-project-fullscreen-link")[Symbol.iterator](); !(n = (i = o.next()).done); n = !0) {
                    var s = i.value,
                        u = new URL(s.getAttribute("href") || "", window.location.origin);
        ...
        function c() {
            ...
            if (e instanceof HTMLInputElement) {
                var t = v["default"](document.querySelector(".js-project-columns-container"), HTMLElement),
                ...
                var g = !0,
                    ...
                    y = void 0;
                try {
                    for (var b, j = t.querySelectorAll(".js-project-column")[Symbol.iterator](); !(g = (b = j.next()).done); g = !0) {
                        var w = b.value,
                            L = v["default"](w.querySelector(".js-filtered-column-card-count"), HTMLElement);
                        if (n.length > 0) {
                            var S = w.querySelectorAll(".js-project-column-card:not(.d-none)").length,
                                x = S.toString() + " result";
        ...
        function h(e) {
            ...
            if (t instanceof HTMLElement) {
                ...
                var n = e.value.slice(0, e.selectionEnd),
                    r = (n.match(L) || [])[0],
                    a = v["default"](t.querySelector(".js-card-filter-suggester-helper-container"), HTMLElement),
                    i = v["default"](a.querySelector(".js-card-filter-suggester-helper"), HTMLElement);
                w.test(e.value) ? (i.textContent = e.value, a.classList.remove("d-none")) : a.classList.add("d-none");
                var o = v["default"](t.querySelector(".js-card-filter-suggestions-header"), HTMLElement),
                    s = !1,
                    u = !0,
                    l = !1,
                    c = void 0;
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.filterCards = c, e.updateSuggestionsDisplay = f, e.hideSuggestions = m;
        var v = r(n),
            g = ["assignee", "author", "is", "label", "repo", "state", "type"],
            p = /[^\s:]+:(".*"|[^\s]*)|[^\s]+/g,
            y = /:"[^"]*"?$/,
            b = /(^|\s+)[^\s:]+$/,
            j = /^(\s|$)/,
        ...
        function o(e, t, n) {
            ...
            return regeneratorRuntime.async(function(c) {
                for (;;) switch (c.prev = c.next) {
                    case 0:
                        return r = t.get(e), i = n.get(e), u["default"](r && i, "Must have old and new positions for the element to animate -- github/magic-move.js:29"), o = r.left - i.left, s = r.top - i.top, c.next = 7, regeneratorRuntime.awrap(a());
                    case 7:
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.recordPositions = i, e.animate = s;
        var u = r(t),
            l = r(n)
        ...
        function d(e, n) {
            var r, i, d, h, m, v, g, p, y, b, j, w, L, S, x, k, E, _, T, q, M, A, C, H, I, D, P, R, O, N, F, B, z, U, W, V, $, Y, J;
            return regeneratorRuntime.async(function(X) {
                for (;;) switch (X.prev = X.next) {
                    ...
                    case 12:
                        ...
                        for (p = {}, y = document.createDocumentFragment(), b = !0, j = !1, w = void 0, X.prev = 19, L = g.columns[Symbol.iterator](); !(b = (S = L.next()).done); b = !0) x = S.value, k = u(x, m), E = k.querySelector(".js-project-column-cards"), E && (p[E.id] = E.scrollTop), y.appendChild(k);
                        X.next = 27;
                        break;
                    case 23:
                    ...
                    case 35:
                        ...
                        for (T in p) E = f["default"](document.getElementById(T), HTMLElement), E.scrollTop = p[T];
                        return X.next = 43, regeneratorRuntime.awrap(t.animate(i, d));
                    case 43:
                        q = e.querySelectorAll(".js-project-column-card"), M = t.recordPositions(q), A = !0, C = !1, H = void 0, X.prev = 48, I = g.columns[Symbol.iterator]();
                    case 50:
                        if (A = (D = I.next()).done) {
                            X.next = 85;
                            break
                    ...
                    case 55:
                        for (O = R.querySelector(".js-project-column-name"), O && (O.textContent = P.name, N = R.querySelector(".js-project-column-name-field"), N instanceof HTMLInputElement && (N.value = P.name, N.setAttribute("value", P.name))), F = R.querySelector(".js-column-card-count"), F && (F.textContent = P.card_ids.length), B = document.createDocumentFragment(), z = !0, U = !1, W = void 0, X.prev = 63, V = P.card_ids[Symbol.iterator](); !(z = ($ = V.next()).done); z = !0) Y = $.value, B.appendChild(l(Y, v));
                        X.next = 71;
                        break;
                    case 67:
                        X.prev = 67, X.t2 = X["catch"](63), U = !0, W = X.t2;
                    case 71:
                        X.prev = 71, X.prev = 72, !z && V["return"] && V["return"]();
                    case 74:
                        if (X.prev = 74, !U) {
                            X.next = 77;
                            break
                    ...
                    case 85:
                        ...
                        break;
                    case 87:
                        X.prev = 87, X.t3 = X["catch"](48), C = !0, H = X.t3;
                    case 91:
                        X.prev = 91, X.prev = 92, !A && I["return"] && I["return"]();
                    case 94:
                        if (X.prev = 94, !C) {
                            X.next = 97;
                            break
    ...
    }), define("github/projects", ["./throttled-input", "./project-cards-filter", "delegated-events", "./jquery", "sortablejs", "./typecast", "./menu", "./debounce", "./fetch", "./focused", "./hash-change", "./hotkey", "invariant", "./observe", "./form", "./project-updater", "./sso"], function(e, t, n, r, a, i, o, s, u, l, c, d, f, h, m, v, g) {
        function p(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function S(e) {
            var t = e.item,
                n = H["default"](document.querySelector(".js-reorder-columns-form"), HTMLFormElement);
        ...
        function _() {
            ...
            if (e) {
                ...
                O["default"](t, "`data-project-activity-url` must exist -- github/projects.js:305");
        ...
        function T() {
            var e = this.querySelector("textarea"),
                ...
                r = e.value || "",
                a = Number(e.getAttribute("data-maxlength")),
                i = t.querySelector(".js-note-limit-warning"),
                o = r.match(/\n/g),
                s = o ? r.length + o.length : r.length;
        ...
        var A = p(r),
            ...
            N = p(g),
            F = void 0,
            B = document.querySelector(".js-client-uid");
        B && (F = B.getAttribute("data-uid") || ""), n.on("card:testAction", ".js-project-column-card", function() {
        ...
        }), A["default"](document).on("ajaxSuccess", ".js-project-update-card", function(e, t, n, r) {
            var a = A["default"].parseHTML(r)[0],
                i = a.getAttribute("data-card-id"),
                o = void 0;
            if (i && (o = document.querySelector('[data-card-id="' + i + '"]')), !o) {
                var s = a.getAttribute("data-content-type"),
                    u = a.getAttribute("data-content-id");
                o = document.querySelector('[data-content-type="' + s + '"][data-content-id="' + u + '"]')
            }
            A["default"](o).replaceWith(a)
        }), A["default"](document).on("ajaxSuccess", ".js-convert-note-to-issue-form", function() {
            n.fire(document, "facebox:close")
        }), A["default"](document).on("change", ".js-convert-note-to-issue-form", function() {
            var e = this.elements.namedItem("repository_id"),
                t = this.querySelector(".js-convert-note-to-issue-button");
            !e || e.value ? t.removeAttribute("disabled") : t.disabled = !0
        }), A["default"](document).on("submit", ".js-convert-note-to-issue-form", function(e) {
            var t = this.elements.namedItem("repository_id");
            t && !t.value && e.preventDefault()
        }), A["default"](document).on("ajaxSuccess", ".js-create-project-column", function(e, t, r, a) {
            var i = A["default"].parseHTML(a)[0],
                o = i.classList.contains("js-column-form-container");
            if (o) this.closest(".js-column-form-container").replaceWith(i);
            else {
                ...
                s.insertAdjacentHTML("beforebegin", a), Array.from(document.querySelectorAll(".js-create-project-column")).forEach(function(e) {
                    O["default"](e instanceof HTMLFormElement, "Every .js-create-project-column must be a HTMLFormElement -- github/projects.js:201"), b(e, null)
                }), n.fire(document, "facebox:close")
            }
        }), A["default"](document).on("ajaxSuccess", ".js-update-project-column", function(e, t, r, a) {
            var i = A["default"].parseHTML(a)[0],
                o = i.classList.contains("js-column-form-container");
            if (o) this.closest(".js-column-form-container").replaceWith(i);
            else {
                var s = this.getAttribute("data-column-id"),
                    u = document.querySelector('.js-project-column[data-id="' + s + '"]');
                u.replaceWith(i), n.fire(document, "facebox:close")
            }
        }), A["default"](document).on("ajaxSuccess", ".js-delete-project-column", function() {
        ...
        }), A["default"](document).on("ajaxSuccess", ".js-delete-card", function() {
        ...
        }), A["default"](document).on("ajaxSuccess", ".js-note-form", function(e, t, r, a) {
            var i = A["default"].parseHTML(a)[0],
                o = i.classList.contains("js-note-form-container");
            if (o) this.closest(".js-note-form-container").replaceWith(i);
            else {
                var s = this.getAttribute("data-card-id"),
                    u = document.getElementById("card-" + s);
                u.replaceWith(i), n.fire(document, "facebox:close")
            }
            ...
            var e = this.closest(".js-project-triage-pane"),
                t = e.querySelector(".js-project-search-form");
        ...
        }), A["default"](document).on("ajaxSuccess", ".js-project-search-form", function(e, t, n, r) {
            var a = this.closest(".js-project-triage-pane");
            a.querySelector(".js-project-search-results").innerHTML = r
        }), A["default"](document).on("ajaxSuccess", ".js-project-activity-form", function(e, t, n, r) {
            var a = this.closest(".js-project-activity-pane"),
                i = a.querySelector(".js-project-activity-container");
            i && (O["default"](i instanceof HTMLElement, "github/projects.js:365"), i.innerHTML = r), a && (O["default"](a instanceof HTMLElement, "github/projects.js:370"), a.classList.remove("Details--on"))
        }), h.observe(".js-project-column-card", function(e) {
            if (e.getAttribute("data-card-id")) {
                var t = e.getAttribute("data-content-type"),
                    n = e.getAttribute("data-content-id"),
                    r = document.getElementById("card-" + t + "-" + n);
                r && r.remove()
            }
        ...
        }), A["default"](document).on("ajaxSend", ".js-project-note-form", function() {
            var e = this.querySelector("textarea");
            this.querySelector("button").disabled = !0, e.disabled = !0
        }), A["default"](document).on("ajaxSuccess", ".js-project-note-form", function(e, t, n, r) {
            var a = this.closest(".js-project-column");
            if (a) {
                var i = a.querySelector(".js-project-column-cards");
                A["default"](i).prepend(r), j(a, 1)
            }
        ...
        n.on("click", ".js-card-filter-clear", function() {
        ...
        }), h.observe(".js-project-column-card", {
            add: z,
            remove: z
        }), h.observe(".js-card-filter-input", function(n) {
        ...
        }), A["default"](document).on("focusout:delayed", ".js-card-filter-input", function() {
            t.hideSuggestions()
        }), n.on("click", ".js-card-filter-suggestion", function() {
            var e = H["default"](document.querySelector(".js-card-filter-input"), HTMLInputElement);
            e.focus()
        }), n.on("navigation:keydown", ".js-card-filter-suggester", function(e) {
            switch (O["default"](e instanceof CustomEvent, "github/projects.js:524"), e.detail.hotkey) {
                case "esc":
        ...
        }), A["default"](document).on("navigation:open", ".js-card-filter-suggester", function(e) {
            var r = document.querySelector(".js-card-filter-input");
            if (r instanceof HTMLInputElement) {
                var a = H["default"](document.querySelector(".js-card-filter-suggester"), HTMLElement),
                    i = e.target.getAttribute("data-value"),
                    o = r.value.slice(0, r.selectionEnd).replace(/\S+$/, ""),
        ...
        }), n.on("socket:message", ".js-project-columns-container", function(e) {
            O["default"](e instanceof CustomEvent, "github/projects.js:565");
            var t = e.detail.data;
            if (F !== t.client_uid) {
                var n = this;
                N["default"]().then(function() {
                    v.updateProject(n, t)
                });
            ...
            O["default"](e instanceof CustomEvent, "github/projects.js:583");
            var t = e.detail.data;
        ...
        var r = n(e),
            a = "$__",
            i = document.querySelector("meta[name=js-proxy-site-detection-payload]"),
            o = document.querySelector("meta[name=expected-hostname]");
            ...
            return regeneratorRuntime.async(function(r) {
                for (;;) switch (r.prev = r.next) {
                    case 0:
                        return n = function(n) {
                            a(e, t, n.target)
                        }, t = null, t = e.querySelector(".js-navigation-item.navigation-focus"), t && (a(e, t, t), e.addEventListener("navigation:focus", n)), r.next = 6, regeneratorRuntime.awrap(u["default"](window, "keyup"));
                    case 6:
            ...
            if (e.shiftKey) {
                ...
                if (this.classList.contains("is-range-selected")) {
                    ...
                    var n = t.querySelectorAll(".js-navigation-item.is-range-selected"),
                        r = n[0],
                        a = n[n.length - 1],
                        o = t.getAttribute("data-range-url"),
                        s = r.getAttribute("data-parent-commit"),
        ...
        function s(e, t) {
            ...
            var h = !0,
                ...
                v = void 0;
            try {
                for (var g, p = document.querySelectorAll(".js-pending-comment-count-type")[Symbol.iterator](); !(h = (g = p.next()).done); h = !0) {
                    var y = g.value;
                    i.pluralizeNode(r, y)
                }
            } catch (f) {
        ...
        c["default"](function() {
            ...
            u(-1)
        }), r.on("click", ".js-review-menu-target", function(e) {
            e.stopImmediatePropagation();
            var n = this.form.querySelector(".js-review-requests-menu");
            t.activate(n)
        })
        ...
        function c(e) {
            var n = e.form;
            y["default"](n instanceof HTMLFormElement, "github/releases.js:15");
            var r = n.querySelector("#release_draft");
            y["default"](r instanceof HTMLInputElement, "github/releases.js:17"), r.value = "1", a.fetchJSON(n.action, {
                method: n.method,
                body: new FormData(n)
            }).then(function(r) {
                d(e, "is-saved"), setTimeout(d, 5e3, e, "is-default"), t.fire(n, "release:saved", {
                    release: r
                })
            })["catch"](function() {
                d(e, "is-failed")
        ...
        function h(e) {
            if (e.value && e.value !== w.get(e)) {
                ...
                n.append("tag_name", e.value), t.search = n.toString(), a.fetchJSON(t).then(function(t) {
                    "duplicate" === t.status && parseInt(e.getAttribute("data-existing-id")) === parseInt(t.release_id) ? f("is-valid") : (p["default"](document.querySelector(".js-release-tag .js-edit-release-link"), HTMLElement).setAttribute("href", t.url), f("is-" + t.status))
                })["catch"](function() {
                    f("is-invalid")
                })
            }
        ...
        function v(e) {
            ...
            if (n) {
                ...
                var a = e.querySelectorAll('input[name="release[tag_name]"], input[name="release[target_commitish]"]:checked'),
                    i = new URL(r, window.location.origin),
                    o = new URLSearchParams(i.search.slice(1)),
                    s = !0,
                    u = !1,
                    l = void 0;
        ...
        t.on("release:saved", ".js-release-form", function(e) {
            y["default"](e instanceof CustomEvent, "github/releases.js:54");
            var t = e.detail.release,
                n = this,
                r = n.getAttribute("data-repo-url"),
                a = t.update_url || m("tag", r, t.tag_name);
            ...
            f.value || (f.value = t.id, g["default"](n).append('<input type="hidden" name="_method" value="put">'))
        }), t.on("click", ".js-publish-release", function() {
            p["default"](document.querySelector("#release_draft"), HTMLInputElement).value = "0"
        });
        var j = ["is-loading", "is-empty", "is-valid", "is-invalid", "is-duplicate", "is-pending"],
            w = new WeakMap;
    ...
    }), define("github/select-menu/base", ["delegated-events", "../jquery", "../typecast", "../form", "../menu"], function(e, t, n, r, a) {
        function i(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        s["default"](document).on("navigation:open", ".js-select-menu:not([data-multiple]) .js-navigation-item", function() {
            ...
            if (!t) {
                var n = s["default"](this),
                    r = this.closest(".js-select-menu");
                s["default"](r).find(".js-navigation-item.selected").removeClass("selected"), n.addClass("selected"), n.removeClass("indeterminate"), n.find("input[type=radio], input[type=checkbox]").prop("checked", !0).change(), e.fire(this, "selectmenu:selected"), s["default"](r).hasClass("is-loading") || a.deactivate(r)
            }
        }), s["default"](document).on("navigation:open", ".js-select-menu[data-multiple] .js-navigation-item", function() {
            var t = o(this);
            if (!t) {
                var n = s["default"](this),
                    a = n.hasClass("selected");
                n.toggleClass("selected", !a), n.removeClass("indeterminate");
                var i = n.find("input[type=radio], input[type=checkbox]");
                i.prop("checked", !a).change();
                var l = !0,
                    c = !1,
                    d = void 0;
                try {
                    for (var f, h = n[0].querySelectorAll("input[type=radio], input[type=checkbox]")[Symbol.iterator](); !(l = (f = h.next()).done); l = !0) {
                        var m = f.value;
                        r.changeValue(u["default"](m, HTMLInputElement), !a)
                    }
                } catch (v) {
                    c = !0, d = v
                } finally {
                ...
                e.fire(this, "selectmenu:selected")
            }
        }), e.on("selectmenu:select", ".js-select-menu .js-navigation-item.disabled", function(e) {
            e.preventDefault()
        })
        ...
        r["default"](document).on("menu:activated selectmenu:load", ".js-select-menu", function() {
            ...
            try {
                for (var i, o = this.querySelectorAll(".js-navigation-item.selected")[Symbol.iterator](); !(n = (i = o.next()).done); n = !0) {
                    var s = i.value,
                        u = s.querySelector("input[type=radio], input[type=checkbox]");
        ...
        function r(e, t) {
            for (var n = e.querySelectorAll(".js-select-button-text, .js-select-menu-filter-text"), r = 0, a = n.length; a > r; r++) {
                var i = n[r],
                    o = i.textContent.toLowerCase().trim();
        ...
        a["default"](document).on("filterable:change", ".js-select-menu .select-menu-list", function(e) {
            ...
            if (n) {
                ...
                if ("" === i || r(this, i)) a["default"](this).removeClass("is-showing-new-item-form");
                else {
        ...
        function i(e, n) {
            var r = e.getAttribute("data-tab-filter"),
                a = e.closest(".js-select-menu"),
                i = a.querySelectorAll(".js-select-menu-tab-bucket"),
                o = !0,
                s = !1,
                u = void 0;
            try {
    ...
    }), define("github/select-menu", ["./select-menu/ajax", "./select-menu/base", "./select-menu/button", "./select-menu/css", "./select-menu/filterable", "./select-menu/loading", "./select-menu/navigation", "./select-menu/new", "./select-menu/tabs"], function() {}), define("github/skip-autofill", ["invariant", "./onfocus"], function(e, t) {
        function n(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        t.onFocus(".js-skip-password-autofill", function(e) {
            r["default"](e instanceof HTMLInputElement, "github/skip-autofill.js:9"), e.type = "password"
        })
        ...
        n.on("click", ".js-smoothscroll-anchor", function(e) {
            e.preventDefault();
            var n = this,
                r = i["default"](t.findFragmentTarget(document, n.hash), HTMLElement);
            o["default"](r, {
                duration: 250
            })
        })
    ...
    function(e, t) {
        ...
        var n = function(r, a, i) {
            function o() {
                f && (f = null, clearTimeout(f))
            }

            function s() {
                L && (e.removeEventListener("online", j), e.removeEventListener("offline", w), L = !1)
            }

            function u() {
                L || (e.addEventListener("online", j), e.addEventListener("offline", w), L = !0)
            }

            function l(e) {
                if (1e3 === e.code || y) return void(v = 0);
                if (t.onLine === !1) return void(p = !0);
                var n = b.shouldReconnect(e, m);
                "number" == typeof n && (f = setTimeout(c, n))
            }

            function c() {
                f = null, h = new WebSocket(r, a), h.binaryType = m.binaryType, v++, m.dispatchEvent(Object.assign(new CustomEvent("connecting"), {
                    attempts: v,
                    reconnects: g
                })), d = setTimeout(function() {
                    d = null, s(), m.dispatchEvent(Object.assign(new CustomEvent("timeout"), {
                        attempts: v,
                        reconnects: g
                    }))
                }, b.timeout), ["open", "close", "message", "error"].forEach(function(e) {
                    h.addEventListener(e, function(t) {
                        m.dispatchEvent(t);
                        var n = m["on" + e];
                        return "function" == typeof n ? n.apply(m, arguments) : void 0
                    })
                }), u()
            }
            var d, f, h = {
                ...
                p = !1,
                y = !1,
                b = Object.assign({}, n.defaultOptions, "function" == typeof i ? {
                    shouldReconnect: i
                } : i);
            if ("number" != typeof b.timeout) throw new Error("timeout must be the number of milliseconds to timeout a connection attempt");
            if ("function" != typeof b.shouldReconnect) throw new Error("shouldReconnect must be a function that returns the number of milliseconds to wait for a reconnect attempt, or null or undefined to not reconnect.");
            ...
            var j = function(e) {
                ...
                L = !1;
            m.send = function() {
                return h.send.apply(h, arguments)
            }, m.close = function(e, t) {
                return "number" != typeof e && (t = e, e = 1e3), o(), p = !1, y = !0, s(), h.close(e, t)
            }, m.open = function() {
                h.readyState !== WebSocket.OPEN && h.readyState !== WebSocket.CONNECTING && (o(), p = !1, y = !1, c())
            }, Object.defineProperty(m, "listeners", {
                value: {
                    open: [function(e) {
                        d && (clearTimeout(d), d = null), e.reconnects = ++g, e.attempts = v, v = 0, p = !1
                    }],
                    close: [l]
                }
            }), Object.defineProperty(m, "attempts", {
                get: function() {
                    return v
                },
                enumerable: !0
            }), Object.defineProperty(m, "reconnects", {
                get: function() {
                    return g
                },
                enumerable: !0
        ...
        return n.defaultOptions = {
            ...
            shouldReconnect: function(e, t) {
                return 1008 !== e.code && 1011 !== e.code ? [0, 3e3, 1e4][t.attempts] : void 0
            },
            automaticOpen: !0
            ...
            if (e in this.listeners)
                for (var n = this.listeners[e], r = 0, a = n.length; a > r; r++)
                    if (n[r] === t) return void n.splice(r, 1)
        }, n.prototype.dispatchEvent = function(e) {
            if (e.type in this.listeners) {
                e.currentTarget = this;
                for (var t = this.listeners[e.type], n = 0, r = t.length; r > n; n++) t[n].call(this, e)
            }
        }, n
    }, "undefined" != typeof window ? window : "undefined" != typeof global ? global : this), define.registerEnd(), define("github/socket-channel", ["robust-websocket", "delegated-events", "invariant", "./observe"], function(e, t, n, r) {
        function a(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function i() {
            ...
            if (e) {
                c["default"](e instanceof HTMLLinkElement, "Link must be of type HTMLLinkElement -- github/socket-channel.js:36");
                var n = new l["default"](e.href, void 0, {
                    shouldReconnect: function(e, t) {
        ...
        function s(e) {
            ...
            if (t) {
                var n = !0,
                    ...
                    a = void 0;
                try {
                    for (var s, u = o(e)[Symbol.iterator](); !(n = (s = u.next()).done); n = !0) {
                        var l = s.value;
                        t.readyState !== WebSocket.OPEN || d[l] || t.send("subscribe:" + l), d[l] = !0, null == f[l] && (f[l] = []), f[l].push(e)
                    }
                } catch (c) {
                    r = !0, a = c
                } finally {
        ...
        function u(e) {
            var t = !0,
                ...
                r = void 0;
            try {
                for (var a, i = o(e)[Symbol.iterator](); !(t = (a = i.next()).done); t = !0) {
                    var s = a.value,
                        u = f[s];
                    if (u) {
                        var l = u.indexOf(e); - 1 !== l && u.splice(l, 1)
                    }
                }
            } catch (c) {
                n = !0, r = c
        ...
        var l = a(e),
            ...
            f = {},
            h = null;
        r.observe(".js-socket-channel[data-channel]", {
            add: s,
            remove: u
        })
    ...
    }), define("github/sudo-required", ["delegated-events", "./observe", "./form", "./sudo"], function(e, t, n, r) {
        function a(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function i(r, a) {
            function i(t) {
                s || (t.preventDefault(), t.stopImmediatePropagation(), o["default"](a).then(function() {
                    s = !0, n.submit(t.target), s = !1
                })["catch"](function(n) {
                    e.fire(t.target, "sudo:failed", {
                        error: n
                    })
                }))
            }
            t.observe(r, {
                ...
                remove: function(e) {
                    e.removeEventListener("submit", i)
                }
            })
        }
        var o = a(r),
            s = !1;
        i("form.js-sudo-required", "low"), i("form.js-high-risk-sudo-required", "high")
        ...
        function c(e) {
            e.currentTarget === e.target && (e.dataTransfer.setData("text/plain", e.currentTarget.textContent.trim()), _ = e.currentTarget, L = !1, S = e.currentTarget, T = S.closest(".contains-task-list"), S.classList.add("is-ghost"), E = Array.from(S.parentNode.children), k = E.indexOf(S), x = E[k + 1] || null)
        }
        ...
        function f(e) {
            if (S) {
                ...
                if (k !== t || T !== n) {
                    T === n && t > k && t++;
                    var r = e.currentTarget.closest(".js-task-list-container");
                    j(r, "reordered", {
                        operation: "move",
                        src: [l(T), k],
                        dst: [l(n), t]
        ...
        function h() {
            S && (S.classList.remove("is-dragging"), S.classList.remove("is-ghost"), L || T.insertBefore(S, x), S = null, x = null, L = !1, _ = null)
        }
        ...
        function g(e) {
            var t = e.currentTarget.closest(".task-list-item");
        ...
        function y(e) {
            if (e.querySelectorAll(".js-task-list-field").length > 0) {
                ...
                var t = !0,
                    ...
                    r = void 0;
                try {
                    for (var a, i = e.querySelectorAll(".task-list-item")[Symbol.iterator](); !(t = (a = i.next()).done); t = !0) {
                        var o = a.value;
                ...
                var u = !0,
                    ...
                    c = void 0;
                try {
                    for (var d, f = e.querySelectorAll(".task-list-item-checkbox")[Symbol.iterator](); !(u = (d = f.next()).done); u = !0) {
                        var h = d.value;
                        h.disabled = !1
                    }
                } catch (s) {
        ...
        t.observe(".contains-task-list", function(e) {
            ...
            var t = this,
                n = t.closest(".js-task-list-container"),
                r = Array.from(t.querySelectorAll("li")),
                a = e.target,
                i = r.indexOf(a.closest(".task-list-item"));
            j(n, "checked:" + (a.checked ? 1 : 0), {
                operation: "check",
                position: [l(t), i],
                checked: a.checked
            })
            ...
            if (r) {
                ...
                if (i && i.remove(), 200 !== t.status || /^\s*</.test(t.responseText)) {
                    ...
                    if (i) {
                        ...
                        f.source && (r.querySelector(".js-task-list-field").value = f.source)
                    }
                    y(r)
                }
            }
        ...
        n.on("click", ".js-expandable-team-breadcrumbs .js-team-breadcrumb-trigger", function(e) {
            o["default"](e.target instanceof HTMLElement, "github/team-breadcrumbs.js:9");
    ...
    }), define("github/team-hierarchy", ["./fetch", "./throttled-input", "./typecast", "invariant", "./observe", "delegated-events"], function(e, t, n, r, a, i) {
        function o(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function s(t, n, r) {
            if (null != n[0]) {
                ...
                t.classList.add("is-open"), f = !1
            } else e.fetchSafeDocumentFragment(document, r).then(function(e) {
                t.after(e), t.classList.add("is-open"), f = !1
            })
        }

        function u(e, t) {
            l(t), e.classList.remove("is-open"), f = !1
        }
        ...
        function l(e) {
            ...
            try {
                for (var a, i = e[Symbol.iterator](); !(t = (a = i.next()).done); t = !0) {
                    var o = a.value,
                        s = String(o.getAttribute("data-team-slug")),
                        u = document.querySelectorAll('.js-child-team[data-parent-team-slug="' + s + '"]');
                    l(u), o.classList.remove("is-open"), o.classList.add("d-none")
                }
            } catch (c) {
                n = !0, r = c
            } finally {
        ...
        i.on("click", ".js-open-child-team", function(e) {
            if (d["default"](e.currentTarget instanceof HTMLElement, "github/team-hierarchy.js:13"), f === !1) {
                f = !0;
                var t = e.currentTarget.getAttribute("data-parent-team-slug");
                if (t) {
                    var n = document.querySelectorAll('.js-child-team[data-parent-team-slug="' + t + '"]'),
                        r = e.currentTarget.closest(".js-team-row");
                    if (d["default"](r instanceof HTMLElement, "github/team-hierarchy.js:20"), r.classList.contains("is-open")) e.currentTarget.setAttribute("aria-expanded", "false"), u(r, n);
                    else {
                        e.currentTarget.setAttribute("aria-expanded", "true");
                        var a = e.currentTarget.getAttribute("data-child-team-url");
                        s(r, n, a)
                    }
                }
            }
            ...
            if (f === !1) {
                f = !0;
                var t = this.closest(".js-team-row"),
                    n = this.getAttribute("data-child-team-url"),
                    r = t.parentNode;
                e.fetchSafeDocumentFragment(document, n).then(function(e) {
                    t.before(e), r && r.removeChild(t), f = !1
                })
            }
        }), a.observe(".js-selected-team-field", function(n) {
            t.addThrottledInputEventListener(n, function() {
                var t = n.getAttribute("data-contents-url"),
                    r = n.value.trim(),
                    a = -1 === t.indexOf("?") ? "?" : "&",
                    i = e.fetchText("" + t + a + "query=" + r);
                return i.then(function(e) {
                    document.getElementsByClassName("js-select-team-results")[0].innerHTML = e
                })
            })
        }), i.on("menu:activated", ".js-select-team-menu", function(e) {
            var t = e.target.querySelector(".js-selected-team-field");
            t && t.focus()
        }), i.on("selectmenu:selected", ".js-select-team", function() {
            var e = this.getAttribute("data-selected-team-id"),
                t = c["default"](document.getElementById("selected-team-id"), HTMLInputElement),
                n = this.getElementsByClassName("js-selected-team-name")[0].innerHTML,
                r = c["default"](document.getElementById("selected-team-name"), HTMLInputElement);
            e !== t.value && (t.value = e, r.value = n)
        }), i.on("selectmenu:selected", ".js-clear-team-selection", function() {
            var e = document.getElementsByClassName("js-select-button")[0];
            e.innerHTML = e.getAttribute("data-placeholder") || "Select team"
        })
    }), define("github/dependencies", ["./fetch", "invariant", "delegated-events"], function(e, t, n) {
        function r(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        var a = r(t);
        n.on("click", ".js-sub-dependencies", function(t) {
            a["default"](t.currentTarget instanceof HTMLElement, "github/dependencies.js:8");
            var n = t.currentTarget,
                r = n.getAttribute("data-loaded"),
                i = n.querySelector(".js-expanded"),
                o = n.querySelector(".js-collapsed"),
                s = n.closest(".js-details-container");
            if (i && i.classList.toggle("d-none"), o && o.classList.toggle("d-none"), s && s.classList.toggle("bg-gray-light"), !r) {
                n.setAttribute("data-loaded", "true");
                var u = n.getAttribute("data-sub-dependency-url"),
                    l = n.closest(".js-dependency");
                e.fetchSafeDocumentFragment(document, u).then(function(e) {
                    l && l.after(e)
                })
            }
        })
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.getSimulatedNavigationStart = n;
        ...
        function u() {
            ...
            if (t) {
                var n = !0,
                    ...
                    a = void 0;
                try {
                    for (var i, s = t.getEntriesByType("navigation")[Symbol.iterator](); !(n = (i = s.next()).done); n = !0) {
                        var u = i.value,
                            l = {};
                        e.push(l);
                        for (var c in u) {
                            var d = u[c];
                            ("number" == typeof d || "string" == typeof d) && (l[c] = d)
                        }
                    }
                } catch (f) {
                    r = !0, a = f
            ...
            var h = o();
            return h && 0 === e.length && e.push({
                name: location.href,
                entryType: "navigation",
                startTime: 0,
                duration: h.loadEventEnd - h.navigationStart,
                initiatorType: "navigation",
                nextHopProtocol: "http/1.1",
                type: "navigate",
                redirectStart: h.redirectStart,
                redirectEnd: h.redirectEnd,
                fetchStart: h.fetchStart,
                domainLookupStart: h.domainLookupStart,
                domainLookupEnd: h.domainLookupEnd,
                connectStart: h.connectStart,
                connectEnd: h.connectEnd,
                secureConnectionStart: h.secureConnectionStart,
                requestStart: h.requestStart,
                responseStart: h.responseStart,
                responseEnd: h.responseEnd,
                unloadEventStart: h.unloadEventStart,
                unloadEventEnd: h.unloadEventEnd,
                domInteractive: h.domInteractive,
                domContentLoadedEventStart: h.domContentLoadedEventStart,
                domContentLoadedEventEnd: h.domContentLoadedEventEnd,
                domComplete: h.domComplete,
                loadEventStart: h.loadEventStart,
                loadEventEnd: h.loadEventEnd
            }), e
        }
        var l = a(r);
        ! function() {
            ...
            return regeneratorRuntime.async(function(a) {
                for (;;) switch (a.prev = a.next) {
                    ...
                    case 4:
                        t = s(), t.length && l["default"]({
                            resourceTimings: t
                        }), r = u(), r.length && l["default"]({
                            navigationTimings: r
                        });
                    case 8:
                    case "end":
        ...
        function l(e) {
            g["default"](e instanceof HTMLElement, "github/topics.js:31");
            var t = e.querySelector(".js-topic-suggestions-box");
            g["default"](t instanceof HTMLElement, "github/topics.js:33");
            var n = t.querySelectorAll(".js-topic-suggestion");
            n.length < 1 && t.remove()
        }

        function c(e) {
            var t = v["default"](document.querySelector(".js-repo-meta-container"), HTMLElement),
                n = v["default"](document.getElementById("topics-list-container"), HTMLElement),
                r = v["default"](t.querySelector(".js-repo-meta-edit"), HTMLElement),
                a = v["default"](t.querySelector(".js-edit-repo-meta-button"), HTMLButtonElement);
        ...
        function f() {
            c(!1);
            var e = v["default"](document.getElementById("topics-list-container"), HTMLElement),
                t = e.getAttribute("data-url");
            g["default"](t, "`data-url` must exist -- github/topics.js:66"), n.fetchSafeDocumentFragment(document, t).then(function(t) {
                e.innerHTML = "", e.appendChild(t)
            })
        }

        function h(e) {
            g["default"](e instanceof HTMLElement, "github/topics.js:77");
            var t = e.querySelector(".js-topic-suggestions-container");
            if (t) {
                var r = t.getAttribute("data-url");
                g["default"](r, "`data-url` must exist -- github/topics.js:82"), n.fetchSafeDocumentFragment(document, r).then(function(e) {
                    t.innerHTML = "", t.appendChild(e)
                })
            }
        }
        ...
        m["default"](document).on("ajaxSuccess", ".js-accept-topic-form", function() {
            var e = v["default"](this.closest(".js-topic-suggestion"), HTMLElement),
                t = this.closest(".js-topic-form-area"),
                n = e.closest(".js-topic-save-notice-container"),
                r = v["default"](this.closest(".js-topic-form-area"), HTMLElement),
                a = v["default"](r.querySelector(".js-template"), HTMLElement),
                i = v["default"](r.querySelector(".js-tag-input-selected-tags"), HTMLElement),
                o = a.cloneNode(!0),
                s = e.querySelector('input[name="input[name]"]');
            g["default"](s instanceof HTMLInputElement, "github/topics.js:102");
            ...
            g["default"](e.target instanceof HTMLElement, "github/topics.js:119"), o.toggleDetailsTarget(e.target), f()
            ...
            t.textContent = "";
            var n = e.querySelectorAll(".js-tag-input-tag.invalid-topic"),
                r = !0,
                a = !1,
                i = void 0;
            try {
            ...
            if (t.responseJSON) {
                ...
                if (t.responseJSON.invalidTopics) {
                    var a = t.responseJSON.invalidTopics,
                        i = this.querySelectorAll(".js-topic-input"),
                        o = !0,
                        s = !1,
                        u = void 0;
                    try {
                        for (var l, c = a[Symbol.iterator](); !(o = (l = c.next()).done); o = !0) {
                            var d = l.value,
                                ...
                                m = void 0;
                            try {
                                for (var v, g = i[Symbol.iterator](); !(f = (v = g.next()).done); f = !0) {
                                    var p = v.value;
                                    p.value === d && p.closest(".js-tag-input-tag").classList.add("invalid-topic")
                                }
                            } catch (y) {
                                h = !0, m = y
                            } finally {
            ...
            var t = v["default"](e.target.closest(".js-repo-meta-container"), HTMLElement),
                n = t.querySelector(".js-repo-topics-form-fragment");
            if (n) {
                n.classList.remove("d-none");
                var r = n.getAttribute("data-url");
                g["default"](r, "`data-url` must exist -- github/topics.js:199"), n.setAttribute("src", r)
            }
            var a = t.querySelector(".js-repository-topics-container"),
                i = v["default"](a, HTMLElement).classList.contains("open");
            i ? d() : f()
        }), a.on("click", ".js-edit-repo-meta-toggle", function(e) {
            var t = v["default"](e.target.closest(".js-repo-meta-container"), HTMLElement),
                n = t.querySelector(".js-repo-meta-edit"),
                r = v["default"](n, HTMLElement).classList.contains("open"),
                a = t.querySelector(".js-repository-topics-container");
            ...
            var e = "s",
                ...
                a = function() {
                    var t = r(new Date(n.BASELINE_YEAR, 0, 2)),
                        a = r(new Date(n.BASELINE_YEAR, 5, 2)),
                        i = t - a;
        ...
        if (!("u2f" in window) && e) {
            ...
            n.EXTENSION_ID = "kmendfapggjehodndflmmgagdbamhnfd", n.MessageTypes = {
                ...
                n.getPortSingleton_(function(o) {
                    var s = ++n.reqCounter_;
                    n.callbackMap_[s] = a;
                    var u = "undefined" != typeof i ? i : n.EXTENSION_TIMEOUT_SEC,
                        l = n.formatSignRequest_(e, t, r, u, s);
                    o.postMessage(l)
                })
                ...
                n.getPortSingleton_(function(o) {
                    ...
                    n.callbackMap_[s] = a;
                    var u = "undefined" != typeof i ? i : n.EXTENSION_TIMEOUT_SEC,
                        l = n.formatRegisterRequest_(e, r, t, u, s);
                    o.postMessage(l)
                })
    ...
    function(e, t) {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.u2fEnabledBrowser = n, e.u2fSign = r, e.u2fRegister = a
        ...
        function i() {
            var e = o["default"](document.querySelector(".js-u2f-auth-form"), HTMLFormElement),
                t = o["default"](e.querySelector(".js-u2f-auth-response"), HTMLInputElement),
                a = e.getAttribute("data-app-id"),
                i = e.getAttribute("data-challenge"),
    ...
    }), define("github/u2f-settings", ["./u2f", "./jquery", "./typecast", "./fetch", "./observe", "delegated-events", "./sudo"], function(e, t, n, r, a, i, o) {
        function s(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function l(e) {
            var t = y["default"](document.querySelector(".js-add-u2f-registration-form"), HTMLFormElement);
            return u(t, "data-sign-requests", e)
        }

        function c(e) {
            var t = y["default"](document.querySelector(".js-add-u2f-registration-form"), HTMLFormElement);
            return u(t, "data-register-requests", e)
        }

        function d(e) {
            e.register_requests && c(e.register_requests), e.sign_requests && l(e.sign_requests)
        }
        ...
        function f(e) {
            ...
            t.innerHTML = e;
            var n = t.firstChild;
            null != n && y["default"](document.querySelector(".js-u2f-registrations"), HTMLElement).appendChild(n)
        }

        function h(e, t) {
            var n = y["default"](document.querySelector(".js-new-u2f-registration"), HTMLElement);
            ...
            var r = y["default"](n.querySelector(e), HTMLElement);
            null != t && (r.textContent = t), r.classList.remove("d-none")
        }

        function m() {
            var e = y["default"](document.querySelector(".js-new-u2f-registration"), HTMLElement);
            e.classList.remove("is-sending", "is-active"), y["default"](document.querySelector(".js-u2f-registration-nickname-field"), HTMLInputElement).value = ""
        }

        function v(e) {
            b["default"]("high").then(function() {
                var t = y["default"](document.querySelector(".js-add-u2f-registration-form"), HTMLFormElement);
                y["default"](t.elements.namedItem("response"), HTMLInputElement).value = JSON.stringify(e), r.fetchJSON(t.action, {
                    method: t.method,
                    body: new FormData(t)
                }).then(function(e) {
                    d(e), m(), f(e.registration)
                })["catch"](function(e) {
                    e.response ? e.response.json().then(function(e) {
                        d(e), h(".js-u2f-server-error", e.error)
        ...
        function g() {
            var t = y["default"](document.querySelector(".js-new-u2f-registration"), HTMLElement);
            t.classList.add("is-sending"), t.classList.remove("is-showing-error");
            var n = y["default"](document.querySelector(".js-add-u2f-registration-form"), HTMLElement),
                r = n.getAttribute("data-app-id");
            if (null == r) throw new Error("invalid appId");
            e.u2fRegister(r, c(), l()).then(v)["catch"](function(e) {
        ...
        p["default"](document).on("ajaxSend", ".js-u2f-registration-delete", function() {
            ...
            d(t.responseJSON), this.closest(".js-u2f-registration").remove()
        }), i.on("click", ".js-add-u2f-registration-link", function() {
            var e = y["default"](document.querySelector(".js-new-u2f-registration"), HTMLElement);
            e.classList.add("is-active"), e.classList.remove("is-showing-error");
            var t = y["default"](document.querySelector(".js-u2f-registration-nickname-field"), HTMLInputElement);
            t.focus()
    ...
    }), define("github/updatable-content-observer", ["invariant", "delegated-events", "./updatable-content"], function(e, t, n) {
        function r(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        var a = r(e);
        t.on("socket:message", ".js-updatable-content", function(e) {
            a["default"](e instanceof CustomEvent, "github/updatable-content-observer.js:18");
            var t = e.detail.data;
            if (this === e.target) {
                var r = t && t.wait;
                null == r ? n.updateContent(e.target) : setTimeout(function() {
                    a["default"](e.target instanceof HTMLElement, "github/updatable-content-observer.js:28"), n.updateContent(e.target)
                }, r)
            }
        })
        ...
        r.on("upload:setup", ".js-upload-avatar-image", function(e) {
            o["default"](e instanceof CustomEvent, "github/upload/avatar.js:9");
            var t = e.detail.policyRequest,
                n = this.getAttribute("data-alambic-organization"),
                r = this.getAttribute("data-alambic-owner-type"),
                a = this.getAttribute("data-alambic-owner-id");
            ...
            o["default"](e instanceof CustomEvent, "github/upload/avatar.js:26");
            var n = e.detail.result,
                r = "/settings/avatars/" + n.id;
            i["default"](function() {
                t.fetchText(r).then(i["default"])
            })
        })
    }), define("github/png-scanner", ["exports", "invariant"], function(e, t) {
        function n(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        var a = n(t),
            ...
            u = function() {
                function e(t) {
                    r(this, e), this.dataview = new DataView(t), this.pos = 0
                }
                return i(e, null, [{
                    key: "fromFile",
                    value: function(t) {
                        return new Promise(function(n, r) {
                            ...
                            i.onload = function() {
                                a["default"](i.result instanceof ArrayBuffer, "github/png-scanner.js:38"), n(new e(i.result))
                            }, i.onerror = function() {
                                r(i.error)
                    ...
                    key: "scan",
                    value: function(e) {
                        if (this.readLong() !== o) throw new Error("invalid PNG");
                        for (this.advance(4);;) {
                            var t = this.readLong(),
                                n = this.readString(4),
                                r = this.pos + t + s;
        ...
        function d(e) {
            var t = "\xa0",
                n = e.textContent.trim().replace(/\|/g, "\\|").replace(/\n/g, " ");
            return n || t
        }

        function f(e) {
            return Array.from(e.querySelectorAll("td, th")).map(d)
        }
        ...
        function h(e) {
            var t = Array.from(e.querySelectorAll("tr")),
                ...
                a = n.join(" | ") + "\n" + r.join(" | ") + "\n",
                i = t.map(function(e) {
                    return Array.from(e.querySelectorAll("td")).map(d).join(" | ")
                }).join("\n");
            return "\n" + a + i + "\n\n"
        }
        var m = i(t),
        ...
        r.on("upload:setup", ".js-upload-markdown-image", function(t) {
            v["default"](t instanceof CustomEvent, "github/upload/markdown.js:48");
            ...
            v["default"](t instanceof CustomEvent, "github/upload/markdown.js:55");
            var r = t.detail,
                a = this,
                i = a.querySelector(".js-comment-field"),
                o = s(r.file);
            m["default"](r.file).then(n, function(e) {
                n(), g["default"](function() {
                    throw e
                })
            })
        }), r.on("upload:error", ".js-upload-markdown-image", function(t) {
            v["default"](t instanceof CustomEvent, "github/upload/markdown.js:86");
            var n = this.querySelector(".js-comment-field"),
                r = s(t.detail.file);
            n.setCustomValidity(""), e.replaceText(n, r, "")
        }), r.on("upload:invalid", ".js-upload-markdown-image", function(t) {
            v["default"](t instanceof CustomEvent, "github/upload/markdown.js:94");
            var n = this.querySelector(".js-comment-field"),
                r = s(t.detail.file);
            n.setCustomValidity(""), e.replaceText(n, r, "")
        }), r.on("upload:drop:links", ".js-upload-markdown-image", function(t) {
            v["default"](t instanceof CustomEvent, "github/upload/markdown.js:107");
            var n = this.querySelector(".js-comment-field"),
                r = !0,
                a = !1,
                i = void 0;
            try {
                for (var o, s = t.detail.links[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
                    var u = o.value,
                        l = c(u) ? "\n![](" + u + ")\n" : u;
                    e.insertText(n, l)
                }
            ...
            v["default"](t instanceof CustomEvent, "github/upload/markdown.js:116");
            var n = this.querySelector(".js-comment-field");
            e.insertText(n, t.detail.text)
        }), r.on("upload:drop:table", ".js-upload-markdown-image", function(t) {
            v["default"](t instanceof CustomEvent, "github/upload/markdown.js:146");
            var n = this.querySelector(".js-comment-field");
            e.insertText(n, h(t.detail.node))
        })
        ...
        r.on("upload:setup", ".js-upload-marketplace-listing-screenshot", function(e) {
            o["default"](e instanceof CustomEvent, "github/upload/marketplace-listing-screenshot.js:9");
            var t = e.detail.policyRequest,
                n = this.getAttribute("data-marketplace-listing-id");
            ...
            o["default"](e, "`data-screenshots-url` must exist -- github/upload/marketplace-listing-screenshot.js:21");
        ...
        n.on("release:saved", ".js-release-form", function() {
            ...
            u["default"](e instanceof CustomEvent, "github/upload/release-file.js:51");
            var n = e.detail,
                a = n.policyRequest,
                i = n.preprocess,
                l = this;
            if (o(l)) t();
            else if (i.push(new Promise(function(e) {
                    return c.push(e)
                }).then(t)), 1 === c.length) {
            ...
            u["default"](e instanceof CustomEvent, "github/upload/release-file.js:82");
            ...
            u["default"](e instanceof CustomEvent, "github/upload/release-file.js:100");
            var t = e.detail,
                n = t.policy,
                r = s["default"](document.querySelector(".js-releases-field"), HTMLElement),
                a = s["default"](r.querySelector(".js-template"), HTMLElement).cloneNode(!0);
            ...
            u["default"](e instanceof CustomEvent, "github/upload/release-file.js:132");
        ...
        function l(e, t) {
            var n = e.closest(".js-upload-manifest-file-container"),
                r = n.querySelector(".js-upload-progress");
        ...
        i.on("upload:drop:setup", ".js-upload-manifest-file", function(e) {
            v["default"](e instanceof CustomEvent, "github/upload/upload-manifest-file.js:46");
            ...
            v["default"](e instanceof CustomEvent, "github/upload/upload-manifest-file.js:56"), e.preventDefault();
            var t = e.detail.upload,
                n = m["default"](document.querySelector("#js-repo-pjax-container"), HTMLElement);
            g["default"](n, "pjax:success").then(function() {
            ...
            v["default"](t instanceof CustomEvent, "github/upload/upload-manifest-file.js:74");
            var r = t.detail,
                a = r.policyRequest,
                i = r.preprocess;
            l(this, t.detail);
            ...
            v["default"](e instanceof CustomEvent, "github/upload/upload-manifest-file.js:121");
            var t = e.detail,
                n = this.closest(".js-upload-manifest-file-container"),
                r = n.querySelector(".js-upload-progress"),
                a = r.querySelector(".js-upload-meter-text");
            ...
            v["default"](e instanceof CustomEvent, "github/upload/upload-manifest-file.js:132");
            var t = e.detail,
                n = document.querySelector(".js-manifest-commit-file-template"),
                r = n.rows[0].cloneNode(!0);
            ...
            v["default"](e instanceof CustomEvent, "github/upload/upload-manifest-file.js:162");
            var t = e.detail,
                n = this.closest(".js-upload-manifest-file-container"),
                r = n.querySelector(".js-upload-meter");
    ...
    }), define("github/uploads", ["./fetch", "delegated-events", "invariant", "./observe", "./parse-html", "./upload/avatar", "./upload/markdown", "./upload/marketplace-listing-screenshot", "./upload/release-file", "./upload/upload-manifest-file"], function(e, t, n, r, a) {
        function i(e) {
            return e && e.__esModule ? e : {
                "default": e
            }
        ...
        function u(e, t) {
            var n;
            (n = e.classList).remove.apply(n, V), e.classList.add(t)
        }
        ...
        function l(n, r) {
            var a = function(a) {
                ...
                s = void 0;
            try {
                for (var l, h = n.files[Symbol.iterator](); !(i = (l = h.next()).done); i = !0) {
                    var m = l.value,
                        v = a(m);
        ...
        function f(n, r, a, i) {
            var o = a.upload_authenticity_token;
            null == o && (o = s(i));
            ...
            return null == l && (l = s(i)), {
                ...
                csrf: o,
                start: function() {
                    u(i, "is-uploading"), t.fire(i, "upload:start", {
                        batch: n,
                        file: r,
                        policy: a
                    })
                ...
                progress: function(e) {
                    n.progress(r, e), t.fire(i, "upload:progress", {
                        batch: n,
                        file: r,
                        percent: e
                    })
                ...
                complete: function(o) {
                    if (n.completed(r), o && o.href && (a.asset || (a.asset = {}), a.asset.href = o.href), a.asset_upload_url && a.asset_upload_url.length > 0) {
                        var s = new FormData;
                        s.append("authenticity_token", l), e.fetchJSON(a.asset_upload_url, {
                            method: "put",
                            body: s
                        })
                    }
                    t.fire(i, "upload:complete", {
                        batch: n,
                        file: r,
                        policy: a,
                        result: o
        ...
        function g(e) {
            if (-1 !== Array.from(e.types).indexOf("text/html")) {
                ...
                if (/<table/i.test(t)) {
                    var n = a.parseHTML(document, t),
                        r = n.querySelector("table");
                    if (r) return /\b(js|blob|diff)-./.test(r.className) ? null : r
                }
            }
        }
        ...
        function x(e, t) {
            return t.isDirectory ? S(t).then(function(e) {
                var n = b(e).map(function(e) {
                    return x(t.fullPath, e)
                });
                return Promise.all(n)
            }) : L(t).then(function(t) {
                return t._path = e, t
        ...
        function T(e) {
            return h(e) ? "copy" : m(e) ? "link" : v(e) ? "copy" : "none"
        }
        ...
        function D(e) {
            var n = document.body;
            B["default"](n, "github/uploads.js:582"), this.classList.remove("dragover"), n.classList.remove("dragover");
            var r = e.dataTransfer,
                a = g(r);
            if (h(r)) {
                var i = null;
                i = this.hasAttribute("data-directory-upload") && r.getFilesAndDirectories ? w(r) : this.hasAttribute("data-directory-upload") && k(r) ? E(r) : Promise.resolve(b(r.files));
                var o = this;
                i.then(function(e) {
                    if (!e.length) return void u(o, "is-hidden-file");
                    var n = _.bind(null, e),
                        r = !t.fire(o, "upload:drop:setup", {
                            upload: n,
                            files: e
                        });
                    r || _(e, o)
                ...
                var s = (r.getData("text/uri-list") || "").split("\r\n");
                s.length && t.fire(this, "upload:drop:links", {
                    links: s
                })
            } else a ? t.fire(this, "upload:drop:table", {
                node: a
            }) : v(r) && t.fire(this, "upload:drop:text", {
                text: r.getData("text/plain")
            });
        ...
        function P(e) {
            if (e.clipboardData) {
                var n = g(e.clipboardData);
                if (n) return t.fire(this, "upload:drop:table", {
                    node: n
                ...
                if (e.clipboardData.items) {
                    ...
                    if (r) {
                        var a = z(r, 2),
                            ...
                            o = a[1],
                            s = i.getAsFile();
                        s.name = o, _([s], this), e.preventDefault()
                    }
                }
            }
        }
        ...
        function R(e) {
            e.target.classList.contains("js-manual-file-chooser") && (_(e.target.files, this), e.target.value = "")
        }

        function O() {
            var e = void 0;
            e = this.classList.contains("js-uploadable-container") ? this : this.querySelector(".js-uploadable-container"), u(e, "is-default")
        }
        ...
        var B = i(n),
            ...
            W = function() {
                function e() {
                    o(this, e), this.uploads = [], this.busy = !1
                }
                return U(e, [{
                    key: "upload",
                    value: function(e, t) {
            ...
            V = ["is-default", "is-uploading", "is-bad-file", "is-duplicate-filename", "is-too-big", "is-too-many", "is-hidden-file", "is-failed", "is-bad-dimensions", "is-empty", "is-bad-permissions", "is-repository-required", "is-bad-format"],
            $ = new W,
            Y = function() {
                function e(t) {
                    o(this, e), this.files = Array.from(t), this.percentages = this.files.map(function() {
                        return 0
        ...
        r.observe(".js-document-dropzone", {
            add: function(e) {
                var t = document.body;
                B["default"](t, "github/uploads.js:716"), t.addEventListener("dragstart", N), t.addEventListener("dragend", F), t.addEventListener("dragenter", C), t.addEventListener("dragover", C), t.addEventListener("dragleave", I), e.addEventListener("drop", D)
            },
            remove: function(e) {
                var t = document.body;
                B["default"](t, "github/uploads.js:727"), t.removeEventListener("dragstart", N), t.removeEventListener("dragend", F), t.removeEventListener("dragenter", C), t.removeEventListener("dragover", C), t.removeEventListener("dragleave", I), e.removeEventListener("drop", D)
            }
        }), r.observe(".js-uploadable-container", {
            add: function(e) {
                0 === X++ && (document.addEventListener("drop", M), document.addEventListener("dragover", A)), e.addEventListener("dragenter", C), e.addEventListener("dragover", C), e.addEventListener("dragleave", H), e.addEventListener("drop", D), e.addEventListener("paste", P), e.addEventListener("change", R);
                var t = e.closest("form");
                null != t && t.addEventListener("reset", O)
            },
            remove: function(e) {
                0 === --X && (document.removeEventListener("drop", M), document.removeEventListener("dragover", A)), e.removeEventListener("dragenter", C), e.removeEventListener("dragover", C), e.removeEventListener("dragleave", H), e.removeEventListener("drop", D), e.removeEventListener("paste", P), e.removeEventListener("change", R);
                var t = e.closest("form");
    ...
    }), define("github-bootstrap", ["./github/accessibility-report", "./github/behaviors/event-key-polyfill", "./github/behaviors/html-validation", "./github/behaviors/user-content", "./github/biztools/showcase", "./github/box-overlay", "./github/branches", "./github/bulk-actions", "./github/bust-frames", "./github/button-outline", "./github/collector-api", "./github/community", "./github/dashboard", "./github/delegated-account-recovery", "./github/details", "./github/diffs/progressive", "./github/diffs/prose", "./github/diffs/toc-summary", "./github/feature-detection", "./github/fixed-offset-fragment-navigation-observer", "./github/gfm", "./github/git-clone-help", "./github/google-analytics-tracking", "./github/hash-change", "./github/homepage/play-video", "./github/issues/bookmark-toggler", "./github/legacy/index", "./github/length-limited-input-with-warning", "./github/link-prefetch-viewed", "./github/manage-membership-navigation", "./github/marketplace/callouts", "./github/marketplace/edit-pricing", "./github/marketplace/edit", "./github/marketplace/order", "./github/marketplace/supported-languages", "./github/menu", "./github/milestone-dragging", "./github/mobile-preference", "./github/notifications", "./github/notifications/filtering", "./github/notifications/live-updates", "./github/notifications/pagination", "./github/notifications/quick-actions", "./github/oauth", "./github/octolytics-tracking", "./github/orgs/team-discussions", "./github/pjax", "./github/pjax/capture-keypresses", "./github/pjax/history-navigate", "./github/pjax/link-prefetch", "./github/project-cards-filter", "./github/project-updater", "./github/projects", "./github/proxy-site-reporting", "./github/pulls/change-base", "./github/pulls/commits-range-selection", "./github/pulls/reviews", "./github/releases", "./github/repository-search", "./github/select-menu", "./github/skip-autofill", "./github/smooth-scroll-anchor", "./github/socket-channel", "./github/sso-auto-replay", "./github/sso", "./github/sticky", "./github/sudo-required", "./github/task-list", "./github/team-breadcrumbs", "./github/team-hierarchy", "./github/dependencies", "./github/timing-stats", "./github/toggler", "./github/topics", "./github/touch-events-observer", "./github/tz-cookie", "./github/u2f-login", "./github/u2f-settings", "./github/updatable-content-observer", "./github/uploads", "./github/user-select-contain", "./github/remote"], function() {}), ghImport("github-bootstrap")["catch"](function(e) {
        setTimeout(function() {
            throw e
        })
    });